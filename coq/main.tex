...
\myfig{
  \begin{center}
    $$
    \trg{\Omega^\diamond} = \trg{\Omega.H;}\text{fold}\ (\lambda \trg{\Delta}\ (\trg{x\mapsto\loc_\poison}).\trg{x\mapsto\loc_\poison^\diamond,\Delta})\ \trg{\hole{\cdot}}\ \trg{\Omega.\Delta}
    $$
  \end{center}
...
\myfig{
  ...
  \typerule{$e-\text{wprog}-\trg{trg}-$failp}{
    \exect{\hole{\cdot};\hole{\cdot}}{e_0}{\Omega_0}{\valueexpr_0}{\trace{_0}} &
    \exect{\Omega_0^\diamond}{e_p[\valueexpr_0/x]}{\lightning}{stuck}{\trace{_p}} &
  }{
  ...
  \typerule{$e-\text{wprog}-\trg{trg}$-fail1}{
    \exect{\hole{\cdot};\hole{\cdot}}{e_0}{\Omega_0}{\valueexpr_0}{\trace{_0}} \\
    \exect{\Omega_0^\diamond}{e_p[\valueexpr_0/x]}{\Omega_p}{\valueexpr_p}{\trace{_p}} &
...
\begin{lemma}[State equality coincides]\label{lem:stateinsertion}
  Iff
  \begin{assumptions}
  \item $\xlangstateeq{\Omega}{\Omega^\diamond}$
  \end{assumptions}
  then
  \begin{goals}
  \item $\xlangbackstateeq{\Omega^\diamond}{\Omega}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
