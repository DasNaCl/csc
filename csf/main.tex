...
\newcommand\hmmax{0}
\newcommand\bmmax{0}
\documentclass[utf8,dvipsnames,conference,peerreviewca]{IEEEtran}
...
\author{\IEEEauthorblockN{1\textsuperscript{st} Matthis Kruse\orcidlink{000-003-4062-9666}} \\
\IEEEauthorblockA{\textit{CISPA Helmholtz Center for Information Security\\
and Saarland Informatics Campus \\
...
director@cispa.de}}%
\linebreakand
\IEEEauthorblockN{3\textsuperscript{rd} Marco Patrignani\orcidlink{000-003-3411-9678}} \\
