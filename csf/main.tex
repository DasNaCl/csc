...
\begin{theorem}[Sequential Composition of Secure Compilers]\label{thm:rtpsim}
  If \bul{$\rtpsim{\cc{\src{L}}{\trg{L}}}{\class[_{1}]}{\sim_1}$}, \rul{$\rtpsim{\cc{\trg{L}}{\obj{L}}}{\tilde{\tau}_{\sim_1}\left(\class[_{2}]\right)}{\sim_2}$}, and \iul{$\wf{\sim_1}{\class[_2]}$}, then \oul{$\rtpsim{\cc{\src{L}}{\trg{L}}\circ\cc{\trg{L}}{\obj{L}}}{\class[_{1}]\cap\class[_{2}]}{\sim_1\bullet\sim_2}$}. \Coqed
\end{theorem}
...
Note that it is not necessary to require $\sim_2$ to be well-formed with respect to $\class[_1]$.
