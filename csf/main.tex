...
This section is concerned about source-level properties, and henceforth uses the existential image of a source-level property $\src{\pi}$ to map $\src{\pi}$ to a target-level property:
