...
\newcommand{\ird}[1]{\ensuremath\mathtt{\col{\irdcol}{#1}}}
...
\newcommand{\rtpsim}[3]{\ensuremath\;\vdash_{{#3}}{#1}:{#2}}
\newcommand{\rtptau}[3]{\ensuremath\;\vdash_{{#3}}{#1}:{#2}}
...
\newcommand{\wfc}[2]{\ensuremath\vdash_c{#1}:{#2}}
\newcommand{\wfctau}[2]{\ensuremath\vdash_c{#1}:{#2}}
\newcommand{\wfcsig}[2]{\ensuremath\vdash_c{#1}:{#2}}
