...
Coming back to the example composing SecurePtrs with FaCT, \MP{does the order matter?}
...
For each of the presented properties, the technical report defines corresponding monitors, which refine\MP{enforce? and enforce?} a given property and have a key role in the proofs of this paper. 
% managed to prove 
