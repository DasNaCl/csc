...
\MP{can we use scct here, instead of cct?}
...
%        This demonstrates that the usage of the presented framework is both simpler and more expressive compared to one monolithic security proof of the whole compilation chain.
  ...
  \item %
  	The paper provides formal proofs of the security of each presented pass, and it analyzes each pass in terms of their compatibility with each other (\Cref{sec:formalities}).
