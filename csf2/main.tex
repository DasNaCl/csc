...
After branching or accessing memory, speculation can start, pushes the current configuration on the speculation register ($\ird{S}$), and run subsequent code in a predetermined window until a rollback of operational state is performed. 
