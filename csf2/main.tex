...
Security tags $\obj{\securitytag}$ are arranged in the usual secrecy lattice~\cite{zdancewicphd}, where $\obj{\lock}\le\obj{\securitytag}$ and $\obj{\securitytag}\le\obj{\unlock}$.
