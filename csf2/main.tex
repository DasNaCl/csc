...
Whether or not compiler passes enforce certain security properties, it is important for a security-aware compiler to consider partial programs that interact with potentially malicious library code, since that code may lead to, e.g., memory--safety issues in the considered partial program.
}
