...
$\src{L_{\tmssafe}}$ is a relatively naive language with second class functionns, the only values being numbers. 
It has simple binary operations, case analyses, C-like memory operations on arrays, as well as C-like function calls.
