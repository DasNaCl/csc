...
The dual theorem also holds: let \bul{$\cc{\src{L}}{\trg{L}}$ robustly preserve the class $\sigma_{\sim_2}\left(\trg{\class[_1]}\right)$ under $\sim_1$} and let \rul{$\cc{\trg{L}}{\obj{L}}$ robustly preserve the class $\trg{\class[_2]}$ under $\sim_2$}.
...
When the cross-language trace relation is an equality, \Cref{thm:rtpsim:tau,thm:rtpsim:sig} collapse:
...
This section introduces trace properties of interest for this paper: \gls*{tms}, \gls*{sms}, \gls*{ms}, \gls*{scct}, and \gls*{ss} (\Cref{subsec:propdefs}).
...
\subsection{Basic Memory Safety Trace Model}\label{subsec:propdefs}\label{subsec:basic:memsafety:tracemodel}
...
\subsection{Memory Safety Trace Model}
...
\[
  \typerulenolabel{mscctrel:drop:tag}{}{\event[_b];\sandboxtag\sim_{msscct}\event[_b];\sandboxtag;\securitytag}
\]
\[
  \typerulenolabel{mscctrel:drop:branch}{}{\emptyevent\sim_{msscct}\ev{Branch n};\sandboxtag;\securitytag}
  \typerulenolabel{mscctrel:drop:binop}{}{\emptyevent\sim_{msscct}\ev{Binop n};\sandboxtag;\securitytag}
\]
...
\subsection{Speculation Trace Model}
...
\begin{definition}[\glsfirst*{ss}]\label{def:trace:ss}
  ...
  \sssafe:=\left\{\trace \left|\begin{array}{rcl}
                                   \trace=\hole{\cdot} & \text{ or } & \trace=\event[_{b}];\sandboxtag;\unlock\cdot\trace['] \wedge \trace[']\in\sssafe
                                 \end{array}\right.\right\}
  \]
\end{definition}
...
\[
  \typerulenolabel{specrel:drop:spec}{}{\emptyevent\sim_{spec}\ev{Spec};\sandboxtag;\securitytag}
  \typerulenolabel{specrel:drop:rlb}{}{\emptyevent\sim_{spec}\ev{Rlb};\sandboxtag;\securitytag}
\]
\[
  \typerulenolabel{specrel:drop:tag}{}{\event[_b];\sandboxtag;\lock\sim_{spec}\event[_b];\sandboxtag;\lock_{vX}}
\]
