...
Action $\trg{Set}$ is treated analogously; any other event is just a trivial re-colouring.\MPin{no explicit mentioning of colours. identity functions}
...
\MPin{
  ...
  other work defined similar props.d
}
