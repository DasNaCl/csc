...
\newcommand{\msscctsafe}{\ensuremath\operatorname{mct}}
\newcommand{\sssafe}{\ensuremath\operatorname{ss}}
\newcommand{\specmssafe}{\ensuremath\operatorname{specms}}
...
\newcommand{\absev}[1]{\ensuremath\bm{\mi{#1}}}
...
\newcommand{\substlist}[1][]{\ensuremath \overline{\rho#1}}
...
\newcommand{\lwrdoit}[2][]{\ensuremath \wrapkeyword[#1]{wrct}\ #2\xspace}
\newcommand{\lrddoit}[3][]{\ensuremath \wrapkeyword[#1]{rdct}\ #2\ \wrapkeyword[#1]{in}\ #3\xspace}
...
\newcommand{\lbarrier}[1][]{\ensuremath \wrapkeyword[#1]{barrier}\xspace}

% Compiler
\newcommand{\rtp}[2]{\ensuremath\vdash{#1}:{#2}}
\newcommand{\rtpsim}[3]{\ensuremath\;\vdash^\forall_{{#3}}{#1}:{#2}}
\newcommand{\rtptau}[3]{\ensuremath\;\vdash^\exists_{{#3}}{#1}:{#2}}
\newcommand{\rtpsig}[3]{\ensuremath\;\vdash_{{#3}}{#1}:{#2}}
...
\newcommand{\ccspec}{\ensuremath\cc{\Lscct}{\Lspec}}
\newcommand{\ccspecms}{\ccmssscct}
\newcommand{\ccmssscct}{\ensuremath\cc{\Ltms}{\Lspec}}

% Well-formedness of x-lang tracerels
...
% State
\newcommand{\securitytag}[1][]{\ensuremath s#1}
...
\newcommand{\ghoststepto}[3]{\ensuremath{#1}\xrightswishingghost{#3}\xspace{#2}\xspace}
...
\newcommand{\tracegen}[2]{\ensuremath{#1}\leadsto{#2}}

\newcommand{\varProp}[1][]{\ensuremath\pi#1}
\newcommand{\varHProp}[1][]{\ensuremath\Pi#1}
