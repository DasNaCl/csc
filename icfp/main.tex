...
%        This demonstrates that the usage of the presented framework is both simpler and more expressive compared to one monolithic security proof of the whole compilation chain.
  ...
  \item %
  		...
  		% 
  		Additionally this paper analyses each pass in terms of their compatibility with each other (\Cref{sec:formalities}), proving how each pass fulfills the conditions that make their composition meaningful from a security standpoint.
