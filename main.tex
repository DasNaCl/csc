...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case} \ref{tr:tw-e-get-in}\textbf{:}
          ...
          Since $\irl{x_{SIZE}}=\irl{m}$\MK{why?}, we can execute to the desired state $\irl{\Omega}$ with just $\irl{Get\ \loc\ n;\comp}$.
    ...
    \item \textbf{Case} \ref{tr:tw-e-set-comp}\textbf{:}
          ...
          Since $\irl{x_{SIZE}}=\irl{m}$\MK{why?}, we can execute to the desired state $\irl{\Omega}$ with just $\irl{Set\ \loc\ n\ \valueexpr;\comp}$.
