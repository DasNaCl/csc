...
\myfig{
  \begin{gather*}
  \begin{aligned}
    \mi{Events}~\msevent \bnfdef&\ \specificev{\emptyevent}\mid \specificev{Alloc\ \loc\ n} \mid \specificev{Dealloc\ \loc} \mid \specificev{Use\ \loc\ n} \mid \specificev{\lightning} |\ \specificev{Branch\ b} \mid \specificev{Binop\ \oplus} \\
                                  &\text{Hereby, }n\in\mathbb{N}\text{ and }b\in\mathbb{B}
  \end{aligned}
  \end{gather*}
...
\myfig{
  \begin{center}
    ...
    \typerule{TMS-Branch-Authentic}{
      ...
      \tmstraceagree{\specificev{Branch\ b}}{\bm{\varepsilon}}
    }{tms-branch-auth}
    %
    \typerule{TMS-Binop-Authentic}{
    }{
      \tmstraceagree{\specificev{Binop\ \oplus}}{\bm{\varepsilon}}
    }{tms-binop-auth}
    %
...
\myfig{
  \begin{center}
    ...
    \typerule{SMS-Branch-Authentic}{
      ...
      \smstraceagree{\specificev{Branch\ b}}{\bm{\varepsilon}}
    }{sms-branch-auth}
    %
    \typerule{SMS-Binop-Authentic}{
    }{
      \smstraceagree{\specificev{Binop\ \oplus}}{\bm{\varepsilon}}
    }{sms-binop-auth}
    %
