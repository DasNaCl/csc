...
\myfig{
  \begin{center}
    \judgbox{\wexect{prog\ \commlib\ \library}{\Omega}{\finalexpr}{\trace}}{,,Run $\mmlAt$ program $\trg{prog\ \commlib\ \library}$, giving dynamic\\state $\configt$ and emitting trace $\trg{\trace}$.''}
  \typerule{$te-\text{wprog}$}{
    \exect{\commlib;\library;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\Omega}{\finalexpr}{\trace}
  }{
    \wexect{prog\ \commlib\ \library}{\Omega}{\finalexpr}{\trace}
  }{wt-e-prog}
  \end{center}
