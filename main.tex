...
\myfig{
  \begin{gather*}
    \begin{aligned}
      \mi{Abstract\ Store}~\smsmonitor =&\ \specificev{L}\times\nat \\
      \mi{Abstract\ Events}~\absevent \bnfdef&\ \bm{\varepsilon}\mid \textbf{Alloc}\ \specificev{\loc}\ \bm{n} \mid \textbf{Dealloc}\ \specificev{\loc} \mid \textbf{Use}\ \specificev{\loc}\ \bm{n} \mid \abstermination \mid \textbf{Branch}\ \bm{n}\\
      &\mid \textbf{Binop}\ \bm{n}\ \bm{m}\\
    \end{aligned}
  \end{gather*}
...
\myfig{
  \begin{center}
    ...
    \typerule{cct-Dealloc}{
      ...
      \monitorcheck[]{\cctmonitor}{\cctmonitor}{\bm{Dealloc}\ \loc\ n}
    }{cct-alloc}
    %
    \typerule{cct-Dealloc}{
    }{
...
\myfig{
  \begin{center}
    ...
    \typerule{CCT-Alloc-Authentic}{
      ...
      \ccttraceagree{\specificev{Alloc\ \loc\ n}}{\textbf{Alloc}\ \specificev{\loc}}
    }{cct-alloc-auth}
    %
    \typerule{CCT-Dealloc-Authentic}{
    }{
      \ccttraceagree{\specificev{Dealloc\ \loc}}{\textbf{Dealloc}\ \specificev{\loc}}
    }{cct-dealloc-auth}
    %
    \typerule{CCT-Use-Authentic}{
    }{
      \ccttraceagree{\specificev{Use\ \loc\ n}}{\textbf{Use}\ \specificev{\loc}}
    }{cct-use-auth}
    %
    ...
    \typerule{CCT-Branch-Authentic}{
      ...
      \ccttraceagree{\specificev{Branch\ n}}{\textbf{Branch\ n}}
    }{cct-branch-auth}
    %
    \typerule{CCT-Binop-Authentic}{
    }{
      \ccttraceagree{\specificev{Binop\ n}}{\textbf{Binop\ n}}
    }{cct-binop-auth}
    %
...
\myfig{
  \begin{center}
    ...
    \typerule{o-cct-filter-comp-alloc}{
      ...
      \tospecificevo[_{\delta_{CCT}}]{Alloc\ \loc\ n;\comp} = \specificev{Alloc\ \loc\ n}
    }{o-cct-filter-comp-alloc}
    %
    \typerule{o-cct-filter-comp-dealloc}{
      \delta_{CCT}(\obj{\loc})=\specificev{\loc}
    }{
      \tospecificevo[_{\delta_{CCT}}]{Dealloc\ \loc;\comp} = \specificev{Dealloc\ \loc}
