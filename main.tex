...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-empty}{
      ...
      \mmlAmmlAtbackdetail{\hole{\cdot}} = \Game, \src{hole : (x:\type_1)\to\type_2}
    }{backtrans-empty}
    %
    \typerule{backtrans-alloc}{
      ...
      \mmlAmmlAtbackdetail{\specificev{Alloc\ \loc\ n}\cdot\mstrace} = \Game'', \src{let\ z = new\ }\mmlAmmlAtbackv{n}\src{\ in\ e}
    }{backtrans-alloc}
    %
    ...
    \typerule{backtrans-use}{
      ...
      \mmlAmmlAtbackdetail{\specificev{Use\ \loc\ n}\cdot\mstrace} = \Game'',\src{z[}\mmlAmmlAtbackv{n}\src{];e}
    }{backtrans-use}
    %
    %
    \typerule{backtrans-call}{
      \fresh{\Game}{\trg{\loc}} &
      \Game'=\Game[\trg{\loc}] &
      \mmlAmmlAtbackdetail[\Game',\src{\type_0\to\type_p}]{\specificev{Alloc\ \loc\ 42}} = \Game'', \src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\src{\type_0\to\type_p}]{\specificev{Call\ ?\finalexprnoerr}} = \Game'', \trg{\loc}, \src{e}
    }{backtrans-call}
    %
    \typerule{backtrans-ret}{
      \src{z} = \Game(\trg{\loc}) &
      \src{e'} = \plugs[N]{delete\ z}{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\loc},\src{e}]{\specificev{Ret\ !\finalexprnoerr}} = \Game', \src{e'}
    }{backtrans-ret}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \mmlAmmlAtbackdetail[\Game,\src{\type_0\to\type_p}]{\mstrace[_0]} = \Game', \src{e_0} \\
      \mmlAmmlAtbackdetail[\Game',\src{\type_0\to\type_p}]{\specificev{Call\ ?\finalexprnoerr_0}} = \Game'',\trg{\loc},\src{e_0'} &
      \mmlAmmlAtbackdetail[\Game'',\trg{\loc},\src{e_0'}]{\specificev{Ret\ !\finalexprnoerr_p}} = \Game''',\src{e_0''} \\
      \src{e_0'''}=\src{let\ x=}\mmlAmmlAtbackv{\finalexprnoerr_0}\src{\ in\ e_0;e_0''} &
      \mmlAmmlAtbackdetail[\Game',()]{\mstrace[_1]}=\Game'',\src{e_1}
    }{
