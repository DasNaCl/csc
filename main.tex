...
\myfig{
  \begin{center}
    \judgbox{\wexecs{prog\ \commlib\ \library}{\configs}{\finalexprnoerr}{\trace}}{,,Run $\mmlAs$ program $\src{prog\ \library}$, giving dynamic state $\configs$\\ and emitting trace $\src{\trace}$.''}
  \typerule{$e-\text{wprog}$}{
    \vdash\src{prog\ \commlib\ \library}\operatorname{ok} &
    \execs{\commlib;\library;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\Omega}{\finalexprnoerr}{\trace}
  }{
    \wexecs{prog\ \commlib\ \library}{\configs}{\finalexprnoerr}{\trace}
  }{ws-e-prog}
  \end{center}
