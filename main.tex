...
\MK{$\src{prog\ e_0\ e_p\ e_1}$ may not be well-typed...}
...
\begin{lemma}[Plugging Well-Typed]\label{lem:plugging:welltyped}
  If
  \begin{assumptions}
  \item $\typecheck{}{\src{context\ e_1\ e_2}}{\src{\nat}[\src{\type_1\to\type_2}]}$
...
\begin{lemma}[Mid-Level Progress]\label{lem:midlevel:progress}
  If
  \begin{assumptions}
    \item $\typecheck{}{\src{component\ e_p}}{\src{\nat}[\src{\type_1\to\type_2}]}$
...
\begin{proof}
  ...
  \begin{passumptions}{H}
    \item $\typechecks{}{component\ e_p}{\tau_1\to\tau_2}$
  ...
  Invert $\typechecks{}{component\ e_p}{\tau_1\to\tau_2}$ and invert the subsequent result to get:
  \begin{passumptions}{H^t}
    \setcounter{enumi}{1}
    \item\label[ass]{asm:mmlatmsviamonitor:typep} $\typechecks{x:\tau_1}{e_p}{\tau_2}$
    \item\label[ass]{asm:mmlatmsviamonitor:int1} $\src{\tau_1}\operatorname{int}$
    \item\label[ass]{asm:mmlatmsviamonitor:int2} $\src{\tau_2}\operatorname{int}$
  \end{passumptions}

  By \Cref{tr:t-empty-store} and \Cref{asm:mmlatmsviamonitor:type1}\MK{we are missing $\typechecks{}{e_0}{\tau_1}$ now}, we have
  \begin{equation}
