...
\myfig{
}{find-judgement}{A helper-judgement that takes in another judgement and do structural recursion on the syntax of $\mmlAs$.}
...
\myfig{
  ...
  \end{center}
}{no-hole}{A check for $\mmlAs$ expressions to see whether they are a valid runtime term or not.}
...
\myfig{
  \begin{center}
    ...
    % TODO: fold over all possible expression modulo hole
  \end{center}
}{has-hole}{A check for $\mmlAs$ expressions to see whether they contain exactly one $\src{hole:(x:\type_1)\to\type_2}$.}
