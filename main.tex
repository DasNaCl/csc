...
\begin{lemma}[Base SMS via Monitor]
  ...
  \begin{assumptions}
    ...
    \item $\trg{\Omega}=\trg{\cfstate;\comp;\memstate}$
    \item\label[ass]{asm:basesmsviamonitor:step} $\exprevalt{\Omega}{e}{\Omega'}{e'}{\event}$
...
\begin{proof}
  ...
  \begin{description}
    ...
    \item $\trg{e}=\trg{let\ x=new\ n\ in\ e}$\textbf{:}
      ...
      Fourth goal is a consequence of \Cref{asm:smssafepstep:storeagree:1} sing \Cref{tr:store-empty-agree,tr:store-cons-agree}.

    \item {\large \color{red}CONTINUE}
  \end{description}
\end{proof}
