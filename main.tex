...
\myfig{
  \begin{center}
    ...
    \tmstraceagree{\specificevs{Get\ \loc\ n}}{\text{Use}\ \loc}
    }{tms-get-auth}
    %
    \typerule{TMS-Set-Authentic}{
      \delta_{\text{tms}}(\src{\loc})=\loc
    }{
      \tmstraceagree{\specificevs{Set\ \loc\ n\ v}}{\text{Use}\ \loc}
    }{tms-set-auth}
    %
...
\begin{definition}[\gls{tms} on Traces]\label{def:tempmemsafe}
  ...
  \begin{itemize}
    ...
    \item $\neg(\specificevs{Get\ \loc\ n}\le_{\src{\overline{a_{ms}}}}\specificevs{Alloc\ \loc\ s})$
    \item $\neg(\specificevs{Set\ \loc\ n\ v}\le_{\src{\overline{a_{ms}}}}\specificevs{Alloc\ \loc\ s})$
    \item $\neg(\specificevs{Dealloc\ \loc}\le_{\src{\overline{a_{ms}}}}\specificevs{Get\ \loc\ n})$
    \item $\neg(\specificevs{Dealloc\ \loc}\le_{\src{\overline{a_{ms}}}}\specificevs{Set\ \loc\ n\ v})$
...
\begin{definition}[Spatial Memory Safety]\label{def:spatmemsafe}
  We define the property $\src{smsafe}\left(\src{\overline{a_{ms}}}\right)$ as a conjunction of the following conditions:
  \begin{itemize}
    \item If $\specificevs{Alloc\ \loc\ s}\in\src{\overline{a_{ms}}}$ and $\specificevs{Get\ \loc\ n}\in\src{\overline{a_{ms}}}$, then $\src{n}<\src{s}$
    \item If $\specificevs{Alloc\ \loc\ s}\in\src{\overline{a_{ms}}}$ and $\specificevs{Set\ \loc\ n\ v}\in\src{\overline{a_{ms}}}$, then $\src{n}<\src{s}$
  \end{itemize}
\end{definition}
...
\myfig{
  \begin{center}
    ...
    \begin{array}{rll} 
      ...
      %
      \mmlAmmlAtbackdetail{(Call\ ?n)^i\cdot\overline{a}} &\ = &\mmlAmmlAtbackdetail{\overline{a}}\\
      \mmlAmmlAtbackdetail{(Ret\ !n)^i\cdot\overline{a}} &\ = &\mmlAmmlAtbackdetail{\overline{a}}\\[0.5cm]
      %
