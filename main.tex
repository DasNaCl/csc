...
\myfig{
  \begin{center}
    ...
    %
    \judgbox{\tospecificevt[^*_{\delta_{MS}}]{\trace} = \mstrace}{,,Project an $\mmlAs$ trace to MS-specific traces.''}
    %
...
\begin{lemma}[Base Preservation]\label{lem:base-preservation}
  ...
  \begin{assumptions}
    ...
    \item\label[ass]{asm:basepres:step} $\exprevals{\configs}{e}{\configs'}{e'}{\event}$
    \item $\configs'\not=\src{\lightning}$
  \end{assumptions}
  Then
  \begin{goals}
...
\begin{lemma}[Ctx Preservation]\label{lem:ctx-preservation}
  ...
  \begin{assumptions}
    \item $\typechecks{}{\src{\Omega}\triangleright e}{\src{\type}}$
    \item\label[ass]{asm:ctxpres:step} $\execs[]{\configs}{e}{\configs'}{e'}{\event}$
  \end{assumptions}
  Then
  \begin{goals}
    \item $\typechecks{}{\src{\Omega'}\triangleright e'}{\src{\type}}$
...
\begin{lemma}[Steps Preservation]\label{lem:steps-preservation}
  ...
  \begin{assumptions}
    \item $\typechecks{}{\src{\Omega}\triangleright e}{\src{\type}}$
    \item\label[ass]{asm:starpres:step} $\execs{\configs}{e}{\configs'}{e'}{\trace}$
  \end{assumptions}
  Then
  \begin{goals}
    \item $\typechecks{}{\src{\Omega'}\triangleright e'}{\src{\type}}$
...
\begin{lemma}[Determinism of Ctx-Step]\label{lem:determ:ctxstep}
  If
  \begin{assumptions}
  \item\label[ass]{asm:determ:ctxstep:a} $\exect[]{\Omega}{e}{\Omega'}{v_1}{\event_{2}}$
  \item $\exect[]{\Omega}{e}{\Omega''}{v_2}{\event_{1}}$
  \end{assumptions}
  Then
  \begin{goals}
  \item $\trg{v_{1}}=\trg{v_{2}}$
...
\myfig{
  \begin{center}
    ...
    %
    \mmlAtmmlAtmscomp{\left[\irl{v}/\irl{x}\right]}&\ = & \irl{\left[\right.}\mmlAtmmlAtmscomp{v}\irl{/}\mmlAtmmlAtmscomp{x}\irl{\left.\right]} \\[0.5cm]
    %
...
\begin{lemma}[Prim. Forward Simulation]\label{lem:sms:ctxforwardsim}
  If
  \begin{assumptions}
    \item\label[ass]{asm:sms:ctxforwardsim:evalt} $\exprevalt{\Omega}{e}{\Omega'}{e'}{\event}$
    ...
    \item $\storeagreesms[]{\smsmonitor}{\trg{\Omega}}$
  \end{assumptions}
  Then $\exists \irl{\Omega'}\ \irl{\event}$,
  \begin{goals}
...
\begin{proof}
  ...
  \begin{description}
    \item \textbf{Case} \ref{tr:tw-e-oplus}\textbf{:}
          ...
          Then $\exists \irl{\Omega'}\ \irl{\event}$,
          \begin{goals}
            \item $\exec{\irl{\Omega}}{\mmlAtmmlAtmscomp{n_{1}\oplus n_{2}}}{\irl{\Omega'}}{\mmlAtmmlAtmscomp{n_{3}}}{\irl{\event}}$
            \item $\irl{\Omega'}=\trg{\Omega}$
          \end{goals}
          Instantiate $\irl{\Omega'}=\trg{\Omega}$ and $\irl{\event}=\trg{\emptyevent}$.
          Goals follow immediately from assumptions.
    ...
    \item \textbf{Case} \ref{tr:tw-e-get-in}\textbf{:}
          ...
          \begin{passumptions}{H}
            ...
            \item\label[ass]{asm:sms:primforwardsim:storeagree:get} $\storeagreesms[]{\smsmonitor}{\trg{\Omega}}$
          \end{passumptions}
          Then $\exists \irl{\Omega'}\ \irl{\event}$,
          \begin{goals}
          ...
          From that, it's easy to conclude $\irl{x_{ACCESS}}=\trg{n}<\trg{m}=\irl{m}$.
          Since $\irl{x_{SIZE}}=\irl{m}$\MK{why?}, we can execute to the desired state $\irl{\Omega'}$.
    ...
    \item \textbf{Case} \ref{tr:tw-e-get-notin}\textbf{:}
          ...
          \begin{passumptions}{H}
            ...
            \item $\trg{\Omega}=\irl{\Omega}$
            \item $\monitorcheck[]{\smsmonitor}{\smsmonitor'}{\absevent}$
            \item\label[ass]{asm:sms:primforwardsim:storeagree:nget} $\storeagreesms[]{\smsmonitor}{\trg{\Omega}}$
            \item\label[ass]{asm:sms:primforwardsim:trace:nget} $\traceagree[]{\theta_{\delta}\left(\trg{Get\ \loc\ n;\comp}\right)}{\absevent}$
          \end{passumptions}
          Then $\exists \irl{\Omega'}\ \irl{\event}$,
          \begin{goals}
            \item $\exec{\irl{\Omega}}{\mmlAtmmlAtmscomp{x[n]}}{\irl{\Omega'}}{\mmlAtmmlAtmscomp{H^{\comp}(\loc+n)}}{\irl{\event}}$
    ...
    \item \textbf{Case} \ref{tr:tw-e-set-comp}\textbf{:}
          ...
          \begin{passumptions}{H}
            ...
            \item\label[ass]{asm:sms:primforwardsim:storeagree:set} $\storeagreesms[]{\smsmonitor}{\trg{\Omega}}$
          \end{passumptions}
          Then $\exists \irl{\Omega'}\ \irl{\event}$,
          \begin{goals}
    ...
    \item \textbf{Case} \ref{tr:tw-e-let-new-comp}\textbf{:}
          ...
          \begin{passumptions}{H}
            ...
            \item\label[ass]{asm:sms:primforwardsim:storeagree:new} $\storeagreesms[]{\smsmonitor}{\trg{\Omega}}$
          \end{passumptions}
          Then $\exists \irl{\Omega'}\ \irl{\event}$,
          \begin{goals}
            \item $\exec{\irl{\Omega}}{\mmlAtmmlAtmscomp{let\ x=new\ n\ in\ e}}{\irl{\Omega'}}{\mmlAtmmlAtmscomp{e[z/x]}}{\irl{\event}}$
            \item $\irl{\Omega'}=\trg{\Omega}$
          \end{goals}
          Note that by inversion on \Cref{asm:sms:primforwardsim:trace:set,asm:sms:primforwardsim:monitorstep:set,asm:sms:primforwardsim:storeagree:set} we have:
          \begin{passumptions}{H}
            ...
            \item $(\specificev{\loc},\bm{n})\in\smsmonitor'$
          \end{passumptions}
          ...
          Now, it's easy to see that we can execute to the desired state $\irl{\Omega'}$.
    ...
    \item \textbf{Case} \ref{tr:tw-e-delete}\textbf{:}
          ...
          \begin{passumptions}{H}
            ...
            \item $\trg{\Omega}=\irl{\Omega}$
            \item $\monitorcheck[]{\smsmonitor}{\smsmonitor'}{\absevent}$
            \item\label[ass]{asm:sms:primforwardsim:storeagree:del} $\storeagreesms[]{\smsmonitor}{\trg{\Omega}}$
          ...
          \begin{goals}
            ...
            \item $\irl{\Omega'}=\trg{\Omega}$
          \end{goals}
          Instantiate $\irl{\Omega'}=\trg{\Omega}$ and $\irl{\event}=\trg{Dealloc\ \loc;\comp}$.
          Since $\mmlAtmmlAtmscomp{delete\ x}=\irl{delete\ x}$, this case is entirely trivial.

    \item \textbf{Cases} \ref{tr:tw-e-let-x}, \ref{tr:tw-e-x-is-poisoned-yes}, \ref{tr:tw-e-x-is-poisoned-no}, \ref{tr:tw-e-proj1}, \ref{tr:tw-e-proj2}, \ref{tr:tw-e-x-hasnat}, \ref{tr:tw-e-n-hasnat}, \ref{tr:tw-e-pair-hasnat}, \ref{tr:tw-e-x-haspair}, \ref{tr:tw-e-n-haspair}, \ref{tr:tw-e-pair-haspair}, \ref{tr:tw-e-if-true} and \ref{tr:tw-e-if-false}\textbf{:}
...
\begin{lemma}[Ctx. Forward Simulation]\label{lem:sms:ctxforwardsim}
  ...
  \begin{assumptions}
    ...
    \item $\trg{\Omega}=\irl{\Omega}$
  \end{assumptions}
  Then $\exists \irl{\Omega'}\ \irl{\trace}$,
  \begin{goals}
...
\begin{proof}
  ...
  \begin{description}
    \item \textbf{Case} $\exists \trg{\finalexprnoerr'},\exect{\Omega}{e}{\Omega'}{\finalexprnoerr'}{\trace}$\textbf{:}
          By \Thmref{lem:sms:forwardsim} on what we assume in this case:
          \begin{passumptions}{H}
