...
\begin{proof}
  ...
  Plugging \Cref{asm:mmlatmsviamonitor:type0} and \Cref{asm:mmlatmsviamonitor:exec0} into \Cref{lem:steps-preservation} and inverting the result, we obtain
  ...
  Using \Cref{asm:mmlatmsviamonitor:type0} we apply \Cref{lem:substitution} to obtain:
  \begin{equation}
  ...
  Now obtain witnesses $\overline{a_p}$, $\delta_{\text{TMS}}^{(p)}$, and $\tmsmonitor$ from supplying \Cref{lem:generaltms:monitor} with \Cref{asm:mmlatmsviamonitor:typesubstx}, \Cref{asm:mmlatmsviamonitor:execp}, and \Cref{asm:mmlatmsviamonitor:agree}, such that:
