...
\myfig{
  \begin{center}
    $$
    \begin{array}{rll}
      \trg{\Omega^{\diamond(y)}} = \trg{\Omega.H;}\text{fold}&\ (\lambda \trg{\Delta}\ (\trg{x\mapsto\loc_\poison}).&if\ \trg{x}\not=\trg{y}\ then\ \\
                                                             &&\ \ \ \ \trg{x\mapsto\loc_\poison^\diamond,\Delta}\\
                                                                                                                   &&else\\
                                                                                                                   &&\ \ \ \ \trg{\Delta})\\
                                                                                                                   &\trg{\hole{\cdot}}\ \ \ \ \trg{\Omega.\Delta}&\\
      \trg{\Omega^{\diamond(\finalexprnoerr)}} = \trg{\Omega.H;}\text{fold}&\ (\lambda \trg{\Delta}\ (\trg{x\mapsto\loc_\poison}).&\trg{x\mapsto\loc_\poison^\diamond,\Delta})\ \trg{\hole{\cdot}}\ \trg{\Omega.\Delta}\\
    \end{array}
    $$
  \end{center}
