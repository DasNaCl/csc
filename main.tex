...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \mmlAmmlAtbacksubtop[\emptyset;\emptyset;\trg{\hole{\cdot}}]{\trace[_0]} = \Game; \delta; \trg{\overline{\loc}}; \src{e_0};\src{e_0'};\src{let\ x_0 = new\ n_0\ in\ e_0''} \\
      \mmlAmmlAtbacksubtop[\Game;\delta;\trg{\overline{\loc}}]{\trace[_1]} = \Game'; \delta'; \trg{\hole{\cdot}}; \src{e_1};\src{e_1'};\src{e_1''} \\
...
\begin{lemma}[Backtranslation for Non-Interacting Traces is Well-Typed]\label{lem:expr:backtranslation:welltyped}
  ...
  \item $\mmlAmmlAtbackdetail[]{\trace}=\src{e}$
  \end{assumptions}
  Then
  \begin{goals}
  \item $\typechecks{}{e}{\nat}$
...
\begin{lemma}[Backtranslation for $\comptoctx$-Interacting Events is Well-Typed]\label{lem:expr:interact:comptoctx:backtranslation:welltyped}
  If
  \begin{assumptions}
  \item\label[ass]{asm:expr:interact:comptoctx:backtranslation:welltyped} $\mmlAmmlAtbackcomptoctx[\Game;\delta;\trg{\overline{\loc}}]{\event}=\src{e}$
  \end{assumptions}
...
\begin{lemma}[Backtranslation for Call-$\ctxtocomp$ is Well-Typed]\label{lem:expr:interact:call:comptoctx:backtranslation:welltyped}
  If
  \begin{assumptions}
  \item\label[ass]{asm:expr:interact:call:ctxtocomp:backtranslation:welltyped} $\mmlAmmlAtbackctxtocomp[\Game;\delta;\trg{\loc,\overline{\loc}}]{Call\ \ctxtocomp\ foo\ \valueexpr}=\Game';\delta;\trg{\loc,\overline{\loc'}};\src{e'}$
...
\begin{lemma}[Backtranslation for End-$\ctxtocomp$ is Well-Typed]\label{lem:expr:interact:end:ctxtocomp:backtranslation:welltyped}
  If
  \begin{assumptions}
  \item\label[ass]{asm:expr:interact:ret:ctxtocomp:backtranslation:welltyped} $\mmlAmmlAtbackctxtocomp[\Game;\delta;\trg{\hole{\cdot}}]{End\ \valueexpr}=\Game';\delta';\trg{\hole{\cdot}};\src{e}$
  \end{assumptions}
  Then,
  \begin{goals}
  \item $\typechecks{}{e}{\nat\to\bot}$
...
\begin{lemma}[Backtranslation Correctness of $\trg{Start}$]\label{lem:exprbacktranslation:vbeg:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackcomptoctx[\emptyset;\emptyset;\trg{\hole{\cdot}}]{Start}=\trg{\hole{\cdot}};\src{42}$
...
\begin{lemma}[Backtranslation Correctness of $\trg{Ret}$]\label{lem:exprbacktranslation:beg:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackcomptoctx[\Game;\delta;\trg{\overline{\loc}}]{Ret\ \comptoctx\ \valueexpr}=\trg{\overline{\loc'}};\src{delete\ z;}\mmlAmmlAtbackv[]{\valueexpr}$
...
\begin{lemma}[Middle of Backtranslation Correctness]\label{lem:exprbacktranslation:mid:wrapper:correct}
  ...
  \item\label[ass]{asm:exprbacktranslation:mid:correct:backtrans} $\mmlAmmlAtbackdetail[]{\trace}=\src{e}$
...
%  \item $\src{\library}=\left\{\src{main}\mapsto\src{e_{main}}\right\}\src{\linker\library_{comp}}$
  ...
  \item\label[goal]{goal:exprbacktranslation:mid:correct:tracerel} $\src{\trace}\thexlangtraceeq[\delta;\emptyset]\trg{\trace}$
  \end{goals}
\end{lemma}
\begin{proof}
...
\begin{lemma}[Backtranslation Correctness of $\trg{Call\ \ctxtocomp}$]\label{lem:exprbacktranslation:end:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackctxtocomp[\Game;\delta;\trg{\overline{\loc}}]{Call\ \ctxtocomp\ foo\ \valueexpr}=\Game';\delta';\trg{\overline{\loc'}};\src{let\ z = new\ 42\ in\ call\ foo\ }\mmlAmmlAtbackv[]{\valueexpr}$
...
\begin{lemma}[Backtranslation Correctness of $\trg{End}$]\label{lem:exprbacktranslation:vend:wrapper:correct}
  ...
  \item\label[ass]{lem:exprbacktranslation:vend:wrapper:correct:backtrans} $\mmlAmmlAtbackctxtocomp[\Game;\delta;\trg{\hole{\cdot}}]{End\ n}=\Game';\delta';\trg{\hole{\cdot}};\src{let\ z=new\ 42\ in\ delete\ z;return\ }\mmlAmmlAtbackv[]{\valueexpr}$
...
%    \item $\delta' = \delta \cup \left\{\src{\loc}\mapsto\trg{z}\right\}$
  ...
  \begin{passumptions}{H}
    ...
    \item\label[ass]{asm:exprbacktranslation:vend:wrapper:correct:kontsqe} $\xlangbackstateeq[]{(\hole{\cdot};main),\hole{\cdot}}{(\hole{\cdot};main),\hole{\cdot}}$
  \end{passumptions}
  ...
  \noindent
  Use \Cref{asm:exprbacktranslation:vend:wrapper:correct:hdeltaeq,tr:empty-kontstack-qe,asm:exprbacktranslation:vend:wrapper:correct:lib} to solve \Cref{goal:exprbacktranslation:vend:wrapper:correct:stateeq}.
...
\begin{proof}
  ...
  \begin{passumptions}{H}
    \item\label[ass]{asm:backtrans:correct:traceeq0} $\trg{\trace} = \trg{Start;\comp\cdot\trace[_{0}]\cdot Call\ \ctxtocomp\ foo\ \valueexpr_{0};\ctx\cdot\trace[_{comp}]\cdot Ret\ \comptoctx\ \valueexpr_{1};\comp\cdot\trace[_{1}]\cdot End\ \valueexpr_{2};\ctx}$
  ...
  \begin{passumptions}{H}
    ...
    \item\label[ass]{asm:backtranscorr:exect0a} $\exect{foo,\hole{\cdot};\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{0}}{\Omega'}{\finalexprnoerr}{\trace[_{a}]}$
  \end{passumptions}
  ...
  \begin{passumptions}{H}
    \setcounter{enumi}{35}
    \item\label[ass]{asm:backtrans:execs0} $\execs{foo,\hole{\cdot};\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{01}}{Start;\comp}$
    \item\label[ass]{asm:backtrans:correct:backstaterel0} $\xlangbackstateeq[\emptyset;\emptyset]{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\hole{\cdot};\hole{\cdot};\hole{\cdot}}$
    \item $\src{Start;\comp}\thexlangtraceeq[\emptyset;\emptyset]\trg{Start;\comp}$
  \end{passumptions}

  By transitivity, we can split \Cref{asm:backtranscorr:exect0a} arbitrarily, noting \Cref{asm:backtranscorr:nonint0}:
  \begin{passumptions}{H}
    \setcounter{enumi}{38}
    \item\label[ass]{asm:backtranscorr:exect1} $\exect{foo,\hole{\cdot};\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{0}}{foo,\hole{\cdot};\library;\kontstack,(\hole{\cdot};main),\hole{\cdot};\ctx;H^{\ctx}_{0};\hole{\cdot};\Delta_{0}}{e_{1}}{\trace_{0}}$
  ...
  \begin{passumptions}{H}
    \setcounter{enumi}{41}
    \item\label[ass]{asm:backtrans:execs1} $\execs{foo,\hole{\cdot};\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{01}}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{K\hole{42}}{\trace[_{0}]}$
    \item $\xlangbackstateeq[\emptyset;\emptyset]{foo,\hole{\cdot};\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}$
    \item\label[ass]{asm:backtrans:correct:backstaterel1} $\src{\trace[_{0}]}\thexlangtraceeq[\emptyset;\emptyset]\trg{\trace[_{0}]}$
  \end{passumptions}
  ...
  \begin{passumptions}{H}
    ...
    \item $\src{\trace[_{1}]}\thexlangtraceeq[\delta;\src{X}]\trg{Call\ \ctxtocomp\ foo\ \valueexpr_{0};\ctx}$
  \end{passumptions}
  ...
  Assume\MK{derive this somehow}:
  \begin{passumptions}{H}
    \setcounter{enumi}{57}
    \item\label[ass]{asm:backtranscorr:comptypchecks} $\typechecks{}{foo,\hole{\cdot};\library;(K,foo),(\hole{\cdot};main),\hole{\cdot};\comp;\memstate\triangleright e_{foo}}{\nat}$
  ...
  \begin{passumptions}{H}
    ...
    \item $\xlangtraceeq[\delta';\src{X}]{\trace[_{comp}]}{\trace[_{comp}]}$
  \end{passumptions}
  ...
  \begin{passumptions}{H}
    ...
    \item $\xlangtraceeq[\delta';\src{L}]{\trace[_{2}]}{Ret\ \comptoctx\ \valueexpr_{1}}$
  \end{passumptions}
  ...
  \begin{passumptions}{H}
    ...
    \item\label[ass]{asm:backtrans:correct:tracerel3} $\src{\trace[_{3}]}\thexlangtraceeq[\delta';\emptyset]\trg{\trace[_{1}]}$\MK{context could do allocations... don't we need another way to ignore the target actions then?}
  \end{passumptions}

  Finally, use \Thmref{lem:exprbacktranslation:vend:wrapper:correct} with \Cref{asm:backtranscorr:liblink,asm:backtranscorr:rellibdom,asm:backtranscorr:exect5a,asm:backtranscorr:backtrans:end,asm:backtrans:correct:backstaterel3} to acquire:\MK{add freshness and the other stuff..}
  \begin{passumptions}{H}
    \setcounter{enumi}{78}
    \item $\src{L'}=\src{L}\cup\{\src{\loc'}\}$
    \item $\src{X''}=\src{X'}\cup\{\src{Alloc\ \loc'\ 42},\src{Dealloc\ \loc'}\}$
    \item\label[ass]{asm:backtrans:execs6} $\execs{foo,\hole{\cdot};\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\memstate''}{K_{e}[return\ \valueexpr_{2}]}{\commlib;\library;\hole{\cdot};\ctx;\memstate''}{\valueexpr_{2}}{\trace_{4}}$
    \item $\xlangbackstateeq[\delta'';\src{L'}]{foo,\hole{\cdot};\library;\hole{\cdot};\ctx;\memstate''}{\commlib;\library;\hole{\cdot};\ctx;\memstate''}$
    \item\label[ass]{asm:backtrans:correct:backstaterel3} $\src{\trace_{4}}\thexlangtraceeq[\delta'';\src{X''}]\trg{End\ \valueexpr_{2}}$
  \end{passumptions}
  ...
  Similarily, \Cref{goal:backtrans:correct:stateeq} by transitivity, making use of ...
  \MK{lookup refs}

  Lastly, \Cref{goal:backtrans:correct:traceeq} by transitivity, making use of ...

% \label[goal]{goal:backtrans:correct:execs}
% \label[goal]{goal:backtrans:correct:stateeq}
% \label[goal]{goal:backtrans:correct:traceeq}end{incompleteproof}
\end{proof}
