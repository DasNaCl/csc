...
.\MK{change \Cref{tr:trg-filter-context} rule to only talk about those that we don't care about}
\myfig{
  \begin{center}
    ...
    \typerule{trg-filter-empty}{
      ...
      \tospecificevt[^*_{\trg{\bullet}}]{\hole{\cdot}} = \specificev{\hole{\cdot}}
    }{trg-filter-empty}
    %
    \typerule{trg-filter-cons-relevant}{
      \tospecificevt[_{\trg{\bullet}}]{\event} = \specificev{\event} &
      \tospecificevt[^*_{\trg{\bullet}}]{\trace} = \mstrace &
      \specificev{\event} \not= \specificev{\emptyevent}
    }{
      \tospecificevt[^*_{\trg{\bullet}}]{\event\cdot\trace} = \specificev{\event}\cdot\mstrace
    }{trg-filter-cons-relevant}
    %
    \typerule{trg-filter-cons-relevant}{
      \tospecificevt[_{\trg{\bullet}}]{\event} = \specificev{\emptyevent} &
      \tospecificevt[^*_{\trg{\bullet}}]{\trace} = \mstrace
    }{
      \tospecificevt[^*_{\trg{\bullet}}]{\event\cdot\trace} = \mstrace
    }{trg-filter-cons}
  \end{center}
