...
\myfig{
  ...
  \mi{Events}~\src{\event} \bnfdef& \src{\emptyevent} \mid \src{Alloc\ \loc\ n} \mid \src{Dealloc\ \loc} \mid \src{Get\ \loc\ n} \mid \src{Set\ \loc\ n} \\
                             & \mid \src{\lightning} \mid \src{Call\ ?foo\ n} \mid \src{Ret\ !n} \\
  \end{aligned}
  \end{gather*}
...
\myfig{
  ...
  \typerule{$e-\src{get}-\in$}{
    ...
    \exprevals{\library;\kontstack;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{x[n]}{\library;\kontstack;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{H(\loc+n)}{Get\ \loc\ n}
  }{w-e-get-in}
  %
  \typerule{$e-\src{get}-\notin$}{
    \src{\loc}\notin\text{dom }\src{H}
  }{
    \exprevals{\library;\kontstack;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{x[n]}{\library;\kontstack;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{1729}{Get\ \loc\ n}
  }{w-e-get-notin}
  %
  \typerule{$e-\src{set}$}{
...
\myfig{
  ...
  \typerule{$e-\text{wprog}$}{
    ...
    \wexecs{prog\ \library}{\configs}{\finalexpr}{\trace}
  }{ws-e-prog}
  \end{center}
...
\myfig{
  ...
  \mi{Expressions}~\trg{e} \bnfdef&\ \trg{\finalexpr} \mid \trg{e_{1} \oplus e_{2}} \mid \trg{x[e]} \mid \trg{let\ x = e_{1}\ in\ e_{2}}\mid \trg{x[e_{1}]\leftarrow e_{2}} \\
    & \mid \trg{let\ x=new\ e_{1}\ in\ e_{2}} \mid \trg{delete\ x} \mid \trg{return\ e} \mid \trg{call\ x\ e} \\
  ...
  \trg{K}\bnfdef &\ \trg{\hole{\cdot}}\mid \trg{K\oplus e}\mid \trg{v\oplus E}\mid \trg{x[K]}\mid \trg{let\ x=K\ in\ e} \\
                 ...
                 &\mid \trg{\langle K; e\rangle} \mid \trg{\langle n; K\rangle} \mid \trg{ifz\ K\ then\ e_1\ else\ e_2} \\
