...
\myfig{
  ...
  \typerule{$t-\text{ctx}$}{
    \hasholes{x:\type_1}{e_1}{\type_2}&
    \typechecks{x:\type_1}{let\ y=e_1\ in\ e_2}{\nat}&
    %\typechecks{}{e_1}{\type_1}&
...
\begin{proof}
  ...
  Therefore, we can plug using \Cref{tr:src-plugging} which yields \\$\src{prog}\ (\src{let\ h=hole:(x:\nat)\to\nat\ in\ h})\ (\src{e_p})\ (\src{y})$.\\[0.3cm]
...
\begin{lemma}[Fill Typing]\label{lem:fillTyping}
  ...
  Then
  \begin{goals}
    \item $\typechecks{}{e_{1}'}{\type_{2}}$
    \item $\typechecks{y:\type_{2}}{e_{2}}{\nat}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
  ...
  \begin{description}
    \item[$\src{e}=\src{delete\ x}$:]
      ...
      \item[\Cref{tr:store-cons-agree}:] \ \\
        If
        \begin{assumptions}
        \item $\typechecks{}{\src{H;\Delta_1},\src{x\mapsto\loc_\poisonless},\src{\Delta_2}\triangleright \src{delete\ x}}{\type}$
    ...
    \item[$\src{e}=\src{returning\ \finalexprnoerr}$:]
      If
      \begin{assumptions}
        \item $\typechecks{}{\src{\Omega}\triangleright \src{returning\ \finalexprnoerr}}{\type}$
    ...
    \item[$\src{e}=\src{calling\ \finalexprnoerr}$:]
      If
      \begin{assumptions}
        \item $\typechecks{}{\src{\Omega}\triangleright \src{calling\ \finalexprnoerr}}{\type}$
    ...
    \item[$\src{e}=\src{let\ x=new\ n\ in\ e'}$:]
      If
      \begin{assumptions}
        \item $\typechecks{}{\src{H};\src{\Delta}\triangleright\src{let\ x=new\ n\ in\ e'}}{\type}$
    ...
    \item[$\src{e}=\src{x[n]}$:]
      If
      \begin{assumptions}
        \item $\typechecks{}{\src{H};\src{\Delta_1,x\mapsto\loc_\poison,\Delta_2}\triangleright\src{x[n]}}{\type}$
...
\begin{proof}
  ...
  \begin{passumptions}{F}
    \item\label[ass]{asm:mmlatmsviamonitor:e0typs} $\typechecks{}{e_{0}'}{\type_{2}}$
    \item\label[ass]{asm:mmlatmsviamonitor:e1typs} $\typechecks{y:\type_{2}}{e_{1}}{\nat}$
  \end{passumptions}
  Note that by \Cref{tr:t-empty-store} and \Cref{tr:w-t-prog} using \Cref{asm:mmlatmsviamonitor:e0typs} we have:
  \begin{passumptions}{F}
    \setcounter{enumi}{2}
    \item\label[ass]{asm:mmlatmsviamonitor:e0progtyps} $\typechecks{}{\hole{\cdot};\hole{\cdot}\triangleright e_{0}'}{\type_{2}}$
  \end{passumptions}
  ...
  \begin{passumptions}{F}
    \setcounter{enumi}{3}
    \item\label[ass]{asm:mmlatmsviamonitor:epoprogtyps} $\typechecks{}{\Omega_{0}\triangleright e_{po}}{\type_{2}}$
  \end{passumptions}
  ...
  \begin{passumptions}{F}
    \setcounter{enumi}{4}
    \item\label[ass]{asm:mmlatmsviamonitor:e0pprogtyps} $\typechecks{}{\Omega_{po}\triangleright e_{0}''}{\type_{2}}$\todo{really? make an example}
  \end{passumptions}
  ...
  \begin{passumptions}{F}
    \setcounter{enumi}{5}
    \item\label[ass]{asm:mmlatmsviamonitor:e1substprogchecks} $\typechecks{}{\Omega_{0}'\triangleright e_{1}[\finalexprnoerr_{p}'/y]}{\nat}$
  \end{passumptions}
