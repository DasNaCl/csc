...
\myfig{
  \begin{center}
    ...
    \typerule{o-filter-comp-alloc}{
      ...
      \tospecificevo[_{\delta_{MS}}]{Alloc\ \loc\ n;\comp;\sigma} = \specificev{Alloc\ \loc\ n;\sigma}
    }{o-filter-comp-alloc}
    %
    \typerule{o-filter-comp-dealloc}{
      \delta_{MS}(\obj{\loc})=\specificev{\loc}
    }{
      \tospecificevo[_{\delta_{MS}}]{Dealloc\ \loc;\comp;\sigma} = \specificev{Dealloc\ \loc;\sigma}
    ...
    \typerule{o-filter-comp-get-noleak}{
      ...
      \tospecificevo[_{\delta_{MS}}]{\widehat{Get}\ \loc\ n;\comp;\sigma} = \specificev{Use\ \loc\ n;\unlock}
    ...
    \typerule{o-filter-comp-set-noleak}{
      ...
      \tospecificevo[_{\delta_{MS}}]{\widehat{Set}\ \loc\ n\ \valueexpr;\comp;\sigma} = \specificev{Use\ \loc\ n;\unlock}
    ...
    \typerule{o-filter-comp-get-leak}{
      ...
      \tospecificevo[_{\delta_{MS}}]{Get\ \loc\ n;\comp;\sigma} = \specificev{Use\ \loc\ n;\sigma}
    ...
    \typerule{o-filter-comp-set-leak}{
      ...
      \tospecificevo[_{\delta_{MS}}]{Set\ \loc\ n\ \valueexpr;\comp;\sigma} = \specificev{Use\ \loc\ n;\sigma}
...
\myfig{
  \begin{center}
    ...
    \judgbox{\mmlAtmsmmlAtscctcomptoctx[\Game;\delta]{\event}=\irl{e}}{,,Given a \varmapbacktransds $\Game$ and $\delta$ yield an $\mmlAtms$ expression\\from target $\comptoctx$-interaction-event $\obj{\event}$.''}
    %
    \typerule{scct-backtrans-start}{
    }{
      \mmlAtmsmmlAtscctcomptoctx[\emptyset;\emptyset]{\obj{Start}} = \irl{42}
...
%     \mmlAtmsmmlAtscctcomptoctx[\Game;\delta;\obj{\loc,\overline{\loc}}]{\obj{Ret\ \comptoctx\ \valueexpr}}=\obj{\overline{\loc}};\irl{e;}\mmlAtmsmmlAtscctv[]{\valueexpr}
      \mmlAtmsmmlAtscctcomptoctx[\Game;\delta]{\obj{Ret\ \comptoctx\ \valueexpr}}=\mmlAtmsmmlAtscctv[]{\valueexpr}
    }{scct-backtrans-ret-comptoctx}
    %
    %
    \judgbox{\mmlAtmsmmlAtscctctxtocomp[\Game;\delta]{\event}=\Game';\delta';\irl{e}}{,,Given a \varmapbacktransds $\Game$ and $\delta$ construct a \varmapbacktransds $\Game'$,\\ a $\delta'$, and an $\mmlAtscct$ expression from target\\$\ctxtocomp$-interaction-event $\obj{\event}$.''}
    %
...
%     \mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\overline{\loc}}]{\obj{Call\ \ctxtocomp\ foo\ \valueexpr}}=\Game_z;\delta';\obj{\loc,\overline{\loc}};\irl{e}
      \mmlAtmsmmlAtscctctxtocomp[\Game;\delta]{\obj{Call\ \ctxtocomp\ foo\ \valueexpr}}=\Game_z;\delta;\mmlAtmsmmlAtscctv[]{\valueexpr}
...
%     \mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\hole{\cdot}}]{\obj{End\ \valueexpr}}=\Game_z;\delta';\obj{\hole{\cdot}};\irl{e}
      \mmlAtmsmmlAtscctctxtocomp[\Game;\delta]{\obj{End\ \valueexpr}}=\Game_z;\delta;\mmlAtmsmmlAtscctv[]{\valueexpr}
...
\myfig{
  \begin{center}
    \judgbox{\mmlAtmsmmlAtscctsubtop[\Game;\delta]{\event[_1]\cdot\trace\cdot\event[_2]}=\Game';\delta';\irl{e_1};\irl{e_2};\irl{e_3}}{,,Given a \varmapbacktransds $\Game$ and $\delta$,\\construct a \varmapbacktransds $\Game'$, a $\delta'$, and an $\mmlAtms$\\ensemble of expressions from target-\\trace $\obj{\mstrace}$ which starts with a $\ctxtocomp$ event\\and ends in a $\comptoctx$.''}
    %
    \typerule{scct-subtoplevel-backtrans}{
      \vdash \obj{\trace} \operatorname{non-int-\obj{\trace}}\\
      \mmlAtmsmmlAtscctcomptoctx[\Game;\delta]{\obj{\event[_1]}}=\irl{e_1} &
      \mmlAtmsmmlAtscctdetail[]{\obj{\trace}}=\irl{e_2} &
      \mmlAtmsmmlAtscctctxtocomp[\Game;\delta]{\obj{\event[_2]}}=\Game';\delta';\irl{e_3} \\
    }{
      \mmlAtmsmmlAtscctsubtop[\Game;\delta]{\obj{\event[_1]\cdot\trace\cdot\event[_2]}}=\Game';\delta'; \irl{e_1}; \irl{e_2}; \irl{e_3}
...
%      \mmlAtmsmmlAtscctsubtop[\emptyset;\emptyset;\obj{\hole{\cdot}}]{\color{black}\tospecificevo[^*_\obj{\bullet}]{\trace[_0]}} = \Game; \delta; \obj{\overline{\loc}}; \irl{e_0};\irl{e_0'};\irl{let\ x_0 = new\ n_0\ in\ e_0''} \\
      \mmlAtmsmmlAtscctsubtop[\emptyset;\emptyset]{\color{black}\tospecificevo[^*_\obj{\bullet}]{\trace[_0]}} = \Game; \delta; \irl{e_0};\irl{e_0'};\irl{e_0''} \\
      \mmlAtmsmmlAtscctsubtop[\Game;\delta]{\color{black}\tospecificevo[^*_\obj{\bullet}]{\trace[_1]}} = \Game'; \delta'; \irl{e_1};\irl{e_1'};\irl{e_1''} \\
...
\begin{lemma}[Backtranslation Correctness of $\obj{Start}$]\label{lem:cct:exprbacktranslation:vbeg:wrapper:correct}
  ...
  \item\label[ass]{asm:exprbacktranslation:vbeg:wrapper:correct:exect} $\execo[]{\commlib;\library;\hole{\cdot};\comp;0;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\commlib;\library;(\hole{\cdot}; main),\hole{\cdot};\ctx;0;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{main}[0/x]}{Start;\comp}$
  ...
  \item $\xlangstateeqc[\emptyset;\irl{\hole{\cdot}}]{\commlib;\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;\hole{\cdot};\comp;0;\hole{\cdot};\hole{\cdot};\hole{\cdot}}$
  ...
  \item\label[goal]{goal:exprbacktranslation:vbeg:wrapper:correct:backstateeq} $\xlangstateeqc[\emptyset;\irl{\hole{\cdot}}]{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;0;\hole{\cdot};\hole{\cdot}}$
