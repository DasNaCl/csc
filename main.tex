...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case $\exprevals{\Omega}{if\ n_1<n_2\ then\ e_1\ else\ e_2}{\Omega}{e_1}{\varepsilon}$:}

      If
      \begin{passumptions}{H}
      \item\label[ass]{asm:step:forwardsim:case9:stateeq} $\xlangstateeq{\Omega}{\Omega}$
      \item $\typechecks{}{\Omega\triangleright if\ n_1<n_2\ then\ e_1\ else\ e_2}{\nat}$
      \item\label[ass]{asm:step:forwardsim:case9:less} $n_1<n_2$
      \end{passumptions}
      Then $\exists\delta'\ \trg{\Omega'}\ \trg{\event}$,
      \begin{goals}
        \item $\delta\subseteq\delta'$
        \item $\expreval{\trg{\Omega}}{\mmlAmmlAtcomp{if\ n_1<n_2\ then\ e_1\ else\ e_2}}{\trg{\Omega'}}{\mmlAmmlAtcomp{e_1}}{\trg{\event}}$
        \item $\xlangeventeq{\varepsilon}{\event}$
        \item $\xlangstateeq{\Omega}{\Omega'}$
      \end{goals}
      ...
      \begin{goals}
        ...
        \item\label[goal]{goal:step:forwardsim:case9:eval} $\expreval{\trg{\Omega}}{\trg{if\ n_1<n_2\ then\ }\mmlAmmlAtcomp{e_1}\trg{\ else\ }\mmlAmmlAtcomp{e_2}}{\trg{\Omega}}{\mmlAmmlAtcomp{e_1}}{\trg{\varepsilon}}$
      ...
      \Cref{goal:step:forwardsim:case9:eval} follows by definition of \Cref{tr:tw-e-if-less,asm:step:forwardsim:case9:less}.
    ...
    \item \textbf{Case $\exprevals{\Omega}{if\ n_1<n_2\ then\ e_1\ else\ e_2}{\Omega}{e_2}{\varepsilon}$:}
      ...
      This case is completely analogous to the previous case, the only difference is the use of \Cref{tr:tw-e-if-noless} instead of \Cref{tr:tw-e-if-less}.
  \end{description}
\end{proof}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-call}{
      ...
      \mmlAmmlAtbackdetail{\specificevt{Call\ ?n}} = \Game',\mmlAmmlAtbackv{n}
    }{backtrans-call}
   %
...
\begin{lemma}[Backtranslation Correctness]\label{lem:backtranslation:correct}
  ...
  \item $\mstrace=\thetospecificfilter{\trace}$
  \item $\mmlAmmlAtbackdetail{\specificevt{Ret\ !n_0}\cdot\mstrace\cdot\specificevt{Call\ ?n_1}}=\Game',\src{e}$
  \item $\xlangstateeq{\Omega}{\Omega}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  \end{assumptions}
  ...
  \item $\src{Ret\ !}\mmlAmmlAtbackv{n_0}\src{\cdot\trace[_1]\cdot Call\ ?}\mmlAmmlAtbackv{n_1}\thexlangtraceeq[\delta_1]\trg{Ret\ !n_0\cdot\trace\cdot Call\ ?n_1}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
