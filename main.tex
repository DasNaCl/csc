...
\myfig{
  ...
  \mi{Store}~\src{\Delta} \bnfdef\ \src{\hole{\cdot}} \mid \src{x\mapsto\loc^{\sandboxtag}_\poison},\Deltas\\
  %
...
\myfig{
  \begin{center}
    ...
    \typechecks{\library}{x\mapsto\loc^{\sandboxtag}_\poisonless,\Delta}{x:\ptr,\Gamma}
    }{t-ptr-store}
    %
    \typerule{$T\ptr\text{poison}$}{
    \typechecks{\library}{\Delta}{\Gamma}
    }{
    \typechecks{\library}{x\mapsto\loc^{\sandboxtag}_\poisoned,\Delta}{\Gamma}
    }{t-poison-store}
  \end{center}
...
\myfig{
  ...
  \typerule{$e-\src{get}-\in$}{
    ...
    \exprevals{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\sandboxtag}_\poison,\Delta_2}{x[n]}{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\sandboxtag}_\poison,\Delta_2}{H^{\sandboxtag}(\loc+n)}{Get\ \loc^{\sandboxtag}\ n}
  }{w-e-get-in}
  %
  \typerule{$e-\src{get}-\notin$}{
    \src{\loc}\notin\text{dom }\src{H^{\sandboxtag}}
  }{
    \exprevals{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\sandboxtag}_\poison,\Delta_2}{x[n]}{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\sandboxtag}_\poison,\Delta_2}{1729}{Get\ \loc^{\sandboxtag}\ n}
  }{w-e-get-notin}
  %
  \typerule{$e-\src{set}-\ctx$}{
    \src{H^{\ctx'}} = \src{H^{\ctx}}(\src{\loc+n}\mapsto \src{v})
  }{
    \exprevals{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\ctx}_\poison,\Delta_2}{x[n]\leftarrow v}{\cfstate;\sandboxtag;H^{\ctx'};H^{\comp};\Delta_1,x\mapsto\loc^{\ctx}_\poison,\Delta_2}{v}{Set\ \loc^{\ctx}\ n\ v}
  }{w-e-set-ctx}
  %
  \typerule{$e-\src{set}-\comp$}{
    \src{H^{\comp'}} = \src{H^{\comp}}(\src{\loc+n}\mapsto \src{v})
  }{
    \exprevals{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\comp}_\poison,\Delta_2}{x[n]\leftarrow v}{\cfstate;\sandboxtag;H^{\ctx};H^{\comp'};\Delta_1,x\mapsto\loc^{\comp}_\poison,\Delta_2}{v}{Set\ \loc^{\comp}\ n\ v}
  }{w-e-set-comp}
  %
  ...
  \typerule{$e-\src{delete}$}{
    ...
    \exprevals{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\sandboxtag'}_\poison,\Delta_2}{delete\ x}{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto\loc^{\sandboxtag'}_\poisoned,\Delta_2}{0}{Dealloc\ \loc^{\sandboxtag'}}
  }{w-e-delete}
  %
  ...
  \exprevals{\cfstate;\ctx;H^{\ctx};H^{\comp};\Delta}{let\ x=new\ n\ in\ e}{\cfstate;\ctx;H^{\ctx'};H^{\comp};z\mapsto \loc^{\ctx}_\poisonless,\Delta}{e[z/x]}{Alloc\ \loc^{\ctx}\ n}
  }{w-e-let-new-ctx}
  %
  ...
  \exprevals{\cfstate;\comp;H^{\ctx};H^{\comp};\Delta}{let\ x=new\ n\ in\ e}{\cfstate;\comp;H^{\ctx};H^{\comp'};z\mapsto \loc^{\comp}_\poisonless,\Delta}{e[z/x]}{Alloc\ \loc^{\comp}\ n}
  }{w-e-let-new-comp}
  %
...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{ctx}-\src{call}-\text{notsame}$}{
      ...
      \execs[]{\Omega}{K[call\ foo\ \finalexprnoerr]}{\Omega'}{e[x/\valueexpr]}{Call\ \comm\ foo\ \finalexprnoerr}
    ...
    \typerule{$e-\text{ctx}-\src{call}-\text{same}$}{
      ...
      \execs[]{\Omega}{K[call\ foo\ \finalexprnoerr]}{\Omega'}{e[x/\valueexpr]}{Call\ \nocomm\ foo\ \finalexprnoerr}
    }{w-e-ectx-call-same}
    %
    \typerule{$e-\text{ctx}-\src{return}-$main}{
    }{
      \exec[]{\src{\commlib;\library;\hole{\cdot}^{main},\hole{\cdot};\ctx;\memstate}}{\src{K'[return\ \valueexpr]}}{\src{\commlib;\library;\hole{\cdot};\comp;\memstate}}{\src{\valueexpr}}{\src{End\ \valueexpr}}
    }{w-e-ectx-ret-main}
    %
    \typerule{$e-\text{ctx}-\src{return}-\text{notsame}$}{
      ...
      \exec[]{\src{\commlib;\library;K^{foo},\kontstack;\sandboxtag;\memstate}}{\src{K'[return\ \finalexprnoerr]}}{\src{\commlib;\library;\kontstack;\neg\sandboxtag;\memstate}}{\src{K[\finalexprnoerr]}}{\src{Ret\ \comm\ \finalexprnoerr}}
    }{w-e-ectx-ret-notsame}
    %
    \typerule{$e-\text{ctx}-\src{return}-\text{same}$}{
      \src{foo}\in_{\src{\sandboxtag}}\src{\commlib}
    }{
      \exec[]{\src{\commlib;\library;K^{foo},\kontstack;\sandboxtag;\memstate}}{\src{K'[return\ \finalexprnoerr]}}{\src{\commlib;\library;\kontstack;\sandboxtag;\memstate}}{\src{K[\finalexprnoerr]}}{\src{Ret\ \nocomm\ \finalexprnoerr}}
    }{w-e-ectx-ret-same}
    %
...
\myfig{
  \begin{center}
    ...
    \judgbox{\tospecificevs[_{\delta_{MS}}]{\event} = \msevent}{,,Project an $\mmlAs$ event $\src{\event}$ to $\msevent$.''}
    %
  ...
  \begin{description}
    \item[$\src{e}=\src{delete\ x}$:]
      ...
      \begin{passumptions}{F}
        \item $\storeagreetms{\tmsmonitor[_{1}]}{\src{\Delta_{1}}}$
        \item\label[ass]{asm:basetmsmonitor:storeagree:unfolded} $\storeagreetms{\{\specificev{\loc}\}\cup\emptyset}{\src{x\mapsto\loc_{\poison},\hole{\cdot}}}$
        \item $\storeagreetms{\tmsmonitor[_{2}]}{\src{\Delta_{2}}}$
        \item $\tmsmonitor=\tmsmonitor_{1}\cup\{\specificev{\loc}\}\cup\tmsmonitor_{2}$
      \end{passumptions}
...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case $\exprevals{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{delete\ x}{\cfstate;H;\Delta_1,x\mapsto\loc_\poisoned,\Delta_2}{0}{Dealloc\ \loc}$:}
      ...
      First note that $\trg{\Omega}=\trg{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}$, because of \Cref{asm:step:forwardsim:case2:stateeq}.
      ...
      Similarily for \Cref{goal:step:forwardsim:case2:stateeq}, apply \Cref{tr:state-eq,tr:cons-memstate-eq} ,,suitably'' so that what is left to show is
    ...
    \item \textbf{Case $\exprevals{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{x[n]}{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{v}{Get\ \loc\ n}$:}
      ...
      \end{goals}
      First note that $\trg{\Omega}=\trg{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}$, because of \Cref{asm:step:forwardsim:case3:stateeq}.
    ...
    \item \textbf{Case $\exprevals{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{x[n]\leftarrow v}{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{v}{Set\ \loc\ n}$:}
      ...
      \begin{goals}
        ...
        \item $\xlangstateeq{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{\Omega'}$
      \end{goals}
      First note that $\trg{\Omega}=\trg{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}$, because of \Cref{asm:step:forwardsim:case4:stateeq}.
    ...
    \item \textbf{Case $\exprevals{\cfstate;H;\Delta}{let\ x\ =\ new\ n\ in\ e}{\cfstate;H';z\mapsto\loc_\poisonless,\Delta}{e[z/x]}{Alloc\ \loc\ n}$:}
      ...
      \end{goals}
      First note that $\trg{\Omega}=\trg{H;z\mapsto\loc_\poisonless,\Delta}$, because of \Cref{asm:step:forwardsim:case5:stateeq}.
    ...
    \item\label[goal]{goal:step:forwardsim:case5:eval} $\expreval{\trg{\cfstate;H;\Delta}}{\trg{let\ x\ =\ new\ n\ in\ }\mmlAmmlAtcomp{e}}{\trg{\cfstate;H;z\mapsto\loc_\poisonless,\Delta}}{\mmlAmmlAtcomp{e}\trg{[z/x]}}{\trg{Alloc\ \loc\ n}}$
      ...
      Apply \Cref{tr:state-eq,tr:cons-memstate-eq} on \Cref{goal:step:forwardsim:case5:stateeq}, what is left to show is $\mmlAmmlAtcomp{x}=\trg{x}$, follows immediately by definition of the compiler, and $(\delta\cup\left\{\src{\loc}\mapsto\trg{\loc}\right\})(\src{\loc})=\trg{\loc}$, which follows by definition.
...
\section{...allow passing References}

Here, we describe what changes need to be made to allow passing references.
...
\myfig{
  ...
  \typerule{int-$\src{\nat}$-refs}{
    ...
    \vdash\src{\nat}\operatorname{int}
  }{src-int-type-nat-refs}
  %
  \typerule{int-$\src{\wptr}$-refs}{
  }{
    \vdash\src{\wptr}\operatorname{int}
  }{src-int-type-wptr-refs}
  \end{center}
}{src-int-types-refs}{Interface types of $\mmlAs$.}
...
\myfig{
  ...
  \end{array}
  $$
}{compiler-with-refs}{Compiler from components to components.}

\myfig{
  \begin{center}
    \judgbox{\vdash\trg{\trace} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\overline{\loc}}}{,,$\trg{\overline{\loc}}$ has all passed pointers across $\ctxtocomp$-calls.''}
    \typerule{passedptrs-empty}{
    }{
      \vdash\trg{\hole{\cdot}} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\hole{\cdot}}
    }{passedptrs-empty}
    %
    \typerule{pssedptrs-non-calls}{
      \trg{\event}\not=\trg{Call\ \ctxtocomp\ foo\ \loc} &
      \vdash\trg{\trace} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\overline{\loc}}
    }{
      \vdash\trg{\event\cdot\trace} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\overline{\loc}}
    }{passedptrs-non-calls}
    %
    \typerule{pssedptrs-calls}{
      \vdash\trg{\trace} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\overline{\loc}}
    }{
      \vdash\trg{Call\ \ctxtocomp\ foo\ \loc\cdot\trace} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\loc_{\poisonless},\overline{\loc}}
    }{passedptrs-calls}
  \end{center}
}{backtrans-collect-interfaceing-locs}{Collect stack of locations for $\ctxtocomp$-interactions.}


\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc_{\leftrightarrows}}}]{\trace}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc_{\leftrightarrows}}}$, construct a \varmapbacktransds $\Game'$, a $\trg{\overline{\loc_{\leftrightarrows}}}$,\\ and an $\mmlAs$ backtranslation context from target-trace $\trg{\mstrace}$.''}
    %
    \typerule{backtrans-empty-refs}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\hole{\cdot}}=\Game,\trg{\overline{\loc_\leftrightarrows}},\src{42}
    }{backtrans-empty-refs}
    \typerule{backtrans-alloc-in-refs}{
      \trg{\loc_{\poisonless}}\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtcomp{s}=\trg{s} &
      \fresh{\Game}{\trg{\loc}} \\
      \Game_z=\Game[\trg{\loc}] &
      \src{z}=\Game_z(\trg{\loc}) &
      \mmlAmmlAtbackdetail[\Game_z,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Alloc\ \loc\ s}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{let\ z = new\ s\ in\ e}
    }{backtrans-alloc-in-refs}
    \typerule{backtrans-alloc-notin-refs}{
      \trg{\loc_{\poison}}\not\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Alloc\ \loc\ s}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}
    }{backtrans-alloc-notin-refs}
    \typerule{backtrans-dealloc-in-refs}{
      \trg{\overline{\loc_\leftrightarrows}}=\trg{\overline{\loc^1_\leftrightarrows},\loc_{\poisonless},\overline{\loc^2_\leftrightarrows}} &
      \trg{\overline{\loc_\leftrightarrows'}}=\trg{\overline{\loc^1_\leftrightarrows},\loc_{\poisoned},\overline{\loc^2_\leftrightarrows}} &
      \src{z}=\Game(\trg{\loc}) &
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}'}}]{\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows''}},\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Dealloc\ \loc}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows''}},\src{delete\ z;e}
    }{backtrans-dealloc-in-refs}
    \typerule{backtrans-dealloc-notin-refs}{
      \trg{\loc_{\poisoned}}\in\trg{\overline{\loc_\leftrightarrows}}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Dealloc\ \loc}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows}},\src{abort()}
    }{backtrans-dealloc-notin-refs}
    \typerule{backtrans-set-in-refs}{
      \trg{\loc_\poisonless}\in\trg{\overline{\loc_\leftrightarrows}} &
      \Game(\trg{\loc})=\src{z} &
      \mmlAmmlAtcomp{n}=\trg{n} &
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Set\ \loc\ n\ v}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{z[n]\leftarrow v;e}
    }{backtrans-set-in-refs}
    \typerule{backtrans-set-notin-refs}{
      \trg{\loc_\poisoned}\in\trg{\overline{\loc_\leftrightarrows}}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Set\ \loc\ n\ v}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows}},\src{abort()}
    }{backtrans-set-notin-refs}
    \typerule{backtrans-get-refs-notin}{
      \trg{\loc_\poisoned}\in\trg{\overline{\loc_\leftrightarrows}}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Get\ \loc\ n}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}
    }{backtrans-get-refs}
    \typerule{backtrans-get-refs}{
      \trg{\loc_\poisonless}\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Get\ \loc\ n}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc_\leftrightarrows'}},\src{e}
    }{backtrans-get-refs-notin}
    \typerule{backtrans-abort-refs}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\lightning}=\Game,\trg{\overline{\loc_\leftrightarrows}},\src{abort()}
    }{backtrans-abort-refs}
    %
  \end{center}
}{tms-pres-backtrans-refs}{Trace-Based Backtranslation from memory-specific $\mmlAt$ events to $\mmlAs$ terms.}

\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtbacksubtop[\Game, \trg{\overline{\loc}}, \trg{\overline{\loc_\leftrightarrows}}]{\event[_1]\cdot\trace\cdot\event[_2]}=\Game',\trg{\overline{\loc'}},\trg{\overline{\loc_\leftrightarrows}},\src{e_1},\src{e_2}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc}}$, construct a\\\varmapbacktransds $\Game'$, another stack of locations $\trg{\overline{\loc'}}$,\\ propagate to-be-freed locations $\trg{\overline{\loc_{\leftrightarrows}}}$,\\ and an $\mmlAs$ backtranslation context from\\target-trace $\trg{\mstrace}$ which starts with a $\ctxtocomp$\\event and ends in an $\comptoctx$.''}
    %
    \typerule{subtoplevel-backtrans-refs}{
      \vdash \trg{\trace} \operatorname{non-int-\trg{\trace}}\\
      \mmlAmmlAtbackcomptoctx[\Game,\trg{\overline{\loc}}]{\trg{\event[_1]}}=\Game',\trg{\overline{\loc'}},\src{e_1} &
      \mmlAmmlAtbackdetail[\Game',\trg{\overline{\loc_\leftrightarrows}}]{\trg{\trace}}=\Game'',\trg{\overline{\loc_\leftrightarrows'}}, \src{e_2} &
      \mmlAmmlAtbackctxtocomp[\Game'',\trg{\overline{\loc''}}]{\trg{\event[_2]}}=\Game''',\trg{\overline{\loc'''}},\src{e_3} \\
    }{
      \mmlAmmlAtbacksubtop[\Game,\trg{\overline{\loc}},\trg{\overline{\loc_\leftrightarrows}}]{\trg{\event[_1]\cdot\trace\cdot\event[_2]}}=\Game''',\trg{\overline{\loc'''}}, \trg{\overline{\loc_\leftrightarrows'}}, \src{e_1}, \src{e_2},\src{e_3}
    }{subtoplevel-backtrans-refs}
    %
    \typerule{subtoplevel-backtrans-indu-refs}{
      \trg{\trace[_1]}=\trg{\event[^A_1]\cdot\trace[^A]\cdot\event[^A_2]} &
      \vdash\trg{\trace[^A]}\ \operatorname{non-int-\trg{\trace}} \\
      \mmlAmmlAtbackcomptoctx[\Game,\trg{\overline{\loc}}]{\trg{\event[^A_1]}}=\Game',\trg{\overline{\loc'}},\src{e_1^A} &
      \mmlAmmlAtbackdetail[\Game',\trg{\overline{\loc_\leftrightarrows}}]{\trg{\trace^A}}=\Game'',\trg{\overline{\loc_\leftrightarrows'}}, \src{e_2^A} \\
      \mmlAmmlAtbackctxtocomp[\Game'',\trg{\overline{\loc''}}]{\trg{\event[^A_2]}}=\Game''',\trg{\overline{\loc'''}},\src{let\ x_0=new\ n_0\ in\ e_3^A} \\
      \mmlAmmlAtbacksubtop[\Game''',\trg{\overline{\loc'''}}]{\trace[_2]} = \Game'''',\trg{\overline{\loc''''}},\src{e_1^B},\src{e_2^B},\src{e_3^B} \\
      \src{e^A}=\src{e^A_1;e^A_2;let\ x_0=new\ n_0\ in\ (e_3^A;e_1^B)}
    }{
      \mmlAmmlAtbacksubtop[\Game,\trg{\overline{\loc}}]{\trg{\trace[_1]\cdot\trace[_2]}}=\Game'''',\trg{\overline{\loc''''}},\src{e^A},\src{e^B_2},\src{e^B_3}
    }{subtoplevel-backtrans-indu-refs}
  \end{center}
}{tms-pres-subtop-backtrans-refs}{Interaction-Trace-Based Backtranslation from memory-specific $\mmlAt$ events to $\mmlAs$ terms with passing references.}

\myfig{
  \begin{center}
    \typerule{free-leftover-empty}{
    }{
      \trg{\hole{\cdot}}\implies^\Game_{{\kern-4.5pt}\text{free-all}{\kern+3.5pt}}\src{42}
    }{free-leftover-empty}
    %
    \typerule{free-leftover-$\poisoned$}{
      \trg{\overline{\loc_\leftrightarrows''}}\implies^\Game_{{\kern-4.5pt}\text{free-all}{\kern+3.5pt}}\src{e_{\text{freed}}}
    }{
      \trg{\loc_\poisoned,\overline{\loc_\leftrightarrows''}}\implies^\Game_{{\kern-4.5pt}\text{free-all}{\kern+3.5pt}}\src{e_{\text{freed}}}
    }{free-leftover-poisoned}
    %
    \typerule{free-leftover-$\poisonless$}{
      \src{z}=\Game\left(\trg{\loc}\right) &
      \trg{\overline{\loc_\leftrightarrows''}}\implies^\Game_{{\kern-4.5pt}\text{free-all}{\kern+3.5pt}}\src{e_{\text{freed}}}
    }{
      \trg{\overline{\loc_\poisonless,\loc_\leftrightarrows''}}\implies^\Game_{{\kern-4.5pt}\text{free-all}{\kern+3.5pt}}\src{delete\ z;e_{\text{freed}}}
    }{free-leftover-poisonless}
  \end{center}
}{free-all-leftovers}{Free all leftovers.}

\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtback[\Game]{\mstrace} = \Game',\src{\library}}{,,Top-Level backtranslation of $\trg{\trace}$ to $\mmlAs$ library $\src{\library}$.''}
    %
    \typerule{backtrans-top-level-refs}{
      \vdash\trg{\trace}\Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\overline{\loc_\leftrightarrows}} &
      \trg{\trace}=\trg{\trace[_0]\cdot\trace[^{comp}]\cdot\trace[_1]} &
      \vdash \trg{\trace[^{comp}]} \operatorname{non-int-\trg{\trace}} \\
      \trg{\trace[_0]}=\trg{Start\cdot\trace[_0']\cdot Call\ \ctxtocomp\ foo\ \interfacevalue_1} &
      \trg{\trace[_1]}=\trg{Ret\ \comptoctx\ \interfacevalue_2\cdot\trace[_0']\cdot End\ \interfacevalue_3}\\
      \mmlAmmlAtbacksubtop[\Game,\trg{\hole{\cdot}},\trg{\overline{\loc_\rightleftarrows}}]{\trace[_0]} = \Game', \trg{\overline{\loc}}, \trg{\overline{\loc_\leftrightarrows'}}, \src{e_0},\src{e_0'},\src{let\ x_0 = new\ n_0\ in\ e_0''} \\
      \mmlAmmlAtbacksubtop[\Game',\trg{\overline{\loc},\trg{\overline{\loc_\leftrightarrows'}}}]{\trace[_1]} = \Game'', \trg{\hole{\cdot}}, \trg{\overline{\loc_\leftrightarrows''}}, \src{e_1},\src{e_1'},\src{e_1''} \\
      \trg{\overline{\loc_\leftrightarrows''}}\implies^{\Game''}_{{\kern-4.5pt}\text{free-all}{\kern+3.5pt}}\src{e_{\text{freed}}}\\
      \src{e} = \src{e_0;e_0';let\ x_0 = new\ n_0\ in\ (e_0'';e_1);e_1';e_1'';e_{\text{freed}}}
    }{
      \mmlAmmlAtback[\Game]{\trace} = \Game'', \src{let\ main\ x : \nat\to\nat := e, \hole{\cdot}}
    }{backtrans-top-level-refs}
  \end{center}
}{tms-pres-top-level-backtrans-refs}{Top-Level trace-based Backtranslation from $\mmlAt$ trace $\trg{\trace}$ to $\mmlAs$ context $\src{\library}$.}
