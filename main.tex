...
\begin{proof}
  ...
  \begin{passumptions}{F}
    \setcounter{enumi}{2}
    \item\label[ass]{asm:mmlatmsviamonitor:e0progtyps} $\typechecks{}{\hole{\cdot};\hole{\cdot}\triangleright e_{0}'}{\type}$
  \end{passumptions}
  ...
  \begin{passumptions}{F}
    \setcounter{enumi}{3}
    \item\label[ass]{asm:mmlatmsviamonitor:epoprogtyps} $\typechecks{}{\Omega_{0}\triangleright e_{po}}{\type}$
  \end{passumptions}
