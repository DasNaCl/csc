...
\myfig{
  ...
  & \mid \obj{alloc\ x\ e_{1}\ e_{2}} \mid \obj{delete\ x} \\
  ...
  & \mid \obj{\langle n_{1},n_{2}\rangle} \mid \obj{\pi_{1} e} \mid \obj{\pi_{2} e} \mid \obj{e\ has\ \type} \\
...
\myfig{
  ...
  %
  \typerule{$e-\obj{get}-\in$}{
    \obj{\memstate}=\obj{H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;m),\Delta_2} &
    \obj{\loc}+\obj{n}\in\text{dom }\obj{H^{\sandboxtag}}
  }{
    \exprevalo{\cfstate;\sandboxtag';\memstate}{x[n]}{\cfstate;\sandboxtag';\memstate}{H^{\sandboxtag}(\loc+n)}{Get\ \loc\ n;\sandboxtag}
  }{to-e-get-in}
  %
  \typerule{$e-\obj{get}-\notin$}{
    \obj{\memstate}=\obj{H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;m),\Delta_2} &
    ...
    \exprevalo{\cfstate;\sandboxtag';\memstate}{x[n]}{\cfstate;\sandboxtag';\memstate}{1729}{Get\ \loc\ n;\sandboxtag}
  }{to-e-get-notin}
  %
  \typerule{$e-\obj{set}-\ctx$}{
    \obj{\memstate}=\obj{H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\ctx;\poison;n),\Delta_2} &
    \obj{H^{\ctx'}} = \obj{H^{\ctx}}(\obj{\loc+n}\mapsto \obj{v}) \\
    \obj{\memstate'}=\obj{H^{\ctx'};H^{\comp};\Delta_1,x\mapsto(\loc;\ctx;\poison;n),\Delta_2}
  }{
    \exprevalo{\cfstate;\ctx;\memstate}{x[n]\leftarrow v}{\cfstate;\ctx;\memstate'}{v}{Set\ \loc\ n\ v;\ctx}
  }{to-e-set-ctx}
  %
  \typerule{$e-\obj{set}-\comp$}{
    \obj{\memstate}=\obj{H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\comp;\poison;n),\Delta_2} &
    \obj{H^{\comp'}} = \obj{H^{\comp}}(\obj{\loc+n}\mapsto \obj{v}) \\
    \obj{\memstate'}=\obj{H^{\ctx};H^{\comp'};\Delta_1,x\mapsto(\loc;\comp;\poison;n),\Delta_2}
  }{
    \exprevalo{\cfstate;\comp;\memstate}{x[n]\leftarrow v}{\cfstate;\comp;\memstate'}{v}{Set\ \loc\ n\ v;\comp}
  }{to-e-set-comp}
  %
...
\myfig{
  ...
  \end{center}
}{w-events-project-to-specific}{Projection of $\mmlAo$ events to \gls*{ms}-specific events.}
