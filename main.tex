...
%    }{backtrans-ret}
    ...
    \typerule{backtrans-toplevel}{
      \tospecificevctxt{\trace} = \trg{\mstrace[_0]}\cdot \specificevt{Call\ ?n}\cdot \specificevt{Ret\ !n}\cdot \trg{\mstrace[_1]} \\
      \mmlAmmlAtbackdetail[\emptyset]{\mstrace[_0]} = \Game,\src{e_0} &
      \mmlAmmlAtbackdetail[\Game]{\mstrace[_1]} = \Game',\src{e_1} &
    }{
      \mmlAmmlAtback{\trace} = \src{context\ e_0\ e_1}
    }{backtrans-top}
  \end{center}
...
%\begin{lemma}[Call Correctness]\label{lem:call:correctness}
%  If
%  \begin{assumptions}
%  \item $\typechecks{}{component\ e_p}{\nat\to\nat}$
%  \item $\wexec{\trg{prog\ e_1\ }\mmlAmmlAtcomp{e_p}\trg{\ e_2}}{\trg{\Omega'}}{\trg{e}}{\trg{\trace}}$
%  \end{assumptions}
%\end{lemma}
...
\begin{lemma}[Backtranslation Correctness]\label{lem:backtranslation:correct}
  ...
  \end{assumptions}
  then $\exists \configs\ \src{\valueexpr}\ \src{\trace}\ \delta_{tms}$,
  \begin{goals}
  \item $\wexecs{prog\ e_1\ e_p\ e_2}{\configs}{\valueexpr}{\trace}$
  \item $\tmstraceagree{\tospecificevctxs{\trace}}{\tospecificevctxt{\trace}}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
  Inverting \Cref{asm:backtranscorr:progexec} gives:
  \begin{passumptions}{H}
  \item $\exect{\hole{\cdot};\hole{\cdot}}{e_0}{\Omega_0}{\valueexpr_0}{\trace[_0]}$
  \item\label[ass]{asm:backtranscorr:compexecbase} $\exec{\trg{\Omega_0}}{\mmlAmmlAtcomp{e_p}\trg{[\valueexpr_0/x]}}{\trg{\Omega_p}}{\trg{\valueexpr_p}}{\trg{\trace[_p]}}$
  \item $\exect{\Omega_p}{e_1[\valueexpr_p/y]}{\Omega_1}{\valueexpr_1}{\trace[_1]}$
  \end{passumptions}

  By \thmref{lem:compvals:insertion} we have $\mmlAmmlAtcomp{\valueexpr_0}=\trg{\valueexpr_0}$ and $\mmlAmmlAtcomp{\valueexpr_p}=\trg{\valueexpr_p}$.
