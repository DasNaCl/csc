...
%    \judgbox{\tospecificevctxs{\trace} = \src{\mstrace}}{,,Project an $\mmlAs$ trace $\src{\trace}$ to $\src{\mstrace}$, ignoring component.''}
    $$
    \begin{array}{rcll}
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{Alloc\ \loc\ n} &\ = & \src{\comm},\specificev{Alloc\ \loc\ n}&\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc})\text{ and }\specificev{n}=\src{n} \\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{Dealloc\ \loc} &\ = & \src{\comm},\specificev{Dealloc\ \loc} &\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc}) \\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{Get\ \loc\ n} &\ = & \src{\comm},\specificev{Use\ \loc\ n} &\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc})\text{ and }\specificev{n}=\src{n} \\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{Set\ \loc\ n} &\ = & \src{\comm},\specificev{Use\ \loc\ n} &\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc})\text{ and }\specificev{n}=\src{n} \\
      \tospecificevs[_{\delta_{MS}}^{\src{\ctxtocomp}}]{Alloc\ \loc\ n} &\ = & \src{\comm},\specificev{\emptyevent}&\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc})\text{ and }\specificev{n}=\src{n} \\
      \tospecificevs[_{\delta_{MS}}^{\src{\ctxtocomp}}]{Dealloc\ \loc} &\ = & \src{\comm},\specificev{\emptyevent} &\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc}) \\
      \tospecificevs[_{\delta_{MS}}^{\src{\ctxtocomp}}]{Get\ \loc\ n} &\ = & \src{\comm},\specificev{\emptyevent} &\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc})\text{ and }\specificev{n}=\src{n} \\
      \tospecificevs[_{\delta_{MS}}^{\src{\ctxtocomp}}]{Set\ \loc\ n} &\ = & \src{\comm},\specificev{\emptyevent} &\text{where }\specificev{\loc}=\delta_{MS}(\src{\loc})\text{ and }\specificev{n}=\src{n} \\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm'}}]{Call\ \comm\ foo\ n} &\ = & \src{\comm},\specificev{\varepsilon} &\text{where }\src{\comm}\not=\src{\nocomm}\\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm'}}]{Ret\ \comm\ n} &\ = & \src{\comm},\specificev{\varepsilon} &\text{where }\src{\comm}\not=\src{\nocomm}\\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{Call\ \nocomm\ foo\ n} &\ = & \src{\comm},\specificev{\varepsilon} &\\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{Ret\ \nocomm\ n} &\ = & \src{\comm},\specificev{\varepsilon} &\\
      \tospecificevs[_{\delta_{MS}}^{\src{\comm}}]{\lightning} &\ = & \src{\comm},\specificev{\lightning} &\\
    \end{array}
    $$
