...
\myfig{
  \begin{center}
    \begin{gather*}
    \judgbox{\mmlAtmsmmlAtcctcomp{e}=\obj{e'}}{,,Compile $\mmlAt$ expression $\trg{e}$ to $\mmlAt$ expression $\obj{e'}$.''}\\
    \judgbox{\mmlAtmsmmlAtcctcomp{\left[\valueexpr / x\right]}=\obj{\left[\valueexpr / x\right]}}{,,Compile $\mmlAt$ substitution to $\mmlAtms$ substitution.''} \\
    \judgbox{\mmlAtmsmmlAtcctcomp{\commlib}=\obj{\commlib'}}{,,Compile $\mmlAt$ component library to $\mmlAtms$ component library.''} \\
    \end{gather*}
    $$
    \begin{array}{rll}
