...
\begin{proof}
  ...
  \begin{description}
    \item \textbf{Case} $\exprevalt{\Omega}{n_{1}\oplus n_{2}}{\Omega}{n_{3}}{\emptyevent}$\textbf{:}
          If
          \begin{passumptions}{H}
    ...
    \item \textbf{Cases} \ref{tr:tw-e-get-in}\textbf{:}
          If
          \begin{passumptions}{H}
    ...
    \item \textbf{Cases} \ref{tr:tw-e-get-notin}\textbf{:}
          If
          \begin{passumptions}{H}
            \item $\trg{\memstate}=\trg{H^{\ctx};H^{\comp};\Delta_{1},x\mapsto(\loc;\comp;\poison;m),\Delta_{2}}$
