...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case} \ref{tr:tw-e-let-new-comp}\textbf{:}
          ...
          Then $\exists \irl{\gamma'}$,
          \begin{goals}
            \item $\exec{\irl{\Omega}}{\mmlAtmmlAtmscomp{let\ x=new\ n\ in\ e}\irl{\gamma}}{\irl{\Omega'}}{\mmlAtmmlAtmscomp{e[z/x]}\irl{\gamma'}}{\irl{\event}}$
            \item $\storeagreesms[\delta]{\smsmonitor'}{\trg{\cfstate;\comp;\memstate'}}$
            \item $\irl{\gamma'}\Vdash\irl{\Omega.\Delta}$
            \item $\trg{\gamma'}\prec\irl{\gamma'}$
          \end{goals}
    ...
    \item \textbf{Case} \ref{tr:tw-e-delete}\textbf{:}
          ...
          {\color{green} patch. also add case for }\ref{tr:tw-e-subst}
