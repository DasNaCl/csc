...
\begin{lemma}[Agreement Propagation]\label{lem:trace:agreement:propagation}
  ...
  \item\label[ass]{asm:trace:agreement:propagation:xagree} $\xlangtraceeq{\mstrace}{\mstrace}$
...
\end{lemma}
\begin{proof}
  Induction on $\xlangbackstateeq{\mstrace}{\mstrace}$ (\Cref{asm:trace:agreement:propagation:xagree}).
\end{proof}
...
\begin{proof}
  ...
  \item $\tmstraceagree{\tospecificevcomps{\overline{a}}}{\tospecificevcompt{\overline{a}}}$
  \end{passumptions}
