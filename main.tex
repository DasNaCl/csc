...
\myfig{
  \begin{center}
    ...
    %
    \mmlAmmlAtcomp{\hole{\cdot}}_\delta&\ = & \trg{\hole{\cdot}}\\
    \mmlAmmlAtcomp{\varepsilon,\bar{a}}_\delta&\ = & \trg{\varepsilon,}\mmlAmmlAtcomp{\bar{a}}_\delta\\
    \mmlAmmlAtcomp{Alloc\ \loc\ n,\bar{a}}_\delta&\ = & \trg{Alloc\ }\delta(\src{\loc})\trg{\ n,}\mmlAmmlAtcomp{\bar{a}}_\delta\\
    \mmlAmmlAtcomp{Dealloc\ \loc,\bar{a}}_\delta&\ = & \trg{Dealloc\ }\delta(\src{\loc})\trg{,}\mmlAmmlAtcomp{\bar{a}}_\delta\\
    \mmlAmmlAtcomp{Get\ \loc\ n,\bar{a}}_\delta&\ = & \trg{Get\ }\delta(\src{\loc})\trg{\ n,}\mmlAmmlAtcomp{\bar{a}}_\delta\\
    \mmlAmmlAtcomp{Set\ \loc\ n,\bar{a}}_\delta&\ = & \trg{Set\ }\delta(\src{\loc})\trg{\ n,}\mmlAmmlAtcomp{\bar{a}}_\delta\\
    \end{array}
    $$
    \typerule{compile-state}{
      \src{H};\src{\Delta}=\src{\Omega}&
      \trg{\Omega}=\mmlAmmlAtcomp{H};\mmlAmmlAtcomp{\Delta}
    }{
      \mmlAmmlAtcomp{\Omega}_\delta = \trg{\Omega}
    }{compile-state}
    %
    \typerule{empty-compile}{
    }{
      \mmlAmmlAtcomp{\emptyset}_\delta = \trg{\emptyset}
    }{compile-empty-heap}
    %
    \typerule{cons-heap-compile}{
    }{
      \mmlAmmlAtcomp{n,H}_\delta = \mmlAmmlAtcomp{n}\trg{,}\mmlAmmlAtcomp{H}_\delta
    }{compile-cons-heap}
    %
    \typerule{cons-locmap-compile}{
    }{
      \mmlAmmlAtcomp{x\mapsto\loc,\Delta}_\delta = \mmlAmmlAtcomp{x}_\delta\trg{\mapsto}\delta(\src{\loc})\trg{,}\mmlAmmlAtcomp{\Delta}
    }{compile-cons-map}
  \end{center}
...
\begin{lemma}[Compiling Values Invertability]\label{lem:compvals:invertible}\ \\
  $\mmlAmmlAtcomp{v}$ is invertible.
\end{lemma}
\begin{proof}
  Trivial.
\end{proof}
