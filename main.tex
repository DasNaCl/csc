...
\myfig{
  \begin{center}
    ...
    \judgbox{\cfcomp{\left[\valueexpr / x\right]}=\irl{\left[\valueexpr / x\right]}}{,,Compile $\mmlAtms$ substitution to $\mmlAtms$ substitution.''} \\
    ...
    %
    \cfcomp{\left[\valueexpr/x\right]}&\ = & \irl{\left[\right.}\cfcomp{v}\irl{/}\cfcomp{x}\irl{\left.\right]} \\[0.5cm]
    %
