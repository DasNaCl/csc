...
\paragraph{$\src{e}=\src{free\ x}$:}
  ...
  \begin{assumptions}
    ...
    \item\label{asm:basetmsmonitor:storeagree} $\storeagree{T}{\src{\Delta_1,x\mapsto\loc^\poison,\Delta_2}}$
  \end{assumptions}
  Then $\exists a\ \delta'\ T',$
  \begin{goals}
    \item\label{goal:basetmsmonitor:subseteq} $\delta\subseteq\delta'$
    \item\label{goal:basetmsmonitor:traceagree} $\traceagree[\delta']{a}{\src{Dealloc\ \loc}}$
    \item $\monitorcheck[]{T}{T'}{a}$
  ...
  \item $\storeagree{T_1}{\Delta_1}$
  \item $\delta(\src{\loc})=\loc$
  \item $\storeagree{T_2}{\Delta_2}$
  \item $T=T_1\cup\left\{\loc\right\}\cup T_2$
  \end{assumptions}
  then $\exists T'$,
  \begin{goals}
    \item\label{goal:basetmsmonitor:monitorcheck1} $\monitorcheck[]{T}{T'}{\text{Dealloc}\ \loc}$
    \item\label{goal:basetmsmonitor:storeagree1} $\storeagree[\delta']{T'}{\src{\Delta_1,x\mapsto\loc^\poisoned,\Delta_2}}$
  \end{goals}.
  ...
  \subparagraph{\Cref{tr:store-ignore-agree}:} TODO
\end{incompleteproof}
