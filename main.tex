...
\myfig{
  \begin{center}
  \judgbox{closed\ X\ \src{e}}{,,At most all $\mmlAs$ variables in the set $X$ occur in $\src{e}$.''}
    \typerule{$program$}{
...
\myfig{
  \begin{center}
    \judgbox{\typechecks{}{context\ e_1\ e_2}{\nat}}{,,$\mmlAs$ context $\src{context\ e_1\ e_2}$ typechecks.''}$\;$\\
    \judgbox{\typechecks{}{component\ e_p}{\nat\to\nat}}{,,$\mmlAs$ component $\src{component\ e_p}$ typechecks.''}$\;$\\
  ...
  %
  \judgbox{\typechecks{}{\qconfigs[i]\triangleright e}{\nat}}{,,$\mmlAs$ runtime program $\src{\qconfigs[i]\triangleright e}$ typechecks.''}$\;$\\
  \typerule{$t-\text{prog}$}{
    \typechecks{}{\Delta}{\Gamma}&
    \typechecks{\Gamma}{e}{\nat}
	}{
  \typechecks{}{(H;\Delta)^i\triangleright e}{\nat}
	}{w-t-prog}
  \end{center}
...
\myfig{
  \begin{center}
    \judgbox{\wexecs{prog\ e_0\ e_p\ e_1}{\configs}{\valueexpr}{\trace}}{,,Run $\mmlAs$ program $\src{prog\ e_0\ e_p\ e_1}$, giving dynamic state $\configs$\\ and emitting trace $\src{\trace}$.''}
  \typerule{$e-\text{wprog}$}{
    \typechecks{}{component\ e_p}{\nat\to\nat} &
    \execs{\hole{\cdot};\hole{\cdot}}{e_0}{\configs_0}{\valueexpr_0}{\trace{_0}} \\
    \execs{\qconfig_0}{e_p[\valueexpr_0/x]}{\configs_p}{\valueexpr_p}{\trace{_p}} &
    \execs{\configs_p}{e_1[\valueexpr_p/y]}{\configs_1}{\valueexpr_1}{\trace{_1}} &
  }{
    \wexecs{prog\ e_0\ e_p\ e_1}{\configs_1}{v_1}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\valueexpr_0\cdot \trace{_p}\cdot Ret\ !\valueexpr_p\cdot \trace{_1}\cdot Call\ ?\valueexpr_1}
  }{ws-e-prog}
  ...
  \typerule{$e-\text{wprog}-$failp}{
    \typechecks{}{component\ e_p}{\nat\to\nat} &
    \execs{\hole{\cdot};\hole{\cdot}}{e_0}{\configs_0}{\valueexpr_0}{\trace{_0}} \\
    \execs{\qconfig_0}{e_p[\valueexpr_0/x]}{\lightning}{stuck}{\trace{_p}} &
  }{
    \wexecs{prog\ e_0\ e_p\ e_1}{\lightning}{stuck}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\valueexpr_0\cdot \trace{_p}}
  }{ws-e-prog}
  \typerule{$e-\text{wprog}-$fail1}{
    \typechecks{}{component\ e_p}{\nat\to\nat} &
    \execs{\hole{\cdot};\hole{\cdot}}{e_0}{\configs_0}{\valueexpr_0}{\trace{_0}} \\
    \execs{\qconfig_0}{e_p[\valueexpr_0/x]}{\configs_p}{\valueexpr_p}{\trace{_p}} &
    \execs{\configs_p}{e_1[\valueexpr_p/y]}{\lightning}{stuck}{\trace{_1}} &
  }{
    \wexecs{prog\ e_0\ e_p\ e_1}{\lightning}{stuck}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\valueexpr_0\cdot \trace{_p}\cdot Ret\ !\valueexpr_p\cdot \trace{_1}}
  }{ws-e-prog-fail1}
  \end{center}
...
\myfig{
  \begin{gather*}
  \begin{aligned}
    \mi{Events}~\src{\mstrace} \bnfdef&\ \specificevs{Alloc\ \loc\ n} \mid \specificevs{Dealloc\ \loc} \mid \specificevs{Use\ \loc\ n} \\
...
\myfig{
  \begin{center}
    \judgbox{\tospecificevs{\event} = \src{\msevent}}{,,Project an $\mmlAs$ event $\src{\event}$ to $\src{\msevent}$.''}
    ...
    \begin{array}{rcl}
      ...
      \tospecificevs{\trace} &\ = & \operatorname{map}\ \thetospecificfilter\ \src{\trace}\\[0.5cm]
      %
...
\myfig{
  \begin{center}
    \judgbox{\monitorcheck[]{\tmsmonitor}{\tmsmonitor[']}{\event}}{,,Given abstract state $\tmsmonitor$, step to abstract state $\tmsmonitor'$\\ emitting an abstract event $\event$.''}
    \judgbox{\monitorcheck{\tmsmonitor}{\tmsmonitor[']}{\trace}}{,,Reflexive-Transitive closure of above judgement.\\$\trace$ is a list of abstract events.''}
    \typerule{TMS-Use}{
      \loc\in \tmsmonitor[.A] &
      \loc\not\in \tmsmonitor[.F] &
    }{
...
\myfig{
  \begin{center}
    ...
    \judgbox{\tmstraceagree{\src{\msevent}}{\event}}{,,Memory-Safety specific event $\src{\msevent}$ describes same action as $\event$.''}
    \judgbox{\tmstraceagree{\src{\mstrace}}{\trace}}{,,Memory-Safety specific trace $\src{\mstrace}$ describes same trace as $\trace$.''}
    %
    ...
    \typerule{TMS-Ret-Authentic}{
      ...
      \tmstraceagree{\specificevs{Ret\ !n}\cdot\src{\mstrace}}{\trace}
    }{tms-ret-auth}
  \end{center}
...
\begin{proof}
  ...
  \begin{passumptions}{H}
    ...
    \item\label[ass]{asm:mmlatmsviamonitor:tracedef} $\src{\trace}=\src{Ret\ !0}\cdot\src{\trace{_0}}\cdot\src{Call\ ?v_0}\cdot\src{\trace{_p}}\cdot\src{Ret\ !v_p}\cdot\src{\trace{_1}\cdot\src{Call\ ?v_1}}$
  \end{passumptions}
  ...
  Note that $\tospecificevcomps{\trace}=\specificevs{Call\ ?v_0}\cdot\tospecificevs{\trace{_p}}\cdot\specificevs{Ret\ !v_p}$ by \Cref{asm:mmlatmsviamonitor:tracedef}, so the remaining goals are:
...
\myfig{
  ...
  \mi{Final\ Result}\ \trg{\finalexpr} \bnfdef\ \trg{\valueexpr} \mid \trg{stuck} \\
  %
  ...
  \begin{gather*}
    \begin{aligned}
      ...
      \trg{let\ x=K\ in\ e}\\
                     ...
                     &\mid \trg{if\ K < e_1\ then\ e_2\ else\ e_3} \mid \trg{if\ n < K\ then\ e_1\ else\ e_2}
    \end{aligned}
  \end{gather*}
...
\myfig{
  \begin{center}
    \judgbox{\wexect{prog\ e_0\ e_p\ e_1}{\configt}{\valueexpr}{\trace}}{,,Run $\mmlAt$ program $\trg{prog\ e_0\ e_p\ e_1}$,\\giving dynamic state $\configt$  and emitting trace $\trg{\trace}$.''}
  \typerule{$e-\text{wprog}-\trg{trg}$}{
    \exect{\hole{\cdot};\hole{\cdot}}{e_0}{\Omega_0}{\valueexpr_0}{\trace{_0}} \\
    \exect{\qconfigt{_0}}{e_p[\valueexpr_0/x]}{\Omega_p}{\valueexpr_p}{\trace{_p}} &
    \exect{\Omega_p}{e_1[\valueexpr_p/y]}{\Omega_1}{\valueexpr_1}{\trace{_1}} &
  }{
    \wexect{prog\ e_0\ e_p\ e_1}{\Omega_1}{\valueexpr_1}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\valueexpr_0\cdot \trace{_p}\cdot Ret\ !\valueexpr_p\cdot \trace{_1}\cdot Call\ ?v_1}
  }{wt-e-prog}
  ...
  \typerule{$e-\text{wprog}-\trg{trg}-$failp}{
    \exect{\hole{\cdot};\hole{\cdot}}{e_0}{\Omega_0}{\valueexpr_0}{\trace{_0}} &
    \exect{\Omega_0}{e_p[\valueexpr_0/x]}{\lightning}{stuck}{\trace{_p}} &
  }{
    \wexect{prog\ e_0\ e_p\ e_1}{\lightning}{stuck}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\valueexpr_0\cdot \trace{_p}}
  }{wt-e-prog-failp}
  \typerule{$e-\text{wprog}-\trg{trg}$-fail1}{
    \exect{\hole{\cdot};\hole{\cdot}}{e_0}{\Omega_0}{\valueexpr_0}{\trace{_0}} \\
    \exect{\Omega_0}{e_p[\valueexpr_0/x]}{\Omega_p}{\valueexpr_p}{\trace{_p}} &
    \exect{\Omega_p}{e_1[\valueexpr_p/y]}{\lightning}{stuck}{\trace{_1}} &
  }{
    \wexect{prog\ e_0\ e_p\ e_1}{\lightning}{stuck}{Ret\ !0\cdot \trace{_0}\cdot Call\ ?\valueexpr_0\cdot \trace{_p}\cdot Ret\ !\valueexpr_p\cdot \trace{_1}}
  }{wt-e-prog}
  \end{center}
...
\myfig{
  \begin{gather*}
    \begin{aligned}
      ...
      \mi{Abstract\ Events}~\event \bnfdef&\ \text{Alloc}\ \loc\ n \mid \text{Dealloc}\ \loc \mid \text{Use}\ \loc\ n \mid \lightning\\
...
\myfig{
  \begin{center}
    \judgbox{\monitorcheck[]{\smsmonitor}{\smsmonitor[']}{\event}}{,,Given abstract state $\smsmonitor$, step to abstract state $\smsmonitor'$\\ emitting an abstract event $\event$.''}
    \judgbox{\monitorcheck{\smsmonitor}{\smsmonitor[']}{\trace}}{,,Reflexive-Transitive closure of above judgement.\\$\trace$ is a list of abstract events.''}
    %
    \typerule{sms-Use}{
    ...
    %
    \typerule{sms-Trans}{
      \monitorcheck[]{\smsmonitor}{\smsmonitor[']}{\event}&
      \monitorcheck{\smsmonitor[']}{\smsmonitor['']}{\trace}&
    }{
    \monitorcheck{\smsmonitor}{\smsmonitor['']}{\event\cdot\trace}
    }{sms-trans}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \judgbox{\smstraceagree{\trg{\msevent}}{\event}}{,,Memory-Safety specific event $\trg{\msevent}$ describes same action as $\event$.''}
    \judgbox{\smstraceagree{\trg{\mstrace}}{\trace}}{,,Memory-Safety specific trace $\trg{\mstrace}$ describes same trace as $\trace$.''}
    %
    ...
    \typerule{SMS-Trans-Authentic}{
      \smstraceagree{\specificevt{\event}}{\event} &
      \smstraceagree{\trg{\mstrace}}{\trace}
    }{
      \smstraceagree{\specificevt{\event}\cdot\trg{\mstrace}}{\event\cdot\trace}
    }{sms-trans-auth}
    %
    \typerule{SMS-Call-Authentic}{
      \smstraceagree{\trg{\mstrace}}{\trace}
    }{
      \smstraceagree{\specificevt{Call\ ?n}\cdot\trg{\mstrace}}{\trace}
    }{sms-call-auth}
    %
    \typerule{SMS-Ret-Authentic}{
      \smstraceagree{\trg{\mstrace}}{\trace}
    }{
      \smstraceagree{\trg{\mstrace}\cdot\specificevt{Ret\ !n}}{\trace}
    }{sms-ret-auth}
    %
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{tms-sms-Trans}{
      \monitorcheck[]{T}{T'}{\event}&
      \monitorcheck{T'}{T''}{\trace}&
    }{
    \monitorcheck{T}{T''}{\event\cdot\trace}
    }{tms-sms-trans}
  \end{center}
...
\begin{definition}[Trace is temporal memory safe via monitor.]\label{def:trg:trace:tms}
  ...
  We say $\texttt{TMS}(\trg{\mstrace})$ iff $\exists \delta\ \trace\ \tmsmonitor$ such that:
  \begin{itemize}
    \item $\tmstraceagree{\trg{\mstrace}}{\trace}$
    \item and $\monitorcheck{\emptyset}{\tmsmonitor}{\trace}$
  \end{itemize}
\end{definition}
...
\myfig{
  \begin{center}
    ...
    $\;$
    %
    \judgbox{\atled(\trg{\loc})=\src{\loc}}{,,The $\mmlAt$ memory location $\trg{\loc}$ corresponds to\\the $\mmlAs$ memory location $\src{\loc}$.''} \\
    ...
    \typerule{back-cons-locmap-eq}{
      %\mmlAmmlAtcomp{x}=\trg{x} &  % TODO: α equivalent!
      \atled(\trg{\loc}) = \src{\loc} &
      \xlangbackstateeq{\Delta}{\Delta}
    }{
      \xlangbackstateeq{x\mapsto\loc,\Delta}{x\mapsto\loc,\Delta}
    }{back-cons-locmap-eq}
  \end{center}
...
\begin{lemma}[Step Forward Simulation]\label{lem:step:forwardsim}
  If
  \begin{assumptions}
    \item\label[ass]{asm:step:forwardsim:srcstep} $\exprevals{\Omega}{e}{\Omega'}{\finalexpr}{\event}$
  ...
  \begin{goals}
    ...
    \item $\expreval{\trg{\Omega}}{\mmlAmmlAtcomp{e}}{\trg{\Omega'}}{\mmlAmmlAtcomp{\finalexpr}}{\trg{\event}}$
...
\begin{incompleteproof}
  ...
  \begin{description}
    ...
    \item \textbf{Case $\exprevals{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{delete\ x}{H;\Delta_1,x\mapsto\loc_\poisoned,\Delta_2}{0}{Dealloc\ \loc}$:}
      ...
      If
      \begin{passumptions}{H}
      \item\label[ass]{asm:step:forwardsim:case2:stateeq} $\xlangstateeq{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}$
      \item $\typechecks{}{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2\triangleright delete\ x}{\nat}$
      \end{passumptions}
      Then $\exists\delta'\ \trg{\Omega'}\ \trg{\event}$,
      \begin{goals}
        \item $\delta\subseteq\delta'$
        \item $\expreval{\trg{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}}{\mmlAmmlAtcomp{delete\ x}}{\trg{\Omega'}}{\mmlAmmlAtcomp{0}}{\trg{\event}}$
    ...
    \item \textbf{Case $\exprevals{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{x[n]}{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{v}{Get\ \loc\ n}$:}
      ...
      If
      \begin{passumptions}{H}
      \item\label[ass]{asm:step:forwardsim:case3:stateeq} $\xlangstateeq{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}$
      ...
      \begin{goals}
        \item $\delta\subseteq\delta'$
        \item $\expreval{\trg{H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}}{\mmlAmmlAtcomp{x[n]}}{\trg{\Omega'}}{\mmlAmmlAtcomp{v}}{\trg{\event}}$
      ...
      For \Cref{goal:step:forwardsim:case2:eventeq}, invert \Cref{asm:step:forwardsim:case3:stateeq} ,,suitably''\MK{technical lemma needed: splitting} to obtain the assumption $\delta(\src{\loc})=\trg{\loc}$. The claim then follows by applying \Cref{tr:get-event-eq}.

      \Cref{goal:step:forwardsim:case2:stateeq} follows immediately from \Cref{asm:step:forwardsim:case3:stateeq}.
...
\begin{lemma}[Ctx Step Forward Simulation]\label{lem:ctxstep:forwardsim}
  If
  \begin{assumptions}
    \item\label[ass]{asm:step:forwardsim:srcstep} $\execs[]{\Omega}{e}{\Omega'}{\finalexpr}{\event}$
    \item $\xlangstateeq{\Omega}{\Omega}$
    \item $\typechecks{}{\Omega\triangleright e}{\nat}$
  \end{assumptions}
  Then $\exists\delta'\ \trg{\Omega'}\ \trg{\event}$,
  \begin{goals}
    \item $\delta\subseteq\delta'$
    \item $\exec[]{\trg{\Omega}}{\mmlAmmlAtcomp{e}}{\trg{\Omega'}}{\mmlAmmlAtcomp{\finalexpr}}{\trg{\event}}$
    \item $\xlangeventeq{\event}{\event}$
    \item $\xlangstateeq{\Omega'}{\Omega'}$
  \end{goals}
\end{lemma}
...
\begin{lemma}[Expression Correctness]\label{lem:expression:correctness}
  ...
  \item $\xlangstateeq{\Omega}{\Omega}$
  \item\label[ass]{lem:expr:corr:typechecks} $\typechecks{}{\Omega\triangleright e}{\nat}$
  \end{assumptions}
...
\end{lemma}
\begin{proof}
  We prove this by contradiction. Thus, we are given arbitrary $\delta',\ \src{\Omega'}$, and $\src{\trace}$.
  There are four cases, each of which needs to lead to a contradiction.
  \begin{description}
    \item\label[ass]{lem:expr:corr:first} \textbf{Assume} $\delta'\subset\delta$\textbf{:}

      We admit this. \MK{obviously, we don't want to just assume this to be correct}

    \item\label[ass]{lem:expr:corr:second} \textbf{Assume} $\neg\left(\execs{\Omega}{e}{\Omega'}{\finalexpr}{\trace}\right)$\textbf{:}

      We apply \thmref{lem:progress} on \Cref{lem:expr:corr:typechecks}. Therefore, we know that $\src{e}$ reduces (or is a value).
      However, it is assumed that $\neg\left(\execs{\Omega}{e}{\Omega'}{\finalexpr}{\trace}\right)$, so assume:

      \begin{passumptions}{H}
        \item\label[ass]{asm:exprcorrect:exec2} $\execs{\Omega}{e}{\Omega''}{\finalexpr'}{\trace}$
        \item\label[ass]{asm:exprcorrect:unequal1} $\src{\finalexpr}\not=\src{\finalexpr'}$
        \item\label[ass]{asm:exprcorrect:unequal2} $\src{\Omega'}\not=\src{\Omega''}$
      \end{passumptions}

      Apply \thmref{lem:forwardsim} on \Cref{asm:exprcorrect:exec2} to get:
      \begin{passumptions}{F}
        \item\label[ass]{asm:exprcorrect:exec2:trg} $\exec{\trg{\Omega_\exists}}{\mmlAmmlAtcomp{e}}{\trg{\Omega_\exists''}}{\mmlAmmlAtcomp{\finalexpr'}}{\trg{\trace_\exists}}$
        \item $\xlangtraceeq{\trace}{\trace_\exists}$
        \item $\xlangstateeq{\Omega}{\Omega_\exists}$
        \item $\xlangstateeq{\Omega''}{\Omega''_\exists}$
      \end{passumptions}

      The compiler is deterministic, so using \Cref{asm:exprcorrect:unequal1} on \thmref{lem:determcomp} gives:
      \begin{passumptions}{G}
        \item\label[ass]{asm:exprcorrect:compiled:unequal} $\mmlAmmlAtcomp{\finalexpr}\not=\mmlAmmlAtcomp{\finalexpr'}$
      \end{passumptions}

      Using \Cref{asm:exprcorrect:exec1:trg} and \Cref{asm:exprcorrect:exec2:trg} on \thmref{lem:determ:steps} we have:\MK{can't do this, trace may be different}
      \begin{passumptions}{G}
        \setcounter{enumi}{1}
        \item\label[ass]{asm:exprcorrect:compiled:equal} $\mmlAmmlAtcomp{\finalexpr}=\mmlAmmlAtcomp{\finalexpr'}$
      \end{passumptions}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-alloc}{
      ...
      \mmlAmmlAtbackdetail{\specificevt{Alloc\ \loc\ n}\cdot\mstrace} = \Game'', \src{let\ }\Game'(\trg{\loc})\src{ = new\ }\mmlAmmlAtbackv{n}\src{\ in\ e}
    }{backtrans-alloc}
    %
    \typerule{backtrans-dealloc}{
      ...
      \mmlAmmlAtbackdetail{\specificevt{Dealloc\ \loc}\cdot\mstrace} = \Game'', \src{delete\ }\Game'(\trg{\loc})\src{; e}
    }{backtrans-dealloc}
    %
    \typerule{backtrans-use}{
      ...
      \mmlAmmlAtbackdetail{\specificevt{Use\ \loc\ n}\cdot\mstrace} = \Game'',\src{x[}\mmlAmmlAtbackv{n}\src{];e}
    }{backtrans-use}
    %
    \typerule{backtrans-abort}{
      \mmlAmmlAtbackdetail{\mstrace} = \Game',\src{e}
    }{
      \mmlAmmlAtbackdetail{\specificevt{\lightning}\cdot\mstrace} = \Game',\src{abort();e}
    }{backtrans-abort}
    %
    \typerule{backtrans-call}{
      \mmlAmmlAtbackdetail{\mstrace} = \Game',\src{e}
    }{
      \mmlAmmlAtbackdetail{\specificevt{Call\ ?n}\cdot\mstrace} = \Game',\mmlAmmlAtbackv{n}\src{;e}
    }{backtrans-call}
   %
    \typerule{backtrans-ret}{
      \mmlAmmlAtbackdetail{\mstrace} = \Game', \src{e}
    }{
      \mmlAmmlAtbackdetail{\specificevt{Ret\ !n}} = \Game',\mmlAmmlAtbackv{n}\src{;e}
    }{backtrans-ret}
  \end{center}
...
\begin{definition}[Mimicking Locations]\label{def:location:mimicking}
  For two functions $\delta,\atled$ we say that they mimick each other iff 
  $$\forall \src{\loc}\ \trg{\loc}, \delta\left(\src{\loc}\right) = \trg{\loc} \Leftrightarrow \atled\left(\trg{\loc}\right) = \src{\loc}$$
\end{definition}
...
\end{proof}
\MK{we don't know anything about this $\delta$, besides $\delta:\src{L}\to\trg{L}$}
...
\begin{lemma}[State Agreement Insertion]\label{lem:backtranslation:stateagreement:insertion}
  ...
  \item\label[ass]{ass:stateagreeinsertion:deltasagree} Mimicking $\delta,\atled$ (see \thmref{def:location:mimicking})
  \end{assumptions}
  Then
  \begin{goals}
...
\begin{proof}
  ...
  \begin{goals}
  \item $\atled\left(\trg{\loc}\right) = \src{\loc}$
  \item $\xlangbackstateeq{\Delta}{\Delta}$
  \end{goals}

  Claims follow using \Cref{ass:stateagreeinsertion:deltasagree} and \Cref{asm:stateagreeinsertion:delta,asm:stateagreeinsertion:ih}.
\end{proof}
...
\begin{lemma}[Agreement Propagation]\label{lem:trace:agreement:propagation}
  ...
  \item $\tmstraceagree[\delta^{\src{\bullet}}]{\tospecificevs{\trace}}{\trace}$, where $\delta^{\src{\bullet}}_{tms}:\src{L}\to L$
  \end{assumptions}
...
\begin{lemma}[Backtranslation Correctness]\label{lem:backtranslation:correct}
  If
  \begin{assumptions}
  \item $\exect{\Omega}{e}{\Omega'}{\finalexpr}{\trace}$
  \item $\mmlAmmlAtbackdetail{\specificevt{Ret\ !n_0}\cdot\trace\cdot\specificevt{Call\ ?n_1}}=\Game',\src{e}$
  \item $\xlangstateeq{\Omega}{\Omega}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  \end{assumptions}
  then $\exists \delta'\ \atled'\ \src{\Omega'}\ \src{\trace}$,
  \begin{goals}
  \item $\delta\subseteq\delta'$
  ...
  \item $\src{Ret\ !}\mmlAmmlAtbackv{n_0}\src{\cdot\trace[_1]\cdot Call\ ?}\mmlAmmlAtbackv{n_1}\thexlangtraceeq[\delta_1]\trg{Ret\ !n_0\cdot\trace[_1]\cdot Call\ ?n_1}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\end{theorem}
\begin{proof}
  Invert \Cref{asm:rtmsp:trgexec} and note that we assume it terminates in a value, so we immediately disregard the failure cases:
  \begin{passumptions}{H}
  \item\label[ass]{rtmsp:runt:e1} $\exect{\emptyset;\emptyset}{e_1}{\Omega_1}{\valueexpr_1}{\trace[_1]}$
  \item\label[ass]{rtmsp:runt:ep} $\exec{\trg{\Omega_1}}{\mmlAmmlAtcomp{e_p}}{\trg{\Omega_p}}{\trg{\valueexpr_p}}{\trg{\trace[_p]}}$
  \item $\exect{\Omega_p}{e_2}{\Omega_2}{\valueexpr_2}{\trace[_2]}$
  ...
  Now note that $\xlangstateeq[\emptyset]{\emptyset}{\emptyset}$ by \Cref{tr:compile-empty-heap-or-map-eq}.
  Analogousy, $\xlangbackstateeq[\emptyset]{\emptyset}{\emptyset}$ by \Cref{tr:back-compile-empty-heap-or-map-eq}.
  Using these three facts, we apply \thmref{lem:backtranslation:correct} on \Cref{rtmsp:runt:e1}:

  \begin{passumptions}{H^{\tiny 1}}
  \item $\emptyset\subseteq\delta_1$, where $\delta_1:\src{L}\to\trg{L}$
  \item $\emptyset\subseteq\atled_1$, where $\atled_1:\trg{L}\to\src{L}$
  \item $\exec{\src{\emptyset}}{\src{e_1}}{\src{\Omega_1}}{\mmlAmmlAtbackv{f}}{\src{\trace[_1]}}$
  \item $\xlangstateeq[\delta_1]{\Omega_1}{\Omega_1}$
  ...
  \begin{passumptions}{H'}
    \setcounter{enumi}{1}
  \item\label[ass]{rtmsp:runt:ep:compv} $\exec{\trg{\Omega_1}}{\mmlAmmlAtcomp{e_p}}{\trg{\Omega_p}}{\mmlAmmlAtcomp{\valueexpr_p}}{\trg{\trace[_p]}}$
  \end{passumptions}
