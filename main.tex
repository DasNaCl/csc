...
\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc}}]{\trace}=\Game',\trg{\overline{\loc'}},\src{K}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc}}$, construct a \varmapbacktransds $\Game'$,\\another stack of locations $\trg{\overline{\loc'}}$, and an $\mmlAs$\\backtranslation contexts from target-trace $\trg{\mstrace}$.''}
    %
    \typerule{backtrans-empty}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\hole{\cdot}}=\Game,\trg{\overline{\loc}},\src{\hole{\cdot}}
    }{backtrans-empty}
    \typerule{backtrans-alloc}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Alloc\ \loc\ s}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-alloc}
    \typerule{backtrans-dealloc}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Dealloc\ \loc}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-dealloc}
    \typerule{backtrans-set}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Set\ \loc\ n}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-set}
    \typerule{backtrans-get}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Get\ \loc\ n}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-get}
    \typerule{backtrans-abort}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\lightning}=\Game,\trg{\overline{\loc}},\src{abort();\hole{\cdot}}
    }{backtrans-abort}
    %
    \typerule{backtrans-call-comptoctx}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K} &
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Call\ \comptoctx\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-call-comptoctx}
    %
    \typerule{backtrans-ret-comptoctx}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K'} &
      \src{z}=\Game_z(\trg{\loc}) &
      \src{K}=\src{delete\ z; K'}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\loc,\overline{\loc}}]{\trg{Ret\ \comptoctx\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-ret-comptoctx}
    %
    \typerule{backtrans-call-ctxtocomp}{
      \fresh{\Game}{\trg{\loc}}&
      \Game_z=\Game[\trg{\loc}] &
      \mmlAmmlAtbackdetail[\Game_z,\trg{\loc,\overline{\loc}}]{\trace}=\Game',\trg{\overline{\loc'}},\src{K'} \\
      \src{K}=\src{let\ z = new\ 42\ in\ call\ }\mmlAmmlAtbackdetail[\Game_z]{foo}\ \mmlAmmlAtbackv[\Game_z]{\interfacevalue}\src{; K'}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-call-ctxtocomp}
    \typerule{backtrans-ret-ctxtocomp}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Ret\ \ctxtocomp\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{K}
    }{backtrans-ret-ctxtocomp}
  \end{center}
}{tms-pres-backtrans}{Trace-Based Backtranslation from memory-specific $\mmlAt$ events to $\mmlAs$ terms.}
.\MK{add definition of backtranslation contexts (basically eval ctxs, but with possibility to add hole in let at the other position)}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\hole{\cdot}}]{\trace[_0]} = \Game', \trg{\overline{\loc}}, \src{K_0} &
      \mmlAmmlAtbackdetail[\Game',\trg{\overline{\loc}}]{\trace[_1]} = \Game'', \trg{\hole{\cdot}}, \src{K_1} &
      \src{e} = \src{K_0\hole{K_1\hole{42}}}
    }{
...
\begin{lemma}[Expression-based Backtranslation is Well-Typed]\label{lem:expr:backtranslation:welltyped}
  If
  \begin{assumptions}
  \item $\trg{\trace}$ not stuck
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trace}=\Game,\trg{\overline{\loc'}},\src{K}$
  \item $\Gammas$ from $\trg{\overline{\loc}}$ and $\Game$\MK{add another relation...}
  \end{assumptions}
  Then
  \begin{goals}
  \item $\typechecks{\Gamma}{K}{\nat\to\nat}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Backtranslation is Well-Typed]\label{lem:backtranslation:welltyped}
  ...
  \begin{assumptions}
  \item $\trg{\trace}$ not stuck
  \item $\mmlAmmlAtback[\emptyset]{\trace}=\Game,\src{\library}$
  \end{assumptions}
  Then
  \begin{goals}
  \item $\vdash\src{\library}\operatorname{ok}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Very Beginning of Backtranslation Correctness]\label{lem:exprbacktranslation:vbeg:wrapper:correct}
  If
  \begin{assumptions}
  \item $\trg{\Omega}=\trg{\commlib;\library;\hole{\cdot};\memstate}$
  \item $\trg{\library}=\trg{\library_{ctx}\linker}\mmlAmmlAtcomp{\library_{comp}}$
  \item $\trg{\commlib}=\mmlAmmlAtcomp{\commlib}=\operatorname{dom}\ \mmlAmmlAtcomp{\library_{comp}}$
  \item $\exect{\Omega}{e}{\Omega'}{e'}{Call\ \comptoctx\ main\ 0}$
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{Call\ \comptoctx\ main\ 0}=\Game,\trg{\overline{\loc}},\src{\hole{\cdot}_{bt}}$
  \item $\xlangstateeq{\Omega}{\Omega}$
  \item $\src{\Omega}=\src{\commlib;\library;\hole{\cdot};\memstate}$
  \item $\src{\library}=\left\{\src{main}\mapsto\src{e_{main}}\right\}\src{\linker\library_{comp}}$
  \end{assumptions}
  then $\exists \delta'\ \src{\trace}\ \src{L'}\ \src{X'}$,
  \begin{goals}
  \item $\delta\subseteq\delta'$
  \item $\src{L}\subseteq\src{L'}$
  \item $\src{X}\subseteq\src{X'}$
  \item $\exec{\src{\Omega}}{\src{call\ main\ 0}}{\src{\commlib;\library;\hole{\cdot}^{main}_{\ctxtocomp},\hole{\cdot};\memstate}}{\src{e_{main}}}{\src{\trace}}$
  \item $\xlangbackstateeq[\delta';\src{L'}]{\Omega'}{\src{\commlib;\library;\hole{\cdot}^{main}_{\ctxtocomp};\memstate}}$
  \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{Call\ \comptoctx\ main\ 0}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Beginning of Backtranslation Correctness]\label{lem:exprbacktranslation:beg:wrapper:correct}
  ...
  \item $\trg{\library}=\trg{\library_{ctx}\linker}\mmlAmmlAtcomp{\library_{comp}}$
  \item $\trg{\commlib}=\mmlAmmlAtcomp{\commlib}=\operatorname{dom}\ \mmlAmmlAtcomp{\library_{comp}}$
  \item $\exect[]{\Omega}{K_{0}[return\ \interfacevalue]}{\Omega'}{K[\interfacevalue]}{Ret\ \comptoctx\ \interfacevalue}$
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{Ret\ \comptoctx\ \interfacevalue}=\Game',\trg{\overline{\loc'}},\left(\src{delete\ z;\hole{\cdot}}\right)_{\src{bt}}$
  \item $\xlangstateeq{\Omega}{\Omega}$
  \item $\src{K}=\src{\hole{\cdot};}\left(\left(\src{delete\ z;\hole{\cdot}}\right)_{\src{bt}}\src{\hole{e_{any}}}\right)$
  ...
  \item $\src{L}\subseteq\src{L'}$
  \item $\src{X}\subseteq\src{X'}$
  \item $\exec{\src{\Omega}}{\src{K_{component}[return\ }\mmlAmmlAtbackv[\Game']{\trg{\interfacevalue}}\src{]}}{\src{\commlib;\library;\kontstack;\memstate}}{\src{delete\ z;e_{any}}}{\src{\trace}}$
  \item $\xlangbackstateeq[\delta';\src{L'}]{\Omega'}{\src{\commlib;\library;\hole{\cdot}^{main}_{\ctxtocomp};\memstate}}$
  \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{Ret\ \comptoctx\ \interfacevalue}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Middle of Backtranslation Correctness]\label{lem:exprbacktranslation:mid:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackdetail[\Game]{\trace}=\Game',\src{K_{bt}}$
  ...
  \item $\src{\library}=\left\{\src{main}\mapsto\src{e_{main}}\right\}\src{\linker\library_{comp}}$
  \end{assumptions}
  then $\forall\src{e},\exists \delta'\ \src{\memstate'}\ \src{\trace}$,
  \begin{goals}
  \item $\delta\subseteq\delta'$
  \item $\exec{\src{\Omega'}}{\src{K_{bt}\hole{e}}}{\src{\commlib;\library;\kontstack;\memstate'}}{\src{e}}{\src{\trace}}$
...
\begin{lemma}[End of Backtranslation Correctness]\label{lem:exprbacktranslation:end:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{Call\ \ctxtocomp\ foo\ \interfacevalue}=\Game',\trg{\overline{\loc'}},\left(\src{let\ z = new\ 42\ in\ call\ foo\ }\mmlAmmlAtbackv{\interfacevalue}\src{;\hole{\cdot}}\right)_{\src{bt}}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  \item $\src{\Omega}=\src{\commlib;\library;\kontstack;\memstate}$
  \item $\src{\library}=\left\{\src{main}\mapsto\src{e_{main}}\right\}\src{\linker\library_{comp}}$
  \end{assumptions}
  ...
  \item $\src{L}\subseteq\src{L'}$
  \item $\src{X}\subseteq\src{X'}$
  \item $\exec{\src{\Omega}}{\src{K[call\ foo\ }\mmlAmmlAtbackv{\interfacevalue}\src{]}}{\src{\commlib;\library;K^{foo}_{\comptoctx},\kontstack;\memstate}}{\src{e_{foo}}}{\src{\trace}}$
  \item $\xlangstateeq[\delta';\src{L'}]{\src{\commlib;\library;\kontstack;\memstate'}}{\Omega'}$
  \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{\event[_{end}]}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Very End of Backtranslation Correctness]\label{lem:exprbacktranslation:vend:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{Ret\ \ctxtocomp\ n}=\Game,\trg{\overline{\loc}},\src{\hole{\cdot}_{bt}}$
  \item $\xlangstateeq{\Omega}{\Omega}$
  ...
  \item $\src{L}\subseteq\src{L'}$
  \item $\src{X}\subseteq\src{X'}$
  \item $\exec{\src{\Omega}}{\src{K[return\ }\mmlAmmlAtbackv{n}\src{]}}{\src{\commlib;\library;\hole{\cdot};\memstate}}{\mmlAmmlAtbackv{n}}{\src{\trace}}$
  \item $\xlangbackstateeq[\delta';\src{L'}]{\Omega'}{\src{\commlib;\library;\hole{\cdot};\memstate}}$
  \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{Call\ \comptoctx\ main\ 0}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
...
%   \item $\trg{\library}=\trg{\library_{ctx}\linker}\mmlAmmlAtcomp{\library_{comp}}$
%   \item $\trg{\commlib}=\mmlAmmlAtcomp{\commlib}=\operatorname{dom}\ \mmlAmmlAtcomp{\library_{comp}}$
%   \item $\exect{\Omega}{e}{\Omega'}{e'}{\event[_{begin}]\cdot\trace\cdot\event[_{end}]}$
%   \item $\mmlAmmlAtbackdetail[\Game]{\event[_{begin}]\cdot\trace\cdot\event[_{end}]}=\Game',\src{e}$
%   \item $\left(\trg{\event[_{begin}]}=\trg{Call\ \comptoctx\ main\ 0} \wedge \trg{\event[_{end}]}=\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}\right)\vee\\\left(\trg{\event[_{begin}]}=\trg{Ret\ \comptoctx\ \interfacevalue_{p}}\wedge\trg{\event[_{end}]}=\trg{Ret\ \ctxtocomp\ \interfacevalue_{c}}\right)$
%   \item $\xlangbackstateeq{\Omega}{\Omega}$
%   \item $\src{\Omega}=\src{\commlib;\library;\kontstack;\memstate}$
%   \item $\src{\library}=\left\{\src{main}\mapsto\src{e}\right\}\src{\linker\library_{comp}}$
%   \end{assumptions}
%   then $\exists \delta'\ \src{\memstate'}\ \src{\trace}\ \src{e'}\ \src{L'}\ \src{X'}$,
%   \begin{goals}
%   \item $\delta\subseteq\delta'$
%   \item $\src{L}\subseteq\src{L'}$
%   \item $\src{X}\subseteq\src{X'}$
%   \item $\exec{\src{\Omega'}}{\src{e}}{\src{\commlib;\library;\kontstack;\memstate'}}{\src{e'}}{\src{\trace}}$
%   \item $\xlangstateeq[\delta';\src{L'}]{\src{\commlib;\library;\kontstack;\memstate'}}{\Omega'}$
%   \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{\event[_{begin}]\cdot\trace\cdot\event[_{end}]}$
%   \end{goals}
% \end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
