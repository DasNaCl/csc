...
\begin{lemma}[Backtranslation Correctness of $\obj{Start}$]\label{lem:scct:exprbacktranslation:vbeg:wrapper:correct}
  ...
  \item\label[ass]{asm:scct:exprbacktranslation:vbeg:wrapper:correct:exect} $\execo[]{\commlib;\library;\hole{\cdot};\comp;1;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\commlib;\library;(\hole{\cdot}; main),\hole{\cdot};\ctx;1;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{main}[0/x]}{Start;\comp}$
  \item $\mmlAtmsmmlAtscctcomptoctx[\emptyset;\emptyset]{\color{black}\tospecificevo[_{\obj{\bullet}}]{Start}}=\irl{42}$
  \item $\xlangstateeqc[\emptyset;\irl{\hole{\cdot}}]{\commlib;\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;\hole{\cdot};\comp;1;\hole{\cdot};\hole{\cdot};\hole{\cdot}}$
  ...
  \item\label[goal]{goal:scct:exprbacktranslation:vbeg:wrapper:correct:backstateeq} $\xlangstateeqc[\emptyset;\irl{\hole{\cdot}}]{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;1;\hole{\cdot};\hole{\cdot}}$
  \item\label[goal]{goal:scct:exprbacktranslation:vbeg:wrapper:correct:eventeq} $\irl{Start}\thexlangtraceeq[\emptyset;\irl{\hole{\cdot}}]\obj{Start}$
  \end{goals}
\end{lemma}
\begin{proof}
...
\begin{lemma}[Backtranslation Correctness of $\obj{Ret}$]\label{lem:scct:exprbacktranslation:beg:wrapper:correct}
  ...
  \item $\obj{\library}=\obj{\library_{ctx}\linker}\mmlAtmsmmlAtscctcomp{\library_{comp}}$
  \item $\obj{\commlib}=\mmlAtmsmmlAtscctcomp{\commlib}=\operatorname{dom}\ \mmlAtmsmmlAtscctcomp{\library_{comp}}$
  \item\label[ass]{asm:scct:exprbacktranslation:beg:wrapper:correct:exect} $\execo[]{\Omega}{K_{component}[return\ \valueexpr]}{\Omega'}{K[\valueexpr]}{Ret\ \comptoctx\ \valueexpr;\comp}$
  \item $\obj{K_{component}}=\mmlAtmsmmlAtscctcomp{K_{component}}$
  \item $\mmlAtmsmmlAtscctcomptoctx[\Game;\delta]{\color{black}\tospecificevo[_{\obj{\bullet}}]{Ret\ \comptoctx\ \valueexpr}}=\irl{delete\ z;}\mmlAtmsmmlAtscctv[]{\valueexpr}$
  ...
  \item\label[ass]{asm:scct:exprbacktranslation:beg:wrapper:correct:K} $\irl{K}=\irl{\hole{\cdot};delete\ z;K[}\mmlAtmsmmlAtscctv[]{\valueexpr}\irl{]}$
  \item $\irl{\library}=\left\{\irl{main}\mapsto\irl{e_{main}}\right\}\irl{\linker\library_{comp}}$
  \item\label[ass]{asm:scct:exprbacktranslation:beg:wrapper:correct:delta} $\delta\left(\irl{\loc}\right)=\obj{\loc}$
  \item\label[ass]{asm:scct:exprbacktranslation:beg:wrapper:correct:z} $\irl{z}=\Game(\irl{\loc})$
  \item\label[ass]{asm:scct:exprbacktranslation:beg:wrapper:correct:linL} $\irl{\loc}\in\irl{L}$
  \item\label[ass]{asm:scct:exprbacktranslation:beg:wrapper:correct:fooinlibctx} $\obj{foo}\in\obj{\library_{\comp}}$
  \end{assumptions}
  then $\exists n\ \irl{\trace}\ \irl{\memstate'}$,
  \begin{goals}
...
\begin{lemma}[Backtranslation Correctness of $\obj{Call\ \ctxtocomp}$]\label{lem:scct:exprbacktranslation:end:wrapper:correct}
  If
  \begin{assumptions}
  \item $\obj{\Omega}=\obj{\commlib;\library;\kontstack;\ctx;\memstate}$
  \item\label[ass]{asm:scct:exprbacktranslation:end:wrapper:correct:kontstack} $\obj{\kontstack}=\obj{(K';bar),\kontstack'}$
  \item $\obj{\library}=\obj{\library_{ctx}\linker}\mmlAtmsmmlAtscctcomp{\library_{comp}}$
  \item $\obj{\commlib}=\mmlAtmsmmlAtscctcomp{\commlib}=\operatorname{dom}\ \mmlAtmsmmlAtscctcomp{\library_{comp}}$
  \item $\execoN[^{2}]{\Omega}{K\hole{call\ foo\ \valueexpr}}{\commlib;\library;(K;foo),\kontstack;\comp;1;\memstate}{{\color{black}\mmlAtmsmmlAtscctcomp{e_{foo}}}[\valueexpr/y]}{Call\ \ctxtocomp\ foo\ \valueexpr;\ctx}$
  \item $\mmlAtmsmmlAtscctctxtocomp[\Game;\delta]{\color{black}\tospecificevo[_{\obj{\bullet}}]{Call\ \ctxtocomp\ foo\ \valueexpr}}=\Game';\delta';\irl{call\ foo\ }\mmlAtmsmmlAtscctv[]{\valueexpr}$
...
%  \item\label[goal]{goal:scct:exprbacktranslation:end:wrapper:correct:deltasubset} $\delta\subseteq\delta'$
  \item\label[goal]{goal:scct:exprbacktranslation:end:wrapper:correct:execs} $\execN[^{n}]{\irl{\Omega}}{\irl{K[call\ foo\ }\mmlAtmsmmlAtscctv[]{\valueexpr}\irl{]}}{\irl{\commlib;\library;(K;foo),\kontstack;\comp;\memstate'}}{\irl{e_{foo}\gamma}}{\irl{\trace}}$
  ...
  \item\label[goal]{goal:scct:exprbacktranslation:end:wrapper:correct:traceeq} $\irl{\trace}\thexlangtraceeq[\delta']\obj{Call\ \ctxtocomp\ foo\ \valueexpr;\ctx}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Backtranslation Correctness of $\obj{End}$]\label{lem:scct:exprbacktranslation:vend:wrapper:correct}
  ...
  \item $\obj{\library}=\obj{\library_{ctx}\linker}\mmlAtmsmmlAtscctcomp{\library_{comp}}$
  \item $\obj{\commlib}=\mmlAtmsmmlAtscctcomp{\commlib}=\operatorname{dom}\ \mmlAtmsmmlAtscctcomp{\library_{comp}}$
  \item $\execoN[^{2}]{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;n;\memstate}{K\hole{return\ n}}{\commlib;\library;\hole{\cdot};\comp;1;\memstate}{n}{End\ n;\ctx}$
  \item\label[ass]{asm:scct:exprbacktranslation:vend:wrapper:correct:backtrans} $\mmlAtmsmmlAtscctctxtocomp[\Game;\delta]{\color{black}\tospecificevo[_{\obj{\bullet}}]{End\ n}}=\Game';\delta';\irl{return\ }\mmlAtmsmmlAtscctv[]{\valueexpr}$
...
%  \item\label[goal]{goal:scct:exprbacktranslation:end:wrapper:correct:deltasubset} $\delta\subseteq\delta'$
  ...
  \item\label[goal]{goal:scct:exprbacktranslation:vend:wrapper:correct:traceeq} $\irl{\trace}\thexlangtraceeq[\delta']\obj{End\ \valueexpr;\ctx}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Backtranslation Correctness]\label{lem:scct:backtranslation:correct}
  ...
  \item\label[ass]{asm:scct:backtrans:correct:backtrans} $\mmlAtmsmmlAtscct[\emptyset;\emptyset]{\trace}=\Game;\delta;\irl{\library_{ctx}}$
