...
\begin{theorem}[TMS Relation Correctness for $\mmlAtmmlAtmscomp{\bullet}$]\label{thm:tms-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)} = \tmssafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))}{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)}
    \\
    \text{ then }& 
    \tospecificevt[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))} = \tmssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
\end{proof}
\begin{theorem}[SMS Relation Correctness for $\mmlAtmmlAsmscomp{\bullet}$]\label{thm:sms-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\smssafe)} = \smssafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\smssafe))}{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\smssafe)}
    \\
    \text{ then }& 
    \tospecificevt[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\smssafe))} = \smssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding, works since memory accesses need to be in bounds.
\end{proof}
\begin{theorem}[sCCT Relation Correctness for $\mmlAtmmlAscctcomp{\bullet}$]\label{thm:scct-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)} = \scctsafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))}{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)}
    \\
    \text{ then }& 
    \tospecificevt[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))} = \scctsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
\end{proof}
\begin{theorem}[SS Relation Correctness for $\mmlAtmmlAspeccomp{\bullet}$]\label{thm:spec-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\specsafe)} = \specsafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\specsafe))}{\color{black}\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\specsafe)}
    \\
    \text{ then }& 
    \tospecificevt[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\specsafe))} = \specsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SMS Relation Correctness for $\mmlAsmsmmlAtscctcomp{\bullet}$]\label{thm:sms-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificevo[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\smssafe)} = \smssafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\smssafe))}{\color{black}\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\smssafe)}
    \\
    \text{ then }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\smssafe))} = \smssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
\end{proof}
\begin{theorem}[sCCT Relation Correctness for $\mmlAscctmmlAtscctcomp{\bullet}$]\label{thm:scct-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificevo[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)} = \scctsafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))}{\color{black}\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)}
    \\
    \text{ then }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))} = \scctsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding, works since there must not occur leaks according to the x-lang relation.
\end{proof}
\begin{theorem}[SS Relation Correctness for $\mmlAspecmmlAtscctcomp{\bullet}$]\label{thm:spec-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificevo[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\specsafe)} = \specsafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\specsafe))}{\color{black}\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\specsafe)}
    \\
    \text{ then }& 
    \tospecificevi[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\specsafe))} = \specsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{proof}
  ...
  \end{passumptions}
  Apply \Cref{asm:rsmsp:srcsms} to our goal.

  Conclude with \Cref{asm:rsmsp:twprog}.
\end{proof}
...
\begin{theorem}[TMS Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:tms-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)} = \tmssafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))}{\color{black}\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)}
    \\
    \text{ then }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))} = \tmssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SMS Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:sms-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\smssafe)} = \smssafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\smssafe))}{\color{black}\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\smssafe)}
    \\
    \text{ then }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\smssafe))} = \smssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[sCCT Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:scct-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)} = \scctsafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))}{\color{black}\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)}
    \\
    \text{ then }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))} = \scctsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SS Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:spec-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\specsafe)} = \specsafe
    \text{ and } 
    \xlangtraceeq{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\specsafe))}{\color{black}\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\specsafe)}
    \\
    \text{ then }& 
    \tospecificevs[^*_{\delta_{MS}}]{\color{black}\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\specsafe))} = \specsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\myfig{
  \begin{center}
    ...
    $$
  \end{center}
}{scct-pres-compiler}{Compiler from $\mmlAtscct$ to $\mmlAspec$.}
\myfig{
  \begin{center}
    \begin{gather*}
    ...
    \begin{array}{rll}
      \mmlAtscctmmlAspeccomp{\hole{\cdot}}&\ = & \ird{\hole{\cdot}} \\
      \mmlAtscctmmlAspeccomp{F,\library}&\ = & \mmlAtscctmmlAspeccomp{F}\obj{,}\mmlAtscctmmlAspeccomp{\library} \\
    \end{array}
    $$
  \end{center}
}{scct-pres-compiler-comp}{Compiler from $\mmlAtscct$ components to $\mmlAspec$ components.}
...
\begin{scontents}[store-env=buffer]
  $\;$\\
  \begin{goals}
  \item $\vdash\mmlAtscctmmlAspeccomp{\color{black}\mmlAtmsmmlAtscctcomp{\color{black}\mmlAtmmlAtmscomp{\color{black}\mmlAmmlAtcomp{\bullet}}}}:\lceil\operatorname{msafe}\rceil\cap\lceil\operatorname{sCCT}\rceil\cap\lceil\specsafe\rceil$
  \end{goals}
\end{scontents}
