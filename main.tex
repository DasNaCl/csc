...
\myfig{
  \begin{gather*}
    \begin{aligned}
      ...
      \mi{Abstract\ Store}~T \subseteq L\times L \\
      ...
      T\subseteq_2 T' &\text{ iff } \pi_2 T \subseteq \pi_2 T'
    \end{aligned}
  \end{gather*}
...
\myfig{
  \begin{center}
    ...
    %
    \typerule{TMS-Alloc}{
      T'=\left(\pi_1 T\cup\left\{\loc\right\}, \pi_2 T\right)&
      \loc\not\in \pi_1 T&
      \loc\not\in \pi_2 T&
    }{
    ...
    \typerule{TMS-Dealloc}{
      \loc\in \pi_1 T &
      \loc\not\in \pi_2 T &
      T'=\left(\pi_1 T\setminus\left\{\loc\right\},\pi_2 T\right)
    }{
...
\paragraph{$\src{e}=\src{free\ x}$:}
  ...
  \subparagraph{\Cref{tr:store-cons-agree}:}
  If
  \begin{assumptions}
...
\item $\storeagree{T_2}{\src{\Delta_2}}$
  ...
  \subparagraph{\Cref{tr:store-ignore-agree}:}
  If
  \begin{assumptions}
