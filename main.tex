...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-alloc}{
      \Game'=\Game[\trg{\loc}] &
      \Game'',\src{e}=\mmlAmmlAtbackdetail[\Game']{\overline{a_{ms}}} &
    }{
    ...
    \typerule{backtrans-use}{
      \Game'=\Game[\trg{\loc}] &
      \Game'',\src{e}=\mmlAmmlAtback{\overline{a_{ms}}} &
      \src{x}=\Game'(\trg{\loc}) &
    }{
      \mmlAmmlAtbackdetail{\specificevt{Use\ \loc\ n}\cdot\overline{a_{ms}}} = \src{x[}\mmlAmmlAtbackv{n}\src{];e}
    }{backtrans-use}
    %
    \typerule{backtrans-abort}{
      \src{e}=\mmlAmmlAtbackdetail{\overline{a_{ms}}}
    }{
      \mmlAmmlAtbackdetail{\specificevt{\lightning}\cdot\overline{a_{ms}}} = \src{abort();e}
    }{backtrans-abort}
    %
    \typerule{backtrans-internal}{
      \src{e}=\mmlAmmlAtbackdetail{\overline{a_{ms}}}
    }{
      \mmlAmmlAtbackdetail{\specificevt{\varepsilon}\cdot\overline{a_{ms}}} = \src{let\ \_ = 42\ in\ e}
    }{backtrans-internal}
    %
...
%    }{backtrans-ret}
    ...
    \typerule{backtrans-toplevel}{
      ...
      \mmlAmmlAtback{\overline{a}} = \src{context\ }\mmlAmmlAtbackdetail{\overline{a_0}}\ \mmlAmmlAtbackdetail{\overline{a_1}}
    }{backtrans-top}
  \end{center}
