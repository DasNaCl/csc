...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{ctx}-\src{call}-\src{\valueexpr}$}{
      ...
      \execs[]{\Omega}{K[call\ foo\ \valueexpr]}{\Omega'}{return\ e[x/\valueexpr]}{Call\ \comm\ foo\ \valueexpr}
    }{w-e-ectx-call-value}
    %
    \typerule{$e-\text{ctx}-\src{call}-\src{\loc}$}{
      ...
      \execs[]{\Omega}{K[call\ foo\ \loc]}{\Omega'}{return\ e[x/\valueexpr]}{Call\ \comm\ foo\ \loc}
    }{w-e-ectx-call-value}
    %
    \typerule{$e-\text{ctx}-\src{return}-\src{\valueexpr}$}{
      \rho_{\tiny ret}\left(\src{\comm}\right)=\src{\comm_0}\\
    }{
      \execs[]{\commlib;\library;K_{\comm},\kontstack;\memstate}{K'[return\ \valueexpr]}{\commlib;\library;\kontstack;\memstate}{K[\valueexpr]}{Ret\ \comm_0\ \valueexpr}
    }{w-e-ectx-ret}
    %
    \typerule{$e-\text{ctx}-\src{return}-\src{\loc}$}{
      ...
      \execs[]{\commlib;\library;K_{\comm},\kontstack;\memstate}{K'[return\ x]}{\commlib;\library;\kontstack;\memstate}{K[x]}{Ret\ \comm_0\ \loc}
    }{w-e-ectx-ret}
    %
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-call-internal}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Call\ \nocomm\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    }{backtrans-call-internal}
    \typerule{backtrans-ret-internal}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Ret\ \nocomm\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    }{backtrans-ret-internal}
    %
    \typerule{backtrans-call-ctxtocomp}{
      \fresh{\Game}{\trg{\loc}}&
      \src{z}=\Game[\trg{\loc}]&
      \mmlAmmlAtbackdetail[\Game,\trg{\loc,\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e'} \\
      \src{e}=\src{let\ z = new\ 42\ in\ call\ }\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{foo}\ \mmlAmmlAtbackv{\interfacevalue}\src{;e'}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    }{backtrans-call-ctxtocomp}
    \typerule{backtrans-ret-ctxtocomp}{
      \fresh{\Game}{\trg{\loc}}&
      \src{z}=\Game[\trg{\loc}]&
      \mmlAmmlAtbackdetail[\Game,\trg{\loc,\overline{\loc}}]{\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e'} \\
      \src{e}=\src{let\ z = new\ 42\ in\ return\ }\mmlAmmlAtbackv{\interfacevalue}\src{;e'}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Ret\ \ctxtocomp\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    ...
    \typerule{backtrans-call-comptoctx}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\loc,\overline{\loc}}]{\trg{Call\ \comptoctx\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
    ...
    \typerule{backtrans-ret-comptoctx}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\loc,\overline{\loc}}]{\trg{Ret\ \comptoctx\ \interfacevalue}\cdot\trg{\trace}}=\Game',\trg{\overline{\loc'}},\src{e}
...
\myfig{
  \begin{center}
    \typerule{backtrans-base}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trace}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trace} = \Game',\src{e}
    }{backtrans-base}
    %
    ...
    \typerule{backtrans-top-level}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\hole{\cdot}}]{\trace[_0]\cdot\trace[_1]} = \Game', \src{e}
    }{
...
.\MK{can we generalize above definition to yield $\library$? likely not... bc: \texttt{if 1337 < x then abort() else delete x}}

.\MK{at least weaken to ``no multiple calls'' instead of ``just one call''}
