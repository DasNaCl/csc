...
\newcommand{\expreval}[3]{{#1}\xspace\Downarrow_{#2}\xspace{#3}}
\newcommand{\exprevals}[3]{\src{\expreval{#1}{#2}{#3}}}
...
\myfig{
  ...
  \end{aligned}
  \end{gather*}
}{while-syntax}{Syntax of $While_\arr$.}
...
\myfig{
  ...
  \end{center}
}{w-command-ty}{Checking of $While_\arr$ commands.}
...
\myfig{
  ...
  \end{center}
}{w-program-ty}{Checking of $While_{\arr}$ programs.}
...
}{w-step}{Evaluation Relation of $While_{\arr}$}
...
}{while-arr-manysteps}{A \textit{coinductive} definition of $While_{\arr}$ programs taking an infinite amount of steps.}
