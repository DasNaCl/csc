...
\myfig{
  \begin{center}
    ...
    \begin{array}{rcl}
      ...
      \tospecificevcomps{Call\ ?n_1\cdot\trace{_p}\cdot Ret\ !n_2\cdot\trace{_1}} &\ = & \operatorname{map}\ \thetospecificfilter\ \left(\src{Call\ ?n_1\cdot \trace{_p} \cdot Ret\ !n_2}\right)\\
    \end{array}
    $$
  \end{center}
