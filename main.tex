...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \fresh{\Game}{\trg{\loc}}\\
      \mmlAmmlAtbackdetail[\Game,\src{\type_0\to\type_p}]{\mstrace[_0]\cdot\specificev{Alloc\ \loc\ 42}} = \Game', \src{e_0} \\
      \src{e_0'}=\src{let\ x=}\mmlAmmlAtbackv{\finalexprnoerr_0}\src{\ in\ e_0} &
      \src{z}=\Game'[\trg{\loc}] &
      \src{e_0''}=\plugs[N]{delete\ z}{e_0'}\\
      \mmlAmmlAtbackdetail[\Game',()]{\mstrace[_1]}=\Game'',\src{e_1}
    }{
      \mmlAmmlAtback[\Game]{\trace} = \Game'', \src{context\ e_0''\ e_1}
    }{backtrans-top-level}
    %
