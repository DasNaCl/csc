...
\myfig{
  \begin{center}
    ...
    \typechecks{}{x\mapsto\loc_\rho^\diamond,\Delta}{\Gamma}
    }{t-ignore-store}
    %
    \typerule{$T\text{ref}\nat$}{
    \typechecks{}{\Delta}{\Gamma}
...
\item[\Cref{tr:store-cons-agree}:]
  ...
  \Cref{goal:basetmsmonitor:storeagree1}, $\storeagreetms[\delta']{\tmsmonitor[']}{\src{\Delta_1,x\mapsto\loc_\poisoned,\Delta_2}}$, follows immediately by \Cref{tr:store-ignore-agree}.
