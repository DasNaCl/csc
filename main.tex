...
\myfig{
  ...
  %
  \mi{Expressions}~\obj{e} \bnfdef&\ \obj{\finalexpr} \mid \obj{e_{1} \oplus e_{2}} \mid \obj{x[e]} \mid \obj{rddoit\ x} \mid \obj{wrdoit\ e} \\
  & \mid \obj{let\ x = e_{1}\ in\ e_{2}} \mid \obj{x\leftarrow e_{1}[e_{2}]} \\
