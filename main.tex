...
\begin{lemma}[Base SMS via Monitor]
  If
  \begin{assumptions}
    \item $\exprevalt{\Omega}{e_{0}}{\Omega'}{e_{0}'}{\event}$
    \item $\trg{e}=\mmlAtmmlAtcomp{e_{0}}$
    \item $\trg{\Omega}=\trg{\cfstate;\comp;\memstate}$
    \item\label[ass]{asm:basesmsviamonitor:step} $\exect{\Omega}{e}{\Omega'}{e'}{\event}$
...
\begin{incompleteproof}
  ...
  \begin{itemize}
    ...
    \item $\trg{\memstate}=\trg{H^{\ctx};H^{\comp};\Delta}$
  \end{itemize}
  Induction on $\exprevalt{\Omega}{e}{\Omega'}{e'}{\event}$.
  \begin{description}
    \item $\trg{e}=\trg{n_{1}\oplus n_{2}}$\textbf{:}
      If
      \begin{passumptions}{H}
        \item $\trg{n_{3}}=\trg{n_{1}}\oplus\trg{n_{2}}$
        \item $\trg{n_{1}\oplus n_{2}}=\mmlAtmmlAtcomp{e_{0}}$
    ...
    \item $\trg{e}=\trg{let\ x=\finalexprnoerr\ in\ e}$\textbf{:}
      If
      \begin{passumptions}{H}
        \item $\trg{let\ x=\finalexprnoerr\ in\ e}=\mmlAtmmlAtcomp{e_{0}}$
    ...
    \item $\trg{e}=\trg{if\ 0\ then\ e_{1}\ else\ e_{2}}$\textbf{:}
      If
      \begin{passumptions}{H}
        \item $\trg{if\ 0\ then\ e_{1}\ else\ e_{2}}=\mmlAtmmlAtcomp{e_{0}}$
    ...
    \item $\trg{e}=\trg{if\ S(n)\ then\ e_{1}\ else\ e_{2}}$\textbf{:}
      If
      \begin{passumptions}{H}
        \item $\trg{if\ S(n)\ then\ e_{1}\ else\ e_{2}}=\mmlAtmmlAtcomp{e_{0}}$
