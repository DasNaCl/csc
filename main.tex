...
\myfig{
  \begin{center}
    ...
    \typerule{\sCCT-Alloc-Authentic}{
      ...
      \sccttraceagree{\specificev{Alloc\ \loc\ n}}{\textbf{Alloc}}
    }{scct-alloc-auth}
    %
    \typerule{\sCCT-Dealloc-Authentic}{
    }{
      \sccttraceagree{\specificev{Dealloc\ \loc}}{\textbf{Dealloc}}
    }{scct-dealloc-auth}
    %
    \typerule{\sCCT-Use-Authentic}{
    }{
      \sccttraceagree{\specificev{Use\ \loc\ n}}{\textbf{Use}}
    }{scct-use-auth}
    %
    ...
    \typerule{\sCCT-Branch-Authentic}{
      ...
      \sccttraceagree{\specificev{Branch\ n}}{\textbf{Branch}}
    }{scct-branch-auth}
    %
    \typerule{\sCCT-Binop-Authentic}{
    }{
      \sccttraceagree{\specificev{Binop\ n}}{\textbf{Binop}}
    }{scct-binop-auth}
    %
...
\myfig{
  \begin{center}
    \judgbox{\delta_{\sCCT}(\obj{\loc})=\specificev{\loc}}{,,A map from $\mmlAo$ memory locations $\obj{\loc}$ to \sCCT-specific locations $\specificev{\loc}$.''}
    \judgbox{\tospecificevo[_{\delta_{\sCCT}}]{\event} = \scctevent}{,,Project an $\mmlAo$ event to \sCCT-specific events.''}
    %
    \typerule{o-scct-filter-context}{
      \obj{\event_b} \not= \obj{\lightning}
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{\event_b;\ctx} = \specificev{\emptyevent}
    }{o-scct-filter-context}
    %
    \typerule{o-scct-filter-comp-start}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Start;\comp} = \specificev{\emptyevent}
    ...
    \typerule{o-scct-filter-comp-alloc}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{Alloc\ \loc\ n;\comp} = \specificev{\emptyevent}
    }{o-scct-filter-comp-alloc}
    %
    \typerule{o-scct-filter-comp-dealloc}{
      \delta_{\sCCT}(\obj{\loc})=\specificev{\loc}
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Dealloc\ \loc;\comp} = \specificev{\emptyevent}
    ...
    \typerule{o-scct-filter-comp-get-noleak}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{\widehat{Get}\ \loc\ n;\comp} = \specificev{\emptyevent}
    ...
    \typerule{o-scct-filter-comp-set-noleak}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{\widehat{Set}\ \loc\ n\ \valueexpr;\comp} = \specificev{\emptyevent}
    ...
    \typerule{o-scct-filter-comp-get-leak}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{Get\ \loc\ n;\comp} = \specificev{Use\ \loc\ n}
    ...
    \typerule{o-scct-filter-comp-set-leak}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{Set\ \loc\ n\ \valueexpr;\comp} = \specificev{Use\ \loc\ n}
    }{o-scct-filter-comp-set-leak}
    %
    \typerule{o-scct-filter-comp-call}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Call\ \comm\ foo\ \interfacevalue;\comp} = \specificev{\emptyevent}
    }{o-scct-filter-comp-call}
    %
    \typerule{o-scct-filter-comp-ret}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Ret\ \comm\ \interfacevalue;\comp} = \specificev{\emptyevent}
    }{o-scct-filter-comp-ret}
    %
    \typerule{o-scct-filter-comp-binop}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Binop\ n_1\ n_2;\comp} = \specificev{Binop\ n_1\ n_2}
    }{o-scct-filter-comp-binop}
    %
    \typerule{o-scct-filter-comp-branch}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Branch\ n;\comp} = \specificev{Branch\ n}
    }{o-scct-filter-comp-branch}
    %
    \typerule{o-scct-filter-abort}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{\lightning;\sandboxtag} = \specificev{\lightning}
    }{o-scct-filter-abort}
    %
    \judgbox{\tospecificevo[^*_{\delta_{\sCCT}}]{\trace} = \sccttrace}{,,Project an $\mmlAo$ trace to \sCCT-specific traces.''}
    %
  ...
  \end{center}
}{wo-scct-events-project-to-specific}{Projection of $\mmlAo$ events to \gls*{scct}-specific events.}
...
\myfig{
  ...
  \end{center}
}{scct-pres-state-relations-first}{State Relation from $\mmlAtms$ to $\mmlAtscct$. This is meant to relate the states whenever we are ,,inside'' a component.}
...
\myfig{
  \begin{center}
    ...
    \mmlAtmsmmlAtscctcomp{e_1\oplus e_2} &\ = & \mmlAtmsmmlAtscctcomp{e_1} \obj{\widehat{\oplus}} \mmlAtmsmmlAtscctcomp{e_2} \\
      \mmlAtmsmmlAtscctcomp{x[e]} &\ = & \obj{\widehat{load}\ x\ }\mmlAtmsmmlAtscctcomp{e}\\
    \mmlAtmsmmlAtscctcomp{let\ x= e_1\ in\ e_2} &\ = & \obj{let\ x=} \mmlAtmsmmlAtscctcomp{e_1}\obj{\ in\ }\mmlAtmsmmlAtscctcomp{e_2} \\
    \mmlAtmsmmlAtscctcomp{x[e_1]\leftarrow e_2} &\ = & \obj{\widehat{write}\ x\ }\mmlAtmsmmlAtscctcomp{e_1}\ \mmlAtmsmmlAtscctcomp{e_2} \\
    ...
    \mmlAtmsmmlAtscctcomp{ifz\ e_1\ then\ e_2\ else\ e_3} &\ = & \obj{\widehat{ifz}\ }\mmlAtmsmmlAtscctcomp{e_1}\\
...
\myfig{
  \begin{center}
    ...
    \begin{array}{rll}
    %
      \mmlAtmsmmlAtscctcomp{let\ foo\ x := e}&\ = & \obj{let\ foo\ x := }\mmlAtmsmmlAtscctcomp{e}\\
    \end{array}
    $$
    \begin{gather*}
...
\myfig{
  \begin{center}
    ...
    \typerule{obj-filter-context}{
      ...
      \tospecificevo[_{\obj{\bullet}}]{\event_b;\ctx} = \obj{\emptyevent}
    }{obj-filter-context}
    %
    \typerule{obj-filter-unimportant}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{\emptyevent;\sandboxtag} = \obj{\emptyevent}
    }{obj-filter-unimportant}
    %
    \typerule{obj-filter-comp-start}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Start;\comp} = \obj{\emptyevent}
    }{obj-filter-comp-start}
    %
    \typerule{obj-filter-comp-alloc}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Alloc\ \loc\ n;\comp} = \obj{Alloc\ \loc\ n}
    }{obj-filter-comp-alloc}
    %
    \typerule{obj-filter-comp-dealloc}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Dealloc\ \loc;\comp} = \obj{Dealloc\ \loc}
    }{obj-filter-comp-dealloc}
    %
    \typerule{obj-filter-comp-get-noleak}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{\widehat{Get}\ \loc\ n;\comp} = \obj{\widehat{Get}\ \loc\ n}
    }{obj-filter-comp-get-noleak}
    %
    \typerule{obj-filter-comp-set-noleak}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{\widehat{Set}\ \loc\ n\ \valueexpr;\comp} = \obj{\widehat{Set}\ \loc\ n\ \valueexpr}
    }{obj-filter-comp-set-noleak}
    %
    \typerule{obj-filter-comp-get-leak}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Get\ \loc\ n;\comp} = \obj{Get\ \loc\ n}
    }{obj-filter-comp-get-leak}
    %
    \typerule{obj-filter-comp-set-leak}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Set\ \loc\ n\ \valueexpr;\comp} = \obj{Set\ \loc\ n\ \valueexpr}
    }{obj-filter-comp-set-leak}
    %
    \typerule{obj-filter-comp-call}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Call\ \comm\ foo\ \valueexpr;\sandboxtag} = \obj{Call\ \comm\ foo\ \valueexpr;\sandboxtag}
    }{obj-filter-comp-call}
    %
    \typerule{obj-filter-comp-ret}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Ret\ \comm\ \valueexpr;\sandboxtag} = \obj{Ret\ \comm\ \valueexpr;\sandboxtag}
    }{obj-filter-comp-ret}
    %
    \typerule{obj-filter-branch}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Branch\ n;\comp} = \obj{Branch\ n}
    }{obj-filter-branch-leak}
    %
    \typerule{obj-filter-binop}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{Binop\ n_1\ n_2;\comp} = \obj{Binop\ n_1\ n_2}
    }{obj-filter-binop}
    %
    \typerule{obj-filter-abort}{
    }{
      \tospecificevo[_{\obj{\bullet}}]{\lightning;\sandboxtag} = \obj{\lightning}
    }{obj-filter-abort}
    %
    %
...
\myfig{
  \begin{center}
    ...
    \typerule{scct-backtrans-alloc}{
      ...
      \mmlAtmsmmlAtscctdetail[]{\obj{Alloc\ \loc\ s;\sandboxtag}\cdot\obj{\trace}}=\irl{e}
    }{scct-backtrans-alloc}
    \typerule{scct-backtrans-dealloc}{
      \mmlAtmsmmlAtscctdetail[]{\obj{\trace}}=\irl{e}
    }{
      \mmlAtmsmmlAtscctdetail[]{\obj{Dealloc\ \loc;\sandboxtag}\cdot\obj{\trace}}=\irl{e}
    }{scct-backtrans-dealloc}
    \typerule{scct-backtrans-set}{
      \mmlAtmsmmlAtscctdetail[]{\obj{\trace}}=\irl{e}
    }{
      \mmlAtmsmmlAtscctdetail[]{\obj{Set\ \loc\ n\ \valueexpr;\sandboxtag}\cdot\obj{\trace}}=\irl{e}
    }{scct-backtrans-set}
    \typerule{scct-backtrans-get}{
      \mmlAtmsmmlAtscctdetail[]{\obj{\trace}}=\irl{e}
    }{
      \mmlAtmsmmlAtscctdetail[]{\obj{Get\ \loc\ n;\sandboxtag}\cdot\obj{\trace}}=\irl{e}
    }{scct-backtrans-get}
    \typerule{scct-backtrans-abort}{
    }{
      \mmlAtmsmmlAtscctdetail[]{\lightning;\sandboxtag}=\irl{abort()}
    }{scct-backtrans-abort}
    %
  \end{center}
}{scct-pres-backtrans}{Trace-Based Backtranslation from memory-specific $\mmlAtscct$ events to $\mmlAtms$ terms.}
\myfig{
  \begin{center}
    \judgbox{\Game\left(\obj{\loc}\right)=\irl{x}}{,,Map an $\mmlAtscct$ location to an $\mmlAtms$ identifier.''}
    \judgbox{\mmlAtmsmmlAtscctcomptoctx[\Game;\delta;\irl{\overline{\loc}}]{\event}=\irl{\overline{\loc'}};\irl{e}}{,,Given a \varmapbacktransds $\Game$, $\delta$, and $\irl{\overline{\loc}}$, yield\\another stack of locations $\irl{\overline{\loc'}}$, and an $\mmlAtms$\\expression from target $\comptoctx$-interaction-event $\irl{\event}$.''}
    %
    \typerule{scct-backtrans-start}{
    }{
      \mmlAtmsmmlAtscctcomptoctx[\emptyset;\emptyset;\obj{\hole{\cdot}}]{\obj{Start}} = \obj{\hole{\cdot}};\irl{42}
    }{scct-backtrans-start}
    %
%   \typerule{scct-backtrans-call-comptoctx}{
%   }{
%     \mmlAtmsmmlAtscctcomptoctx[\Game;\delta;\obj{\overline{\loc}}]{\obj{Call\ \comptoctx\ foo\ \interfacevalue}}=\obj{\overline{\loc}};\irl{42}
...
%     \mmlAtmsmmlAtscctcomptoctx[\Game;\delta;\obj{\loc,\overline{\loc}}]{\obj{Ret\ \comptoctx\ \valueexpr}}=\obj{\overline{\loc}};\irl{e;}\mmlAtmsmmlAtscctv[]{\valueexpr}
      \mmlAtmsmmlAtscctcomptoctx[\Game;\delta;\obj{\overline{\loc}}]{\obj{Ret\ \comptoctx\ \valueexpr}}=\obj{\overline{\loc}};\irl{e;}\mmlAtmsmmlAtscctv[]{\valueexpr}
    }{scct-backtrans-ret-comptoctx}
    %
    %
    \judgbox{\mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\overline{\loc}}]{\event}=\Game';\delta';\obj{\overline{\loc'}};\irl{e}}{,,Given a \varmapbacktransds $\Game$, $\delta$, and $\obj{\overline{\loc}}$, construct a \varmapbacktransds $\Game'$,\\ a $\delta'$, another stack of locations $\obj{\overline{\loc'}}$, and an $\mmlAtscct$\\expression from target $\ctxtocomp$-interaction-event $\obj{\event}$.''}
    %
...
%     \mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\overline{\loc}}]{\obj{Call\ \ctxtocomp\ foo\ \valueexpr}}=\Game_z;\delta';\obj{\loc,\overline{\loc}};\irl{e}
      \mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\overline{\loc}}]{\obj{Call\ \ctxtocomp\ foo\ \valueexpr}}=\Game_z;\delta;\obj{\overline{\loc}};\irl{e}
    }{scct-backtrans-call-ctxtocomp}
    %
%   \typerule{scct-backtrans-ret-ctxtocomp}{
%     \fresh{\Game}{\irl{x}}
%   }{
%     \mmlAtmsmmlAtscctctxtocomp[\Game,\obj{\overline{\loc}}]{\obj{Ret\ \ctxtocomp\ \interfacevalue}}=\Game,\obj{\overline{\loc}},\irl{let\ x = new\ 1\ in\ delete\ x;return\ }\mmlAtmsmmlAtscctv{\interfacevalue}
...
%     \mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\hole{\cdot}}]{\obj{End\ \valueexpr}}=\Game_z;\delta';\obj{\hole{\cdot}};\irl{e}
  ...
  \end{center}
}{scct-pres-backtrans-interact}{scct-backtranslation of interaction-events from memory-specific $\mmlAtscct$ events to $\mmlAtms$ terms.}
.\MK{get rid of wrapper. what's the point of wrapping if we don't really need it}\\
\myfig{
  \begin{center}
    ...
    \typerule{scct-non-interface-$\obj{Alloc}$}{
      ...
      \vdash \obj{Alloc\ \loc\ n;\sandboxtag} \operatorname{non-int-\obj{\event}}
    }{scct-non-interface-alloc}
    %
    \typerule{scct-non-interface-$\obj{Dealloc}$}{
    }{
      \vdash \obj{Dealloc\ \loc;\sandboxtag} \operatorname{non-int-\obj{\event}}
    }{scct-non-interface-dealloc}
    %
    \typerule{scct-non-interface-$\obj{Get}$}{
    }{
      \vdash \obj{Get\ \loc\ n;\sandboxtag} \operatorname{non-int-\obj{\event}}
    }{scct-non-interface-get}
    %
    \typerule{scct-non-interface-$\obj{Set}$}{
    }{
      \vdash \obj{Set\ \loc\ n;\sandboxtag} \operatorname{non-int-\obj{\event}}
    }{scct-non-interface-set}
    %
    \typerule{scct-non-interface-$\obj{\lightning}$}{
    }{
      \vdash \obj{\lightning;\sandboxtag} \operatorname{non-int-\obj{\event}}
...
\myfig{
  \begin{center}
    \judgbox{\mmlAtmsmmlAtscctsubtop[\Game;\delta; \obj{\overline{\loc}}]{\event[_1]\cdot\trace\cdot\event[_2]}=\Game';\delta';\obj{\overline{\loc'}};\irl{e_1};\irl{e_2};\irl{e_3}}{,,Given a \varmapbacktransds $\Game$, $\delta$, and $\obj{\overline{\loc}}$,\\construct a \varmapbacktransds $\Game'$, a $\delta'$, another\\stack of locations $\obj{\overline{\loc'}}$, and an $\mmlAtms$\\ensemble of expressions from target-\\trace $\obj{\mstrace}$ which starts with a $\ctxtocomp$ event\\and ends in a $\comptoctx$.''}
    %
    \typerule{scct-subtoplevel-backtrans}{
      \vdash \obj{\trace} \operatorname{non-int-\obj{\trace}}\\
      \mmlAtmsmmlAtscctcomptoctx[\Game;\delta;\obj{\overline{\loc}}]{\obj{\event[_1]}}=\obj{\overline{\loc'}};\irl{e_1} &
      \mmlAtmsmmlAtscctdetail[]{\obj{\trace}}=\irl{e_2} &
      \mmlAtmsmmlAtscctctxtocomp[\Game;\delta;\obj{\overline{\loc'}}]{\obj{\event[_2]}}=\Game';\delta';\obj{\overline{\loc''}};\irl{e_3} \\
    }{
      \mmlAtmsmmlAtscctsubtop[\Game;\delta;\obj{\overline{\loc}}]{\obj{\event[_1]\cdot\trace\cdot\event[_2]}}=\Game';\delta';\obj{\overline{\loc''}}; \irl{e_1}; \irl{e_2}; \irl{e_3}
...
%   }{subtoplevel-backtrans-indu}
  \end{center}
}{scct-pres-subtop-backtrans}{Interaction-Trace-Based Backtranslation from memory-specific $\mmlAtscct$ events to $\mmlAtms$ terms.}

\myfig{
  \begin{center}
    \judgbox{\mmlAtmsmmlAtscct[\Game;\delta]{\mstrace} = \Game';\delta;\irl{\library}}{,,Top-Level backtranslation of $\obj{\trace}$ to $\mmlAtms$ library $\irl{\library}$.''}
    %
    \typerule{scct-backtrans-top-level}{
      ...
      \obj{\trace[_0]}=\obj{Start\cdot\trace[_0']\cdot Call\ \ctxtocomp\ foo\ \interfacevalue_1} &
      \obj{\trace[_1]}=\obj{Ret\ \comptoctx\ \interfacevalue_2\cdot\trace[_0']\cdot End\ \interfacevalue_3}\\
%      \mmlAtmsmmlAtscctsubtop[\emptyset;\emptyset;\obj{\hole{\cdot}}]{\color{black}\tospecificevo[^*_\obj{\bullet}]{\trace[_0]}} = \Game; \delta; \obj{\overline{\loc}}; \irl{e_0};\irl{e_0'};\irl{let\ x_0 = new\ n_0\ in\ e_0''} \\
      \mmlAtmsmmlAtscctsubtop[\emptyset;\emptyset;\obj{\hole{\cdot}}]{\color{black}\tospecificevo[^*_\obj{\bullet}]{\trace[_0]}} = \Game; \delta; \obj{\overline{\loc}}; \irl{e_0};\irl{e_0'};\irl{e_0''} \\
      \mmlAtmsmmlAtscctsubtop[\Game;\delta;\obj{\overline{\loc}}]{\color{black}\tospecificevo[^*_\obj{\bullet}]{\trace[_1]}} = \Game'; \delta'; \obj{\hole{\cdot}}; \irl{e_1};\irl{e_1'};\irl{e_1''} \\
%      \irl{e} = \irl{e_0;e_0';let\ x_0 = new\ n_0\ in\ (e_0'';e_1);e_1';e_1''}
      \irl{e} = \irl{e_0;e_0';e_0'';e_1;e_1';e_1''}
    }{
      \mmlAtmsmmlAtscct[\emptyset;\emptyset]{\trace} = \Game';\delta'; \irl{let\ main\ x : \nat\to\nat := e, \hole{\cdot}}
...
\begin{lemma}[Backtranslation Correctness of $\obj{Start}$]\label{lem:cct:exprbacktranslation:vbeg:wrapper:correct}
  If
  \begin{assumptions}
  ...
  \item\label[ass]{asm:exprbacktranslation:vbeg:wrapper:correct:exect} $\execo[]{\commlib;\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\commlib;\library;(\hole{\cdot}; main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{e_{main}[0/x]}{Start;\comp}$
  \item $\mmlAtmsmmlAtscctcomptoctx[\emptyset;\emptyset;\obj{\hole{\cdot}}]{\color{black}\tospecificevo[_{\obj{\bullet}}]{Start}}=\obj{\hole{\cdot}};\irl{42}$
  \item $\xlangstateeqc[\emptyset;\irl{\hole{\cdot}}]{\commlib;\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}$
  \item $\irl{\library}=\left\{\irl{main}\mapsto\irl{42;e_{main}}\right\}\irl{\linker\library_{comp}}$
  \end{assumptions}
  Then $\exists n$
  \begin{goals}
  \item\label[goal]{goal:exprbacktranslation:vbeg:wrapper:correct:execs} $\execN[^{n}]{\irl{\commlib;\library;\hole{\cdot};\comp;\hole{\cdot};\hole{\cdot};\hole{\cdot}}}{\irl{call\ main\ 0}}{\irl{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}}{\irl{e_{main}[0/x]}}{\irl{Start;\comp}}$
  \item\label[goal]{goal:exprbacktranslation:vbeg:wrapper:correct:backstateeq} $\xlangstateeqc[\emptyset;\irl{\hole{\cdot}}]{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{\commlib;\library;(\hole{\cdot};main),\hole{\cdot};\ctx;\hole{\cdot};\hole{\cdot}}$
  \item\label[goal]{goal:exprbacktranslation:vbeg:wrapper:correct:eventeq} $\irl{Start}\thexlangtraceeq[\emptyset;\irl{\hole{\cdot}}]\obj{Start}$
  \end{goals}
\end{lemma}
\begin{proof}
  Similar to \Thmref{lem:exprbacktranslation:vbeg:wrapper:correct}.
\end{proof}
