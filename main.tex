...
\myfig{
  \begin{center}
    \begin{tikzpicture}[state/.style={minimum height=0.6cm}]
      ...
      \path[->,very thick, loop above] (mmlAt) edge[sloped,above] node {SMS} (mmlAt);
    \end{tikzpicture}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{pssedptrs-calls}{
      ...
      \vdash\trg{Call\ \ctxtocomp\ foo\ \loc\cdot\trace} \Rightarrow_{\text{passed\ }\loc\text{s}} \trg{\loc,\overline{\loc}}
    }{passedptrs-calls}
  \end{center}
...
\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc_{\leftrightarrows}}}]{\trace}=\Game',\src{e}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc_{\leftrightarrows}}}$, construct a \varmapbacktransds $\Game'$\\ and an $\mmlAs$ backtranslation contexts from target-trace $\trg{\mstrace}$.''}
    %
    \typerule{backtrans-empty-refs}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\hole{\cdot}}=\Game,\src{42}
    }{backtrans-empty-refs}
    \typerule{backtrans-alloc-in-refs}{
      \trg{\loc}\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtcomp{s}=\trg{s} &
      \fresh{\Game}{\trg{\loc}} \\
      \Game_z=\Game[\trg{\loc}] &
      \src{z}=\Game_z(\trg{\loc}) &
      \mmlAmmlAtbackdetail[\Game_z,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Alloc\ \loc\ s}\cdot\trg{\trace}}=\Game',\src{let\ z = new\ s\ in\ e}
    }{backtrans-alloc-in-refs}
    \typerule{backtrans-alloc-notin-refs}{
      \trg{\loc}\not\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Alloc\ \loc\ s}\cdot\trg{\trace}}=\Game',\src{e}
    ...
    \typerule{backtrans-dealloc-in-refs}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Dealloc\ \loc}\cdot\trg{\trace}}=\Game',\src{delete\ z;e}
    }{backtrans-dealloc-in-refs}
    \typerule{backtrans-dealloc-notin-refs}{
      \trg{\loc}\not\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Dealloc\ \loc}\cdot\trg{\trace}}=\Game',\src{e}
    ...
    \typerule{backtrans-set-in-refs}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Set\ \loc\ n\ v}\cdot\trg{\trace}}=\Game',\src{z[n]\leftarrow v;e}
    }{backtrans-set-in-refs}
    \typerule{backtrans-set-notin-refs}{
      \trg{\loc}\not\in\trg{\overline{\loc_\leftrightarrows}} &
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Set\ \loc\ n\ v}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-set-notin-refs}
    \typerule{backtrans-get-refs}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\trg{Get\ \loc\ n}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-get-refs}
    \typerule{backtrans-abort-refs}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc_{\leftrightarrows}}}]{\lightning}=\Game,\src{abort()}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level-refs}{
      ...
      \trg{\trace[_0]}=\trg{Start\cdot\trace[_0']\cdot Call\ \ctxtocomp\ foo\ \interfacevalue_1} &
      \trg{\trace[_1]}=\trg{Ret\ \comptoctx\ \interfacevalue_2\cdot\trace[_0']\cdot End\ \interfacevalue_3}\\
      \mmlAmmlAtbacksubtop[\Game,\trg{\hole{\cdot}},\trg{\overline{\loc_\rightleftarrows}}]{\trace[_0]} = \Game', \trg{\overline{\loc}}, \src{e_0},\src{e_0'},\src{let\ x_0 = new\ n_0\ in\ e_0''} \\
      \mmlAmmlAtbacksubtop[\Game',\trg{\overline{\loc},\trg{\overline{\loc_\leftrightarrows}}}]{\trace[_1]} = \Game'', \trg{\hole{\cdot}}, \src{e_1},\src{e_1'},\src{e_1''} \\
      \src{e} = \src{e_0;e_0';let\ x_0 = new\ n_0\ in\ (e_0'';e_1);e_1';e_1''}
    }{
      \mmlAmmlAtback[\Game]{\trace} = \Game'', \src{let\ main\ x : \nat\to\nat := e, \hole{\cdot}}
