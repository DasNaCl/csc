...
\myfig{
  ...
  \hspace{0.5cm} \text{where } \src{\oplus}\in\{\src{+},\src{-},\src{\times},\src{<}\}\\
  %
...
\myfig{
  \begin{center}
    \judgbox{\typecheck{}{\src{context\ e_1\ e_2}}{\src{\nat}[\src{\tau_1\to\tau_2}]}}{,,$\mmlAs$ context $\src{context\ e_1\ e_2}$ typechecks.''}$\;$\\
    \judgbox{\typechecks{}{component\ e_p}{\tau_1\to\tau_2}}{,,$\mmlAs$ component $\src{component\ e_p}$ typechecks.''}$\;$\\
    \judgbox{\typechecks{}{program\ e_1\ e_p\ e_2}{\nat}}{,,$\mmlAs$ program $\src{program\ e_1\ e_p\ e_2}$ typechecks.''}$\;$\\
  \typerule{$t-\text{ctx}$}{
    \typechecks{}{e_1}{\tau_1}&
    \typechecks{y:\tau_2}{e_2}{\nat}&
    \src{\tau_1}\operatorname{int}&
    \src{\tau_2}\operatorname{int}&
	}{
  \typecheck{}{\src{context\ e_1\ e_2}}{\src{\nat}[\src{\tau_1\to\tau_2}]}
	}{w-t-ctx}
  %
  \typerule{$t-\text{component}$}{
    \typechecks{x:\tau_1}{e}{\tau_2}&
    \src{\tau_1}\operatorname{int}&
    \src{\tau_2}\operatorname{int}&
	}{
  \typechecks{}{component\ e}{\tau_1\to\tau_2}
	}{w-t-comp}
  %
  \typerule{$t-\text{wprog}$}{
    \typecheck{}{\src{context\ e_0\ e_1}}{\src{\nat}[\src{\tau_1\to\tau_2}]} &
    \typechecks{}{component\ e_p}{\tau_1\to\tau_2}
	}{
  ...
  \begin{gather*}
    \begin{aligned}
      ...
      \src{let\ x=K\ in\ e}\\
                     ...
                     &\ \mid\src{ifz\ K\ then\ e_1\ else\ e_2}
    \end{aligned}
  \end{gather*}
...
\myfig{
  ...
  \typerule{$e-\text{wprog}$}{
    ...
    \wexecs{prog\ e_0\ e_p\ e_1}{\configs_1}{\finalexprnoerr_1}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\finalexprnoerr_0\cdot \trace{_p}\cdot Ret\ !\finalexprnoerr_p\cdot \trace{_1}\cdot Call\ ?\finalexprnoerr_1}
  }{ws-e-prog}
  ...
  \typerule{$e-\text{wprog}-$fail1}{
    ...
    \execs{\hole{\cdot};\hole{\cdot}}{e_0}{\configs_0}{\finalexprnoerr_0}{\trace{_0}} \\
    \execs{\qconfig_0}{e_p[\finalexprnoerr_0/x]}{\configs_p}{\finalexprnoerr_p}{\trace{_p}} &
    \execs{\configs_p}{e_1[\finalexprnoerr_p/y]}{\lightning}{stuck}{\trace{_1}} &
  }{
    \wexecs{prog\ e_0\ e_p\ e_1}{\lightning}{stuck}{Ret\ !0\cdot\trace{_0}\cdot Call\ ?\finalexprnoerr_0\cdot \trace{_p}\cdot Ret\ !\finalexprnoerr_p\cdot \trace{_1}}
  }{ws-e-prog-fail1}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      \trg{\loc}\ \text{fresh} &
      \mmlAmmlAtbackdetail{\specificevt{Alloc\ \loc\ 42}\cdot\mstrace\cdot\specificevt{Dealloc\ \loc}} = \Game', \src{e}
    }{
