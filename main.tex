...
\begin{definition}[$\mmlAs$ Robust Satisfaction]
  We write $\src{\library_{ctx}}\vDash_{R}\pi$ for
  $$
    \forall \src{\library_{comp}}\ \src{\trace}\ \src{\Omega}\ \src{\finalexpr}, \wexecs{prog\ \library_{\ctx}\ \library_{\comp}}{\Omega}{\finalexpr}{\trace} \implies \exists \delta_{MS}, \tospecificevs[_{\delta_{MS}}]{\trace}\in\pi
  $$
\end{definition}

\begin{definition}[$\mmlAt$ Robust Satisfaction]
  We write $\trg{\library_{ctx}}\vDash_{R}\pi$ for
  $$
    \forall \trg{\library_{comp}}\ \trg{\trace}\ \trg{\Omega}\ \trg{\finalexpr}, \wexect{prog\ \library_{\ctx}\ \library_{\comp}}{\Omega}{\finalexpr}{\trace} \implies \exists \delta_{MS}, \tospecificevt[_{\delta_{MS}}]{\trace}\in\pi
  $$
\end{definition}
...
\begin{proof}
  ...
  \begin{assumptions}
    ...
    \item $\src{\library_{ctx}}\vDash_{R}\pi$
  \end{assumptions}
  then
  \begin{goals}
    \item $\mmlAmmlAtcomp{\library_{\ctx}}\vDash_{R}\pi$
...
\begin{proof}
  ...
  \begin{passumptions}{H}
    ...
    \item\label[ass]{asm:rsmsp:srcsms} $\trg{\library_{\ctx}}\vDash_{R}\pi$
  \end{passumptions}
  then
  \begin{goals}
    \item $\mmlAtmmlAtmscomp{\library_{\ctx}}\vDash_{R}\pi$
  \end{goals}
  \MK{unfold goal etc etc}
