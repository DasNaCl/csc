...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{ctx}-\obj{return}-$main}{
      ...
      \exec[]{\obj{\commlib;\library;\hole{\cdot}^{main},\hole{\cdot};\ctx;m;\memstate}}{\obj{K'[return\ \valueexpr^\sigma]}}{\obj{\commlib;\library;\hole{\cdot};\comp;m;\memstate}}{\obj{\valueexpr^\sigma}}{\obj{End\ \valueexpr;\sandboxtag;\sigma}}
    }{to-e-ectx-ret-main}
    %
...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{wprog}$}{
      ...
      \execo{\commlib;\library;\hole{\cdot};\sandboxtag;0;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\Omega}{\finalexpr}{\trace}
    }{
    ...
    \typerule{$e-\text{wprog}-\lightning$}{
      ...
      \obj{main}\notin\obj{\commlib} &
      \obj{\commlib}=\operatorname{dom}\ \obj{\library_{comp}} \\
      \execo{\commlib;\library;\hole{\cdot};\sandboxtag;0;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\Omega}{\finalexpr}{\trace\cdot\lightning;\sandboxtag}
    }{
