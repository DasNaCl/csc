...
\begin{incompleteproof}
  ...
  \item \textbf{Case $\trg{\trace}=\trg{\event\cdot\trace}$:}
          % TODO: Add induction hypothesis
  If
  \begin{assumptions}
  \item $\exect{\Omega}{e}{\Omega'}{\valueexpr}{\event\cdot\trace}$
  \item $\msevent\cdot\mstrace=\tospecificevt{\event}\cdot\thetospecificfilter\left(\trg{\trace}\right)$
