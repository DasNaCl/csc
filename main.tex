...
\begin{incompleteproof}
  ...
  We need to verify that $\src{\Gamma_0}\vdash\src{\library}\operatorname{ok}$ to conclude $\vdash\src{prog\ \library_{ctx}\ \library_{comp}\dashv\src{\library},\operatorname{dom}\library_{comp}}$.
