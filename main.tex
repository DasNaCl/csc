...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case} \ref{tr:tw-e-get-notin}\textbf{:}
          ...
          \begin{passumptions}{H}
            \item $\trg{\memstate}=\trg{H^{\ctx};H^{\comp};\Delta_{1},x\mapsto(\loc;\comp;\poison;m),\Delta_{2}}$
            \item $\irl{\gamma}=\trg{\gamma}=\trg{\hole{\cdot}}$
    ...
    \item \textbf{Case} \ref{tr:tw-e-let-new-comp}\textbf{:}
          ...
          Now, it's easy to see that we can execute to the desired state $\irl{\Omega'}$ with just $\irl{Alloc\ \loc\ n;\comp}$.
    ...
    \item \textbf{Case} \ref{tr:tw-e-let-x}\textbf{:}
          ...
          Then
          \begin{goals}
            \item $\exec{\irl{\Omega}}{\mmlAtmmlAtmscomp{let\ x=\valueexpr\ in\ e}}{\irl{\Omega}}{\mmlAtmmlAtmscomp{e[\valueexpr/x]}}{\irl{\event}}$
            \item $\storeagreesms[\delta]{\smsmonitor}{\trg{\Omega}}$
          \end{goals}
          Note that $\mmlAtmmlAtmscomp{let\ x=\valueexpr\ in\ e}=\irl{let\ x=}\mmlAtmmlAtmscomp{\valueexpr}\irl{\ in\ }\mmlAtmmlAtmscomp{e}$.

          Also by \Thmref{thm:mscomp:subst:compat}, $\mmlAtmmlAtmscomp{e[\valueexpr/x]}=\mmlAtmmlAtmscomp{e}\mmlAtmmlAtmscomp{[\valueexpr/x]}$.

          Now, it is easy to see that we can execute to the desired term.
