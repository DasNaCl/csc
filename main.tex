...
\myfig{
  \begin{center}
    ...
    \typerule{o-filter-comp-call}{
      ...
      \tospecificevo[_{\delta_{MS}}]{Call\ \comm\ foo\ \interfacevalue;\comp;\sigma} = \specificev{\emptyevent}
    }{o-filter-comp-call}
    %
    \typerule{o-filter-comp-ret}{
    }{
      \tospecificevo[_{\delta_{MS}}]{Ret\ \comm\ \interfacevalue;\comp;\sigma} = \specificev{\emptyevent}
    }{o-filter-comp-ret}
    %
...
\myfig{
  \begin{center}
    ...
    \typerule{o-scct-filter-comp-alloc}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{Alloc\ \loc\ n;\comp;\sigma} = \specificev{\emptyevent}
    }{o-scct-filter-comp-alloc}
    %
    \typerule{o-scct-filter-comp-dealloc}{
      \delta_{\sCCT}(\obj{\loc})=\specificev{\loc}
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Dealloc\ \loc;\comp;\sigma} = \specificev{\emptyevent}
    ...
    \typerule{o-scct-filter-comp-get-leak}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{Get\ \loc\ n;\comp;\sigma} = \specificev{Use\ \loc\ n}
    ...
    \typerule{o-scct-filter-comp-set-leak}{
      ...
      \tospecificevo[_{\delta_{\sCCT}}]{Set\ \loc\ n\ \valueexpr;\comp;\sigma} = \specificev{Use\ \loc\ n}
    }{o-scct-filter-comp-set-leak}
    %
    \typerule{o-scct-filter-comp-call}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Call\ \comm\ foo\ \interfacevalue;\comp;\sigma} = \specificev{\emptyevent}
    }{o-scct-filter-comp-call}
    %
    \typerule{o-scct-filter-comp-ret}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Ret\ \comm\ \interfacevalue;\comp;\sigma} = \specificev{\emptyevent}
    }{o-scct-filter-comp-ret}
    %
    \typerule{o-scct-filter-comp-binop}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Binop\ n_1\ n_2;\comp;\sigma} = \specificev{Binop\ n_1\ n_2}
    }{o-scct-filter-comp-binop}
    %
    \typerule{o-scct-filter-comp-branch}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{Branch\ n;\comp;\sigma} = \specificev{Branch\ n}
    }{o-scct-filter-comp-branch}
    %
    \typerule{o-scct-filter-abort}{
    }{
      \tospecificevo[_{\delta_{\sCCT}}]{\lightning;\sandboxtag;\sigma} = \specificev{\lightning}
    }{o-scct-filter-abort}
    %
