...
\myfig{
  \begin{center}
    ...
    %
    \mmlAmmlAtcomp{\Omega}_\delta&\ = & \text{let\ }\src{H};\src{\Delta}=\src{\Omega}\text{\ in}\\
                          && \text{let\ }\trg{\Omega}=\mmlAmmlAtcomp{H}_\delta;\mmlAmmlAtcomp{\Delta}_\delta\text{\ in}\\
                          && \trg{\Omega} \\
    \mmlAmmlAtcomp{\emptyset}_\delta &\ = & \trg{\emptyset}\\
    \mmlAmmlAtcomp{n,H}_\delta &\ = & \mmlAmmlAtcomp{n}\trg{,}\mmlAmmlAtcomp{H}_\delta\\
    \mmlAmmlAtcomp{x\mapsto\loc,\Delta}_\delta &\ = &\mmlAmmlAtcomp{x}_\delta\trg{\mapsto}\delta(\src{\loc})\trg{,}\mmlAmmlAtcomp{\Delta}\\[0.5cm]
    %
