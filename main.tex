...
\myfig{
  \begin{center}
    ...
    \judgbox{\mmlAmmlAtbackv[\Game;\delta]{\interfacevalue} = \src{\interfacevalue}}{,,Map an $\mmlAt$ interface value to an $\mmlAs$ interface value.''}$\;$\\
    \typerule{backtrans-value}{
    }{
      \mmlAmmlAtbackv[\Game;\delta]{n} = \src{n}
    }{backtrans-value}
    \typerule{backtrans-location}{
      \delta(\src{\loc})=\trg{\loc}
    }{
      \mmlAmmlAtbackv[\Game;\delta]{\loc} = \Game(\src{\loc})
    }{backtrans-value}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-end}{
      ...
      \mmlAmmlAtbackcomptoctx[\Game;\delta;\trg{\hole{\cdot}}]{\trg{End\ \interfacevalue}} = \trg{\hole{\cdot}};\mmlAmmlAtbackv[\Game;\delta]{\interfacevalue}
    }{backtrans-end}
    %
...
%   }{backtrans-call-comptoctx}
    ...
    \typerule{backtrans-ret-comptoctx}{
      ...
      \mmlAmmlAtbackcomptoctx[\Game;\delta;\trg{\loc,\overline{\loc}}]{\trg{Ret\ \comptoctx\ \interfacevalue}}=\trg{\overline{\loc}};\src{e}
    ...
    \typerule{backtrans-call-ctxtocomp}{
      ...
      \src{e}=\src{let\ z = new\ 42\ in\ call\ }\mmlAmmlAtbackdetail[]{foo}\ \mmlAmmlAtbackv[\Game_z;\delta']{\interfacevalue}
    }{
      \mmlAmmlAtbackctxtocomp[\Game;\delta;\trg{\overline{\loc}}]{\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}}=\Game_z;\delta';\trg{\loc,\overline{\loc}};\src{e}
...
%   }{backtrans-ret-ctxtocomp}
    ...
    \typerule{backtrans-end-ctxtocomp}{
      ...
      \mmlAmmlAtbackctxtocomp[\Game;\delta;\trg{\hole{\cdot}}]{\trg{End\ \interfacevalue}}=\Game;\delta;\trg{\hole{\cdot}};\mmlAmmlAtbackv[\Game;\delta]{\interfacevalue}
