...
\begin{lemma}[Authentic Weaken]
  If
  \begin{assumptions}
    \item $\tmstraceagree[\delta_0]{\src{\trace}}{\trace}$
    \item $\delta_{\text{tms}}_0\subseteq\delta_{\text{tms}}_1$
  \end{assumptions}
  Then
  \begin{goals}
    \item $\tmstraceagree[\delta_1]{\src{\trace}}{\trace}$
  \end{goals}
\end{lemma}
\begin{proof}
  Induction on $\tmstraceagree[\delta_0]{\src{\trace}}{\trace}$.
\end{proof}
...
\begin{lemma}[$\mmlA$ is \gls{tms} via Monitor]
  ...
  \begin{goals}
    ...
    \item $\monitorcheck{\emptyset}{\tmsmonitor}{\bar{a}}$
    \item $\storeagree{\tmsmonitor}{\src{\Omega}.\src{\Delta}}$
  \end{goals}.
\end{lemma}
\begin{incompleteproof}
