...
\myfig{
  ...
  \typerule{$te-\text{wprog}$}{
    ...
    \wexect{prog\ \library_{ctx}\ \library_{comp}}{\Omega}{\finalexpr}{\trace}
  }{wt-e-prog}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{cons-memstate-eq}{
      ...
      \delta\left(\src{x}\right)=\trg{x}&
      \src{\poison}=\trg{\poison}&
      \text{\color{red} take care of $\src{H}$ and $\trg{H}$} \\
      \xlangstateeq{\Delta_{1},\Delta_{2};H}{\Delta_{1},\Delta_{2};H}
    }{
      \xlangstateeq{\Delta_{1},x\mapsto\loc_{\poison},\Delta_{2};H}{\Delta_{1},x\mapsto\loc_{\poison},\Delta_{2};H}
    }{cons-memstate-eq}
    %
    \typerule{cons-ignore-memstate-eq}{
      \src{\loc}\in\src{L}&
      \xlangstateeq{\Delta_{1},\Delta_{2};H}{\Delta;H}
    }{
      \xlangstateeq{\Delta_{1},x\mapsto\loc_{\poison},\Delta_{2};H}{\Delta;H}
    ...
    \typerule{cfstate-eq}{
      ...
      \src{\commlib;\library}\rightharpoondown\src{\commlib'};\trg{\commlib'}&
      \xlangstateeq[]{\commlib{\color{black}\cup}\commlib';\library}{\commlib{\color{black}\cup}\commlib';\library} &
...
\myfig{
  \begin{center}
    %
    \judgbox{\xlangstateeq[]{\commlib;\library}{\commlib;\library}}{,,The relevant procedures of $\mmlAs$ agree with $\mmlAt$ ones $\trg{\commlib}$.''} \\
    %
    \typerule{empty-commlib-lib-eq}{
    }{
      \xlangstateeq[]{\hole{\cdot};\library}{\hole{\cdot};\library}
    }{compile-empty-commlib-lib-eq}
    %
    \typerule{cons-commlib-eq}{
      \mmlAmmlAtcomp{let\ foo\ x:\type_{\color{black}\lambda} := e} = \trg{let\ foo\ x := e} &
      \xlangstateeq[]{\commlib_1,\commlib_2;\library_1,\library_2}{\commlib_1,\commlib_2;\library_1,\library_2}
    }{
      \xlangstateeq[]{\commlib_1,foo,\commlib_2;\library_1,(let\ foo\ x:\type_{\color{black}\lambda} := e),\library_2}{\commlib_1,foo,\commlib_2;\library_1,(let\ foo\ x := e),\library_2}
    }{cons-commlib-eq}
    %
    %
    \judgbox{\src{\commlib;\library}\rightharpoondown\src{\commlib};\trg{\commlib}}{,,Collect all call-sites in relevant $\mmlAs$ procedures as $\mmlAs$ and $\mmlAt$ identifiers.''} \\
    %
    \typerule{empty-collect}{
    }{
      \src{\hole{\cdot};\hole{\cdot}}\rightharpoondown\src{\hole{\cdot}};\trg{\hole{\cdot}}
    }{empty-collect}
    %
    \typerule{cons-collect}{
      \src{e}\rightharpoondown\src{\commlib_1};\trg{\commlib_1} &
      \src{\commlib_1,\commlib_2;\library_1,\library_2}\rightharpoondown\src{\commlib_2};\trg{\commlib_2}
    }{
      \src{\commlib_1,foo,\commlib_2;\library_1,(let\ foo\ x:\type_{\color{black}\lambda}:=e),\library_2}\rightharpoondown\src{\commlib_1}\cup\src{\commlib_2};\trg{\commlib_1}\cup\trg{\commlib_2}
    }{cons-collect}
    %
    ...
    %
    \judgbox{\src{e}\rightharpoondown\src{\commlib}}{,,Collect all call-sites in $\src{e}$ as $\mmlAs$ and $\mmlAt$ identifiers.''} \\
    %
    \typerule{$\src{\finalexpr}$-collect}{
    }{
      \src{\finalexpr}\rightharpoondown\src{\hole{\cdot}};\trg{\hole{\cdot}}
    }{finalexpr-collect}
    %
    \typerule{$\src{\oplus}$-collect}{
      \src{e_1}\rightharpoondown\src{\commlib_1};\trg{\commlib_1} &
      \src{e_2}\rightharpoondown\src{\commlib_2};\trg{\commlib_2}
    }{
      \src{e_1\oplus e_2}\rightharpoondown\src{\commlib_1}\cup\src{\commlib_2};\trg{\commlib_1}\cup\trg{\commlib_2}
    }{binop-collect}
    %
    \typerule{$\src{x[e]}$-collect}{
      \src{e}\rightharpoondown\src{\commlib};\trg{\commlib}
    }{
      \src{x[e]}\rightharpoondown\src{\commlib};\trg{\commlib}
    }{get-collect}
    %
    \typerule{$\src{let}$-collect}{
      \src{e_1}\rightharpoondown\src{\commlib_1};\trg{\commlib_1} &
      \src{e_2}\rightharpoondown\src{\commlib_2};\trg{\commlib_2}
    }{
      \src{let\ x=e_1\ in\ e_2}\rightharpoondown\src{\commlib_1}\cup\src{\commlib_2};\trg{\commlib_1}\cup\trg{\commlib_2}
    }{let-collect}
    %
    \typerule{$\src{new}$-collect}{
      \src{e_1}\rightharpoondown\src{\commlib_1};\trg{\commlib_1} &
      \src{e_2}\rightharpoondown\src{\commlib_2};\trg{\commlib_2}
    }{
      \src{let\ x=new\ e_1\ in\ e_2}\rightharpoondown\src{\commlib_1}\cup\src{\commlib_2};\trg{\commlib_1}\cup\trg{\commlib_2}
    }{new-collect}
    %
    \typerule{$\src{x[e_{1}]\leftarrow e_{2}}$-collect}{
      \src{e_1}\rightharpoondown\src{\commlib_1};\trg{\commlib_1} &
      \src{e_2}\rightharpoondown\src{\commlib_2};\trg{\commlib_2}
    }{
      \src{x[e_1]\leftarrow e_2}\rightharpoondown\src{\commlib_1}\cup\src{\commlib_2};\trg{\commlib_1}\cup\trg{\commlib_2}
    }{set-collect}
    %
    \typerule{$\src{delete\ x}$-collect}{
    }{
      \src{delete\ x}\rightharpoondown\src{\hole{\cdot}};\trg{\hole{\cdot}}
    }{delete-collect}
    %
    \typerule{$\src{return\ e}$-collect}{
      \src{e}\rightharpoondown\src{\commlib};\trg{\commlib}
    }{
      \src{return\ e}\rightharpoondown\src{\commlib};\trg{\commlib}
    }{delete-collect}
    %
    \typerule{$\src{call}$-collect}{
      \src{e}\rightharpoondown\src{\commlib};\trg{\commlib} &
    }{
      \src{call\ foo\ e}\rightharpoondown\src{foo,\hole{\cdot}}\cup\src{\commlib};\trg{foo,\hole{\cdot}}\cup\trg{\commlib}
    }{call-collect}
    %
    \typerule{$\src{ifz}$-collect}{
      \src{e_1}\rightharpoondown\src{\commlib_1};\trg{\commlib_1} &
      \src{e_2}\rightharpoondown\src{\commlib_2};\trg{\commlib_2} &
      \src{e_3}\rightharpoondown\src{\commlib_3};\trg{\commlib_3}
    }{
      \src{ifz\ e_1\ then\ e_2\ else\ e_3}\rightharpoondown\src{\commlib_1}\cup\src{\commlib_2}\cup\src{\commlib_3};\trg{\commlib_1}\cup\trg{\commlib_2}\cup\trg{\commlib_3}
    }{binop-collect}
  \end{center}
...
\myfig{
  \begin{center}
    ...
    \typerule{cfstate-qe}{
      ...
      \src{\commlib;\library}\rightharpoondown\src{\commlib'};\trg{\commlib'}&
      \xlangstateeq[]{\commlib{\color{black}\cup}\commlib';\library}{\commlib{\color{black}\cup}\commlib';\library} &
      \xlangbackstateeq[\trg{\commlib};\src{\commlib}]{\kontstack}{\kontstack}
    }{
      \xlangbackstateeq[]{\cfstate}{\cfstate}
    }{cfstate-qe}
    %
    \judgbox{\xlangbackstateeq[\trg{\commlib};\src{\commlib}]{\kontstack}{\kontstack}}{,,The stack of $\mmlAs$ continuations $\src{\kontstack}$ agrees with $\mmlAt$ one $\trg{\kontstack}$.\\$\trg{\commlib}$ and $\src{\commlib}$ contain the names of the component procedures.''} \\
    %
    \typerule{empty-kontstack-qe}{
    }{
      \xlangbackstateeq[\trg{\commlib};\src{\commlib}]{\hole{\cdot}}{\hole{\cdot}}
    }{empty-kontstack-qe}
    %
    \typerule{cons-kontstack-qe}{
      \src{\comm}=\trg{\comm} &
      \trg{\comm}\not=\trg{\nocomm} &
      \src{foo}\in\src{\commlib}&
      \trg{foo}\in\trg{\commlib}&
      \dontcare{\trg{\commlib}}{\trg{\kontstack_{0}}}&
      \xlangbackstateeq[\trg{\commlib};\src{\commlib}]{\kontstack}{\kontstack}
    }{
      \xlangbackstateeq[\trg{\commlib};\src{\commlib}]{\kontstack_{0},K^{foo}_{\comm},\kontstack}{K^{foo}_{\comm},\kontstack}
    }{cons-kontstack-qe}
    %
    \judgbox{\dontcare{\trg{\commlib}}{\trg{\kontstack}}}{,,Ignore all continuations in $\trg{\kontstack}$ not marked by a procedure in $\trg{\commlib}$.''}
    %
    \typerule{empty-dontcare-kont}{
    }{
      \dontcare{\trg{\commlib}}{\trg{\hole{\cdot}}}
    }{empty-dontcare-kont}
    %
    \typerule{cons-dontcare-kont}{
      \trg{foo}\notin\trg{\commlib}&
      \dontcare{\trg{\commlib}}{\trg{\kontstack}}
    }{
      \dontcare{\trg{\commlib}}{\trg{K^{foo}_{\comm},\kontstack}}
    }{cons-dontcare-kont}
  \end{center}
...
\begin{lemma}[Trace Agreement with Filter]
  If
  \begin{assumptions}
...
\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtbackdetail[\Game]{\trace}=\Game',\src{e}}{,,Given a \varmapbacktransds $\Game$ construct a \varmapbacktransds $\Game'$ and\\an $\mmlAs$ expression from target-trace $\trg{\mstrace}$.''}
    %
    ...
    \typerule{backtrans-alloc}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Alloc\ \loc\ s}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-alloc}
    \typerule{backtrans-dealloc}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Dealloc\ \loc}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-dealloc}
    \typerule{backtrans-set}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Set\ \loc\ n}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-set}
    \typerule{backtrans-get}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Get\ \loc\ n}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-get}
    \typerule{backtrans-abort}{
    }{
      \mmlAmmlAtbackdetail[\Game]{\lightning}=\Game,\src{abort()}
    }{backtrans-abort}
    %
    \typerule{backtrans-call-comptoctx}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e'} &
      \src{e}=\src{call\ }\mmlAmmlAtbackdetail[\Game]{foo}\ \mmlAmmlAtbackv{\interfacevalue}\src{; e'}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Call\ \comptoctx\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-call-comptoctx}
    %
    \typerule{backtrans-ret-comptoctx}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e'} &
      \src{e}=\src{return\ }\mmlAmmlAtbackv[\Game]{\interfacevalue}\src{;e'}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Ret\ \comptoctx\ \interfacevalue}\cdot\trg{\trace}}=\Game',\src{e}
    ...
    \typerule{backtrans-call-ctxtocomp}{
      ...
      \Game_z=\Game[\trg{\loc}] &
      \src{z}=\Game_z(\trg{\loc}) &
      \src{e'}=\mmlAmmlAtbackdetail[\Game_z]{\trace} \\
      \src{e}=\src{let\ z = new\ 42\ in\ call\ }\mmlAmmlAtbackdetail[\Game_z]{foo}\ \mmlAmmlAtbackv[\Game_z]{\interfacevalue}\src{;delete\ z;e'}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}\cdot\trg{\trace}}=\Game',\src{e}
    }{backtrans-call-ctxtocomp}
    \typerule{backtrans-ret-ctxtocomp}{
      \mmlAmmlAtbackdetail[\Game]{\trg{\trace}}=\Game',\src{e} &
      \src{e}=\src{return\ }\mmlAmmlAtbackv{\interfacevalue}\src{; e'}
    }{
      \mmlAmmlAtbackdetail[\Game]{\trg{Ret\ \ctxtocomp\ \interfacevalue}\cdot\trg{\trace}}=\Game',\src{e}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \vdash \trg{\trace[_0^{ctx}]} \operatorname{non-int-\trg{\trace}} \\
      \trg{\trace[_1]}=\trg{Ret\ \comptoctx\ \interfacevalue_1 \cdot \trace[_1^{ctx}] \cdot Ret\ \ctxtocomp\ n} &
      \vdash \trg{\trace[_1^{ctx}]} \operatorname{non-int-\trg{\trace}} \\
      \mmlAmmlAtbackdetail[\Game]{\trace[_0]\cdot\trace[_1]} = \Game', \src{e}
    }{
...
\begin{lemma}[$\thexlangstateeq$ of $\thexlangbackstateeq$ with $\trg{Call\ \ctxtocomp}$]\label{lem:relations:call:approxoflolly}
  If
  \begin{assumptions}
    \item $\execs[]{\Omega}{e}{\Omega'}{e'}{Call\ \ctxtocomp\ foo\ \interfacevalue}$
    \item $\xlangbackstateeq{\Omega}{\Omega}$
    \item $\exec[]{\trg{\Omega}}{\trg{e}}{\trg{\Omega'}}{\trg{e'}}{\trg{Call\ \ctxtocomp\ }\mmlAmmlAtcomp{foo}\ \trg{\interfacevalue}}$
  \end{assumptions}
  Then
  \begin{goals}
    \item $\xlangstateeq{\Omega'}{\Omega'}$
...
\begin{lemma}[$\thexlangbackstateeq$ of $\thexlangstateeq$ with $\trg{Ret\ \comptoctx}$]\label{lem:relations:ret:lollyofapprox}
  If
  \begin{assumptions}
    \item $\execs[]{\Omega}{e}{\Omega'}{e'}{Call\ \ctxtocomp\ foo\ \interfacevalue}$
    \item $\xlangstateeq{\Omega'}{\Omega'}$
...
\begin{lemma}[Final Expression Insertion]\label{lem:compvals:insertion}\ \\
  Given $\src{\finalexprnoerr}=\mmlAmmlAtbackv{\finalexprnoerr}$, then $\mmlAmmlAtcomp{\finalexprnoerr}=\trg{\finalexprnoerr}$.
\end{lemma}
\begin{proof}
  Immediate.
\end{proof}
...
\begin{lemma}[Backtranslation is Well-Typed]\label{lem:backtranslation:welltyped}
  ...
  Then
  \begin{goals}
  \item $\typecheck{}{\mmlAmmlAtbackdetail{\trace}}{\src{\nat}}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
...
\begin{lemma}[$\mmlAt$ call decomposition]\label{lem:trg:calldecompose}
  If
  \begin{assumptions}
    \item $\exect{\commlib;\library;\kontstack;\memstate}{K[e]}{\Omega'}{\finalexpr}{Call\ \comm\ foo\ \interfacevalue\cdot\trace}$
  \end{assumptions}
  Then $\exists \trg{\trace[_{1}]}\ \trg{\trace[_{2}]}\ n$,
  \begin{goals}
...
\end{lemma}
\begin{incompleteproof}
  .\MK{$\ogreaterthan$ is supposed to say ,,all state outside of the other thing stays untouched''. we may as well just have a stack of memory states? NO, this will lose information about dealloc'd pointers. BUT! we can make a dict}
\end{incompleteproof}

\begin{lemma}[Expression-based Backtranslation Correctness]\label{lem:exprbacktranslation:wrapper:correct}
  If
  \begin{assumptions}
  ...
  \begin{goals}
  \item $\delta\subseteq\delta'$
  \item $\exec{\configs}{\src{e}}{\src{\configs'}}{\mmlAmmlAtbackv[\Game']{\finalexprnoerr}}{\src{\trace}}$
  \item $\xlangbackstateeq[\delta']{\Omega'}{\Omega'}$
  \item $\src{\trace}\thexlangtraceeq[\delta']\trg{\trace}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
  Induction on $\trg{\trace}$.\MK{update the proof}
  ...
  \item\label[ass]{asm:backtranscorr:case0:thebacktrans} $\mmlAmmlAtback[\Game]{\hole{\cdot}}=\Game,\src{e_{H}}$
  ...
  \begin{goals}
  \item $\delta\subseteq\delta'$
  \item $\exec{\configs}{\src{42}}{\src{\configs'}}{\src{\finalexprnoerr}}{\src{\trace}}$
  \item $\xlangbackstateeq[\delta']{\Omega'}{\Omega'}$
  \item $\src{\trace}\thexlangtraceeq[\delta']\trg{\hole{\cdot}}$
  \end{goals}

  Instantiate our goal with $\delta' = \delta, \src{\Omega'}=\src{\Omega}, \src{\trace}=\src{\hole{\cdot}}, \src{\finalexprnoerr}=\src{42}$, the first two goals and the fourth follow immediately by reflexivity, the third goal follows by \Cref{asm:backtranscorr:case0:stateeq} after inverting \Cref{asm:backtranscorr:case0:exect}.\MK{lemma: step with no events doesn't change $\trg{\Omega}$}
  ...
  \begin{description}
    ...
    \item\label[ass]{asm:backtranscorr:call:origexect} $\exect{\Omega}{e}{\Omega'}{\finalexprnoerr}{Call\ \ctxtocomp\ foo\ \interfacevalue\cdot\trace}$
      ...
      \end{passumptions}
      Since $\mmlAmmlAtback{foo}=\src{foo}\in\src{\commlib}$, we know that $(\src{let\ foo\ x:\type_{{\color{black}}\lambda}:=e})\in\src{\library_{comp}}$ and, thus, also $\mmlAmmlAtcomp{let\ foo\ x:\type_{{\color{black}}\lambda}:=e}\in\mmlAmmlAtcomp{\library_{comp}}$, the function known in the target as $\trg{foo}$.
...
\begin{lemma}[Backtranslation Correctness]\label{lem:backtranslation:correct}
  ...
  \begin{assumptions}
  \item $\exect{\Omega}{e}{\Omega'}{\finalexprnoerr}{\trace}$
  \item $\mmlAmmlAtback[\Game]{\trace}=\Game',\src{e}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  \end{assumptions}
  then $\exists \delta'\ \src{\Omega'}\ \src{\trace}$,
  \begin{goals}
...
\begin{incompleteproof}
  ...
  Thus, $\trg{foo}\in\mmlAmmlAtcomp{\library_{comp}}$, $\src{foo}\in\src{\library_{comp}}$, and $\trg{main}\in\trg{\library_{ctx}}$.
  ...
  By backtranslation pr

  $\xlangbackstateeq[\emptyset]{\emptyset}{\emptyset}$ by \Cref{tr:back-compile-empty-heap-or-map-eq}.
