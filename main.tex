...
\begin{lemma}[Expression-based Backtranslation Correctness]\label{lem:exprbacktranslation:wrapper:correct}
  ...
  \item $\exect{\Omega}{e}{\Omega'}{e'}{\trace\cdot\event[_{end}]}$
  \item $\mmlAmmlAtbackdetail[\Game]{\trace\cdot\event[_{end}]}=\Game',\src{e}$
  \item $\trg{\event[_{end}]}=\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}\vee\trg{\event[_{end}]}=\trg{Ret\ \ctxtocomp\ \interfacevalue}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  ...
  \item $\exec{\src{\Omega'}}{\src{e}}{\src{\commlib;\library;\kontstack;\memstate'}}{\mmlAmmlAtbackv[\Game']{\finalexprnoerr}}{\src{\trace}}$
  \item $\xlangbackstateeq[\delta';\src{L}]{\Omega'}{\Omega'}$
