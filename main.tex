...
\myfig{
  \begin{center}
    ...
    \typerule{Cons-Agree}{
      ...
      \storeagreetms{\left\{\loc\right\}\cup \tmsmonitor}{\src{x\mapsto\loc^\poisonless,\Delta}}
    }{store-cons-agree}
    %
    \typerule{Ignore-Agree}{
      ...
      \storeagreetms{\tmsmonitor}{\src{x\mapsto\loc^\poisoned,\Delta}}
    }{store-ignore-agree}
  \end{center}
...
\begin{lemma}[Base \gls{tms} via Monitor]
  ...
  \begin{goals}
    ...
    \item $\monitorcheck[]{\tmsmonitor}{\tmsmonitor[']}{a}$
    \item $\storeagreetms[\delta_{\text{tms}}']{\tmsmonitor[']}{\src{\Omega'}.\src{\Delta}}$
  \end{goals}.
\end{lemma}
\begin{incompleteproof}
...
\item[$\src{e}=\src{free\ x}$:]
  ...
  \begin{assumptions}
    ...
    \item\label[ass]{asm:basetmsmonitor:storeagree} $\storeagreetms{\tmsmonitor}{\src{\Delta_1,x\mapsto\loc^\poison,\Delta_2}}$
  \end{assumptions}
  Then $\exists a\ \delta_{\text{tms}}'\ \tmsmonitor['],$
  \begin{goals}
    ...
    \item $\monitorcheck[]{\tmsmonitor}{\tmsmonitor[']}{a}$
    \item $\storeagreetms[\delta']{\tmsmonitor[']}{\src{\Delta_1,x\mapsto\loc^\poisoned,\Delta_2}}$
  \end{goals}.
...
\item[\Cref{tr:store-cons-agree}:]
  ...
  \item\label[goal]{goal:basetmsmonitor:storeagree1} $\storeagreetms[\delta']{\tmsmonitor[']}{\src{\Delta_1,x\mapsto\loc^\poisoned,\Delta_2}}$
  \end{goals}.
  ...
  \Cref{goal:basetmsmonitor:storeagree1}, $\storeagreetms[\delta']{\tmsmonitor[']}{\src{\Delta_1,x\mapsto\loc^\poisoned,\Delta_2}}$, follows immediately by \Cref{tr:store-ignore-agree}.
...
\item[\Cref{tr:store-ignore-agree}:]
  ...
  \item\label[goal]{goal:basetmsmonitor:storeagree2} $\storeagreetms[\delta']{\tmsmonitor[']}{\src{\Delta_1,x\mapsto\loc^\poisoned,\Delta_2}}$
  \end{goals}.
...
\begin{proof}
  ...
  \begin{equation}
    \storeagreetms{\emptyset}{\src{\emptyset}}\label{asm:mmlatmsviamonitor:agree}
  \end{equation}
