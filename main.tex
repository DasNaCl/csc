...
\begin{proof}
  ...
  \begin{passumptions}{H}
    ...
    \item\label[ass]{asm:mmlatmsviamonitor:execp} $\execs{\configs_{0}^{\diamond}}{e_{po}}{\configs_{po}}{e_{0}''}{\trace[_{p}]\cdot Ret\ !\finalexprnoerr_{p}}$
...
However, it does contain simple, non-nested pairs and dynamic type checks.\todo{describe diamond}
...
\myfig{
  \begin{center}
    ...
    $$
    \begin{array}{rcl}
      \mmlAmmlAtcomp{component\ e_p} = \trg{component\ ifz\ x\ has\ \nat\ then\ }\mmlAmmlAtcomp{e_p}\trg{\ else\ abort()}
    \end{array}
    $$
  \end{center}
