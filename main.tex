...
\myfig{
  \begin{center}
    ...
    \hrule
    %
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc}}]{\event\comptoctx}=\Game',\trg{\overline{\loc'}},\src{e}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc}}$, construct a \varmapbacktransds $\Game'$,\\another stack of locations $\trg{\overline{\loc'}}$, and an $\mmlAs$\\backtranslation contexts from target-trace $\trg{\mstrace}$.''}
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc}}]{\event\ctxtocomp}=\Game',\trg{\overline{\loc'}},\src{e}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc}}$, construct a \varmapbacktransds $\Game'$,\\another stack of locations $\trg{\overline{\loc'}}$, and an $\mmlAs$\\backtranslation contexts from target-trace $\trg{\mstrace}$.''}
    %
    \typerule{backtrans-call-comptoctx}{
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Call\ \comptoctx\ foo\ \interfacevalue}}=\Game,\trg{\overline{\loc}},\src{42}
    ...
    \typerule{backtrans-ret-comptoctx}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\loc,\overline{\loc}}]{\trg{Ret\ \comptoctx\ \interfacevalue}}=\Game,\trg{\overline{\loc}},\src{e}
    ...
    \typerule{backtrans-call-ctxtocomp}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Call\ \ctxtocomp\ foo\ \interfacevalue}}=\Game_z,\trg{\loc,\overline{\loc}},\src{e}
    }{backtrans-call-ctxtocomp}
    \typerule{backtrans-ret-ctxtocomp}{
      \fresh{\Game}{\src{x}}
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{Ret\ \ctxtocomp\ \interfacevalue}}=\Game,\trg{\overline{\loc}},\src{let\ x = new\ 1\ in\ delete\ x;return\ }\mmlAmmlAtbackv{\interfacevalue}
    }{backtrans-ret-ctxtocomp}
    %
    \hrule
    %
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc}}]{\event\comptoctx\cdot\trace\cdot\event\ctxtocomp}=\Game',\trg{\overline{\loc'}},\src{e_1},\src{e_2}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc}}$, construct a \varmapbacktransds $\Game'$,\\another stack of locations $\trg{\overline{\loc'}}$, and an $\mmlAs$\\backtranslation contexts from target-trace $\trg{\mstrace}$.''}
    %
    \typerule{subtoplevel-backtrans}{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\event[_1\comptoctx]}}=\Game',\trg{\overline{\loc'}},\src{e_1} \\
      \mmlAmmlAtbackdetail[\Game',\trg{\overline{\loc'}}]{\trg{\trace}}=\Game'',\trg{\overline{\loc''}}, \src{e_2}\\
      \mmlAmmlAtbackdetail[\Game'',\trg{\overline{\loc''}}]{\trg{\event[_2\ctxtocomp]}}=\Game''',\trg{\overline{\loc'''}},\src{e_3} \\
    }{
      \mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{\trg{\event[_1\comptoctx]\cdot\trace\cdot\event[_2\ctxtocomp]}}=\Game''',\trg{\overline{\loc'''}}, \src{e_1}, \src{e_2},\src{e_3}
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\hole{\cdot}}]{\trace[_0]} = \Game', \trg{\overline{\loc}}, \src{e_0},\src{e_0'},\src{let\ x_0 = new\ n_0\ in\ e_0''} \\
      \mmlAmmlAtbackdetail[\Game',\trg{\overline{\loc}}]{\trace[_1]} = \Game'', \trg{\hole{\cdot}}, \src{e_1},\src{e_1'},\src{e_1''} \\
...
\begin{lemma}[Very Beginning of Backtranslation Correctness]\label{lem:exprbacktranslation:vbeg:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{Call\ \comptoctx\ main\ 0}=\Game,\trg{\overline{\loc}},\src{42}$
  \item $\xlangstateeq{\Omega}{\Omega}$
  ...
  \item $\exec{\src{\Omega}}{\src{call\ main\ 0}}{\src{\commlib;\library;\hole{\cdot}^{main}_{\ctxtocomp},\hole{\cdot};\memstate}}{\src{e_{main}}}{\src{\trace}}$\MK{use step index (technicality)}
...
\begin{lemma}[Beginning of Backtranslation Correctness]\label{lem:exprbacktranslation:beg:wrapper:correct}
  ...
  \item $\trg{\library}=\trg{\library_{ctx}\linker}\mmlAmmlAtcomp{\library_{comp}}$
  \item $\trg{\commlib}=\mmlAmmlAtcomp{\commlib}=\operatorname{dom}\ \mmlAmmlAtcomp{\library_{comp}}$
  \item $\exect[]{\Omega}{K_{component}[return\ \interfacevalue]}{\Omega'}{K[\interfacevalue]}{Ret\ \comptoctx\ \interfacevalue}$
  ...
  \item $\src{K^{foo}_{\comptoctx}}=\src{\hole{\cdot};delete\ z;e_{any}}$
...
%  \item $\src{\library}=\left\{\src{main}\mapsto\src{e_{main}}\right\}\src{\linker\library_{comp}}$
  \end{assumptions}
  then $\exists \delta'\ \src{\memstate'}\ \src{\trace}$,
  \begin{goals}
  \item $\delta\subseteq\delta'$
...
%  \item $\src{\library}=\left\{\src{main}\mapsto\src{e_{main}}\right\}\src{\linker\library_{comp}}$
  ...
  \item $\src{L}\subseteq\src{L'}$
  \item $\src{X}\subseteq\src{X'}$
  \item $\exec{\src{\Omega}}{\src{K[let\ x = new\ 42\ in\ call\ foo\ }\mmlAmmlAtbackv{\interfacevalue}\src{]}}{\src{\commlib;\library;K^{foo}_{\comptoctx},\kontstack;\memstate}}{\src{e_{foo}}}{\src{\trace}}$
...
\begin{lemma}[Very End of Backtranslation Correctness]\label{lem:exprbacktranslation:vend:wrapper:correct}
  ...
  \item $\mmlAmmlAtbackdetail[\Game,\trg{\overline{\loc}}]{Ret\ \ctxtocomp\ n}=\Game,\trg{\overline{\loc}},\src{e}$ %$let\ x = new\ 1\ in\ delete\ x;return\ }\mmlAmmlAtbackv{n}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  ...
  \item $\xlangstateeq[\delta';\src{L'}]{\src{\commlib;\library;\hole{\cdot};\memstate}}{\commlib;\library;\hole{\cdot};\memstate}$
  \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{Ret\ \ctxtocomp\ n}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
