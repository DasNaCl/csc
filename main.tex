...
\myfig{
  ...
  \typerule{$e-\src{new}-ctx$}{
    ...
    \src{\memstate} = \src{H^{\ctx'};H^{\comp};z\mapsto \loc^{\ctx}_\poisonless,\Delta}
  }{
...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{wprog}-\lightning$}{
      \vdash\src{prog\ \library_{ctx}\ \library_{comp}}\dashv \src{\commlib},\src{\library} &
      \src{main}\notin\src{\commlib}\\
      \execs{\commlib;\library;\hole{\cdot};\hole{\cdot};\hole{\cdot}}{call\ main\ 0}{\Omega}{\finalexpr}{\trace\cdot\lightning;\sandboxtag}
    }{
...
\myfig{
  ...
  \end{center}
}{aw-events-project-to-specific}{Projection of $\mmlAs$ events to \gls*{ms}-specific events.}
