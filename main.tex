...
\begin{definition}[Cross-Language Trace Agreement]
  ...
  $$
  \exists \overline{a}, \tmstraceagree{\overline{a}}{\src{\overline{a}}}
                  \wedge\tmstraceagree{\overline{a}}{\trg{\overline{a}}}
  $$
\end{definition}
...
\begin{definition}[Cross-Language Store Agreement]
  ...
  $$
  \exists \tmsmonitor, \storeagreetms{\tmsmonitor}{\src{\Omega}.\src{\Delta}}
                 \wedge\storeagreetms{\tmsmonitor}{\trg{\Omega}.\trg{\Delta}}
  $$
...
\begin{theorem}[Robust \gls{tms} Preservation]
  If
  \begin{assumptions}
  \item $\forall \src{e_1}\ \src{e_2}\ \src{\overline{a}}\ \src{\Omega}\ \src{v},\wexecs{prog\ e_1\ e_p\ e_2}{\configs}{v}{\overline{a}}\rightarrow\texttt{TMS}(\src{\bar{a}})$
  \item $\wexec{\trg{prog\ e_1}\ \mmlAmmlAtcomp{e_p}\ \trg{e_2}}{\trg{\configt}}{\trg{v}}{\trg{\overline{a}}}$
  \end{assumptions}
  then
  \begin{goals}
