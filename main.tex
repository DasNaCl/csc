...
\begin{lemma}[Injective Compiler]\label{lem:smscomp:inject}
  If
  \begin{assumptions}
    \item $\mmlAtmmlAtmscomp{e}=\irl{e_0}$
    \item $\mmlAtmmlAtmscomp{e}=\irl{e_1}$
  \end{assumptions}
  Then
  \begin{goals}
...
\begin{lemma}[Backtranslation Correctness]\label{lem:backtransms}
  If
  \begin{assumptions}
...
\begin{comment}
\begin{lemma}[Prim-Step Backward Simulation]\label{lem:backwardsim:primstep}
  If
  \begin{assumptions}
    \item $\exec{\mmlAtmmlAtmscomp{\commlib}\irl{;\library_{ctx}\linker}\mmlAtmmlAtmscomp{\library_{comp}}\irl{;\kontstack;\sandboxtag;H^{\ctx};H^{\comp};\Delta}}{\irl{e}}{\mmlAtmmlAtmscomp{\commlib}\irl{;\library_{ctx}\linker}\mmlAtmmlAtmscomp{\library_{comp}}\irl{;\kontstack;\sandboxtag';H^{\ctx'};H^{\comp'};\Delta'}}{\irl{e'}}{\irl{\event;\sandboxtag}}$
    \item\label[ass]{asm:backwardsim:primstep} $\vdash\irl{\event;\sandboxtag}\operatorname{non-int-\irl{\event}}$
    \item $\irl{\event;\sandboxtag} = \trg{\event;\sandboxtag}$
    \item $\irl{e}=\trg{e}$
  \end{assumptions}
  Then $\exists \trg{e'}$
  \begin{goals}
    \item $\exec{\trg{\commlib;\library_{ctx}\linker\library_{comp};\kontstack;\sandboxtag;H^{\ctx};H^{\comp};\Delta}}{\trg{e}}{\trg{\commlib;\library_{ctx}\linker;\library_{comp};\kontstack;\sandboxtag';H^{\ctx'};H^{\comp'};\Delta'}}{\trg{e'}}{\trg{\event;\sandboxtag}}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
  Induction on \Cref{asm:backwardsim:primstep}.
  \begin{description}
    \item $\irl{\event}=\irl{Alloc\ \loc\ n;\sandboxtag}$\textbf{:}
    \item $\irl{\event}=\irl{Dealloc\ \loc;\sandboxtag}$\textbf{:}
    \item $\irl{\event}=\irl{Get\ \loc\ n;\sandboxtag}$\textbf{:}
    \item $\irl{\event}=\irl{Set\ \loc\ n;\sandboxtag}$\textbf{:}
    \item $\irl{\event}=\irl{\lightning;\sandboxtag}$\textbf{:}
          Here, $\irl{e}$ can be decomposed, such that $\irl{e}=\irl{K[abort()]}$.
  \end{description}
\end{incompleteproof}


\begin{lemma}[Ctx-Step Backward Simulation]\label{lem:backwardsim:ctxstep}
  If
  \begin{assumptions}
    \item $\exec{\mmlAtmmlAtmscomp{\commlib}\irl{;\library_{ctx}\linker}\mmlAtmmlAtmscomp{\library_{comp}}\irl{;\kontstack;\sandboxtag;H^{\ctx};H^{\comp};\Delta}}{\irl{e}}{\mmlAtmmlAtmscomp{\commlib}\irl{;\library_{ctx}\linker}\mmlAtmmlAtmscomp{\library_{comp}}\irl{;\kontstack;\sandboxtag';H^{\ctx'};H^{\comp'};\Delta'}}{\irl{e'}}{\irl{\event;\sandboxtag}}$
    \item $\irl{\event;\sandboxtag} = \trg{\event;\sandboxtag}$
...
\begin{lemma}[Star-Step Backward Simulation]\label{lem:backwardsim:starstep}
  If
  \begin{assumptions}
    \item $\exec{\mmlAtmmlAtmscomp{\commlib}\irl{;\library_{ctx}\linker}\mmlAtmmlAtmscomp{\library_{comp}}\irl{;\kontstack;\sandboxtag;H^{\ctx};H^{\comp};\Delta}}{\irl{e}}{\mmlAtmmlAtmscomp{\commlib}\irl{;\library_{ctx}\linker}\mmlAtmmlAtmscomp{\library_{comp}}\irl{;\kontstack;\sandboxtag';H^{\ctx'};H^{\comp'};\Delta'}}{\irl{e'}}{\irl{\trace}}$
  \end{assumptions}
  Then
  \begin{goals}
    \item $\exec{\trg{\commlib;\library_{ctx}\linker\library_{comp};\kontstack;\sandboxtag;H^{\ctx};H^{\comp};\Delta}}{\trg{e}}{\trg{\commlib;\library_{ctx}\linker;\library_{comp};\kontstack;\sandboxtag';H^{\ctx'};H^{\comp'};\Delta'}}{\trg{e'}}{\trg{\trace}}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[Top-Level Backward Simulation]\label{lem:backwardsim:toplevel}
  If
  \begin{assumptions}
