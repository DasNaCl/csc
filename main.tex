...
\myfig{
  \begin{center}
    \judgbox{\mmlAmmlAtbackdetail[\Game, \trg{\overline{\loc}}]{\trace}=\Game',\trg{\overline{\loc'}},\src{e}}{,,Given a \varmapbacktransds $\Game$ and $\trg{\overline{\loc}}$ construct a \varmapbacktransds $\Game'$, another \\stack of locations $\trg{\overline{\loc'}}$, and an $\mmlAs$ expression from target-trace $\trg{\mstrace}$.''}
    %
    ...
    \typerule{backtrans-call-ctxtocomp}{
      \fresh{\Game}{\trg{\loc}}&
      \Game_z=\Game[\trg{\loc}] &
      \mmlAmmlAtbackdetail[\Game_z,\trg{\loc,\overline{\loc}}]{\trace}=\Game',\trg{\overline{\loc'}},\src{e'} \\
      \src{e}=\src{let\ z = new\ 42\ in\ call\ }\mmlAmmlAtbackdetail[\Game_z]{foo}\ \mmlAmmlAtbackv[\Game_z]{\interfacevalue}\src{; e'}
    }{
...
\myfig{
  \begin{center}
    ...
    \typerule{backtrans-top-level}{
      ...
      \mmlAmmlAtbackdetail[\Game,\trg{\hole{\cdot}}]{\trace[_0]} = \Game', \trg{\overline{\loc}}, \src{e_0} &
      \mmlAmmlAtbackdetail[\Game',\trg{\overline{\loc}}]{\trace[_1]} = \Game'', \trg{\hole{\cdot}}, \src{e_1} &
    }{
      \mmlAmmlAtback[\Game]{\trace} = \Game', \src{let\ main\ x : \nat\to\nat := e_0;e_1,\hole{\cdot}}
    }{backtrans-top-level}
  \end{center}
...
\begin{lemma}[Begin of Backtranslation Correctness]\label{lem:exprbacktranslation:beg:wrapper:correct}
  If
  \begin{assumptions}
  ...
  \item $\exect{\Omega}{e}{\Omega'}{e'}{\event[_{begin}]}$
  \item $\mmlAmmlAtbackdetail[\Game]{\event[_{begin}]}=\Game',\src{e}$
  \item $\trg{\event[_{begin}]}=\trg{Call\ \comptoctx\ main\ 0} \vee \trg{\event[_{begin}]}=\trg{Ret\ \comptoctx\ \interfacevalue_{p}}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  ...
  \item $\src{\trace}\thexlangtraceeq[\delta';\src{X'}]\trg{\event[_{begin}]}$
  \end{goals}
\end{lemma}
\begin{incompleteproof}
\end{incompleteproof}
...
\begin{lemma}[End of Backtranslation Correctness]\label{lem:exprbacktranslation:end:wrapper:correct}
  ...
  \item $\trg{\library}=\trg{\library_{ctx}\linker}\mmlAmmlAtcomp{\library_{comp}}$
  \item $\trg{\commlib}=\mmlAmmlAtcomp{\commlib}=\operatorname{dom}\ \mmlAmmlAtcomp{\library_{comp}}$
  \item $\exect{\Omega}{e}{\Omega'}{e'}{\event[_{end}]}$
  \item $\mmlAmmlAtbackdetail[\Game]{\event[_{end}]}=\Game',\src{e}$
  \item $\trg{\event[_{end}]}=\trg{Call\ \ctxtocomp\ foo\ \interfacevalue} \vee \trg{\event[_{end}]}=\trg{Ret\ \comptoctx\ \interfacevalue_{c}}$
  \item $\xlangbackstateeq{\Omega}{\Omega}$
  \item $\src{\Omega}=\src{\commlib;\library;\kontstack;\memstate}$
  \item $\src{\library}=\left\{\src{main}\mapsto\src{e}\right\}\src{\linker\library_{comp}}$
  \end{assumptions}
