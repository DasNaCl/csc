...
\myfig{
  \begin{center}
    ...
    \begin{array}{rll}
      ...
      \mmlAmmlAtcomp{if\ K<e'\ then\ e_{1}\ else\ e_{2}} &\ = & \trg{if\ }\mmlAmmlAtcomp{K}\trg{<}\mmlAmmlAtcomp{e'}\trg{\ then\ }\\
                                                                &&\mmlAmmlAtcomp{e_{1}}\trg{\ else\ }\mmlAmmlAtcomp{e_{2}} \\
      \mmlAmmlAtcomp{if\ n<K\ then\ e_{1}\ else\ e_{2}} &\ = & \trg{if\ }\mmlAmmlAtcomp{n}\trg{<}\mmlAmmlAtcomp{K}\trg{\ then\ }\\
                                                            &&\mmlAmmlAtcomp{e_{1}}\trg{\ else\ }\mmlAmmlAtcomp{e_{2}} \\
    \end{array}
    $$
  \end{center}
...
\begin{incompleteproof}
  ...
  We augment \Cref{asm:ctxstep:fowrardsim:typechecks} using \thmref{lem:ctxtyping:plugged}.
  \begin{passumptions}{H}
    \setcounter{enumi}{2}
