...
\myfig{
  ...
  \mi{Base\ Events}~\src{\event_{b}} \bnfdef&\ \src{Alloc\ \loc\ n} \mid \src{Dealloc\ \loc} \mid \src{Get\ \loc\ n} \mid \src{Set\ \loc\ n\ v} \mid \src{\lightning} \\
...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{ctx}-\src{call}-\text{notsame}$}{
      ...
      \execs[]{\Omega}{K[call\ foo\ \finalexprnoerr]}{\Omega'}{e[x/\valueexpr]}{Call\ \comm\ foo\ \finalexprnoerr;\sandboxtag}
...
\myfig{
  ...
  \mi{Base~Events}~\trg{\event_{b}} \bnfdef&\ \trg{Alloc\ \loc\ n} \mid \trg{Dealloc\ \loc} \mid \trg{Get\ \loc\ n} \mid \trg{Set\ \loc\ n} \mid \trg{\lightning}\\
...
\myfig{
  \begin{center}
    ...
    \typerule{$e-\text{ctx}-\trg{call}-\text{notsame}$}{
      ...
      \exect[]{\Omega}{K[call\ foo\ \finalexprnoerr]}{\Omega'}{e[x/\valueexpr]}{Call\ \comm\ foo\ \finalexprnoerr;\sandboxtag}
    ...
    \typerule{$e-\text{ctx}-\trg{call}-\text{same}$}{
      ...
      \exect[]{\Omega}{K[call\ foo\ \finalexprnoerr]}{\Omega'}{e[x/\valueexpr]}{Call\ \nocomm\ foo\ \finalexprnoerr;\sandboxtag}
    }{tw-e-ectx-call-same}
    %
    ...
    \typerule{$e-\text{ctx}-\trg{return}-\text{notsame}$}{
      ...
      \exec[]{\trg{\commlib;\library;K^{foo},\kontstack;\sandboxtag;\memstate}}{\trg{K'[return\ \finalexprnoerr]}}{\trg{\commlib;\library;\kontstack;\neg\sandboxtag;\memstate}}{\trg{K[\finalexprnoerr]}}{\trg{Ret\ \comm\ \finalexprnoerr;\sandboxtag}}
    }{tw-e-ectx-ret-notsame}
    %
    \typerule{$e-\text{ctx}-\trg{return}-\text{same}$}{
      \trg{foo}\in_{\trg{\sandboxtag}}\trg{\commlib}
    }{
      \exec[]{\trg{\commlib;\library;K^{foo},\kontstack;\sandboxtag;\memstate}}{\trg{K'[return\ \finalexprnoerr]}}{\trg{\commlib;\library;\kontstack;\sandboxtag;\memstate}}{\trg{K[\finalexprnoerr]}}{\trg{Ret\ \nocomm\ \finalexprnoerr;\sandboxtag}}
    }{tw-e-ectx-ret-same}
    %
...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case }$\exprevals{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n),\Delta_2}{delete\ x}{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poisoned;n),\Delta_2}{0}{Dealloc\ \loc}$\textbf{:}
      ...
      Instantiate the goal with $\delta'=\delta,\ \trg{\Omega'}=\trg{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poisoned;n),\Delta_2}$, and $\trg{\event}=\trg{Dealloc\ \loc}$, so that what is left to prove is:
      \begin{goals}
    ...
    \item \textbf{Case }$\exprevals{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}{x[n]}{\cfstate;\sandboxtag';H^{\ctx};H^{\comp}\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}{v}{Get\ \loc\ n}$\textbf{:}
      ...
      Instantiate the goal with $\delta'=\delta,\ \trg{\Omega'}=\trg{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}$, and $\trg{\event}=\trg{Get\ \loc\ n}$, so that what is left to prove is:
      \begin{goals}
      ...
      \item\label[goal]{goal:step:forwardsim:case3:stateeq} $\xlangstateeq{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}$
        \setcounter{enumi}{1}
      \item\label[goal]{goal:step:forwardsim:case3:eval} $\expreval{\trg{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}}{\trg{x[n]}}{\trg{\cfstate;\sandboxtag;H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}}{\trg{v}}{\trg{Get\ \loc\ n}}$
      \end{goals}
      ...
      \begin{description}
        \item \textbf{Case }$\src{\loc}\in\operatorname{dom}\src{H}$\textbf{:}

          \Cref{asm:step:forwardsim:case3:dom1} gives $\src{v}=\src{H}(\src{\loc+n})$.
          Since $\trg{v}=\mmlAmmlAtcomp{v}$, $\trg{v}=\mmlAmmlAtcomp{H(\loc+n)}$.
          Using \Cref{asm:step:forwardsim:case3:stateeq}, $\trg{v}=\trg{H(\loc+n)}$, done.

        \item \textbf{Case }$\src{\loc}\not\in\operatorname{dom}\src{H}$\textbf{:}

          \Cref{asm:step:forwardsim:case3:dom2} gives $\src{v}=\src{1729}$.
          Since $\trg{v}=\mmlAmmlAtcomp{v}$, $\trg{v}=\mmlAmmlAtcomp{1729}=\trg{1729}$, done.
      \end{description}

    \item \textbf{Case $\exprevals{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{x[n]\leftarrow v}{\cfstate;H;\Delta_1,x\mapsto\loc_\poison,\Delta_2}{v}{Set\ \loc\ n\ m}$:}
