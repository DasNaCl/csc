...
\myfig{
  ...
  %
  \typerule{$e-\src{let}-\src{\valueexpr}$}{
  }{
    \exprevals{\Omega}{let\ x=\valueexpr\ in\ e}{\Omega}{e[\valueexpr/x]}{\emptyevent}
  }{w-e-let-v}
  %
...
\begin{lemma}[Determinism of Step]\label{lem:determ:step}
  If
  \begin{assumptions}
  \item\label[ass]{asm:determ:step:a} $\exprevalt{\Omega}{e\gamma}{\Omega'}{v_1}{\event_{1}}$
  \item $\exprevalt{\Omega}{e\gamma}{\Omega''}{v_2}{\event_{2}}$
  \end{assumptions}
  Then
  \begin{goals}
...
\begin{lemma}[Determinism of Ctx-Step]\label{lem:determ:ctxstep}
  If
  \begin{assumptions}
  \item\label[ass]{asm:determ:ctxstep:a} $\exect[]{\Omega}{e\gamma}{\Omega'}{v_1}{\event_{2}}$
  \item $\exect[]{\Omega}{e\gamma}{\Omega''}{v_2}{\event_{1}}$
  \end{assumptions}
  Then
  \begin{goals}
  \item $\trg{v_{1}}=\trg{v_{2}}$
...
\begin{lemma}[Step Forward Simulation]\label{lem:step:forwardsim}
  If
  \begin{assumptions}
    \item\label[ass]{asm:step:forwardsim:srcstep} $\exprevals{\Omega}{e}{\Omega'}{e'\gamma}{\event}$
  ...
  \begin{goals}
    \item $\delta\subseteq\delta'$
    \item $\expreval{\trg{\Omega}}{\mmlAmmlAtcomp{e}}{\trg{\Omega'}}{\mmlAmmlAtcomp{e'}\mmlAmmlAtcomp{\gamma}}{\trg{\event}}$
...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case }$\exprevals{\cfstate;\sandboxtag';H^{\ctx};H^{\comp};\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}{x[n]}{\cfstate;\sandboxtag';H^{\ctx};H^{\comp}\Delta_1,x\mapsto(\loc;\sandboxtag;\poison;n'),\Delta_2}{\valueexpr}{Get\ \loc\ n;\sandboxtag'}$\textbf{:}
    ...
    \item \textbf{Case $\exprevals{\Omega}{let\ x=\valueexpr\ in\ e}{\Omega}{e[\valueexpr/x]}{\varepsilon}$:}
      ...
      \Cref{goal:step:forwardsim:case7:eval} follows by definition of \Cref{tr:tw-e-let-v}.
...
\begin{proof}
  ...
  \end{passumptions}
  On \Cref{asm:exprbacktranslation:vbeg:wrapper:correct:execs0} apply \Cref{tr:w-e-ectx,tr:w-e-let-v}
  \begin{passumptions}{H}
    \setcounter{enumi}{1}
...
\begin{proof}
  ...
  Note, \Cref{asm:exprbacktranslation:beg:wrapper:correct:execs0a}, continue with \Cref{tr:w-e-ectx,tr:w-e-let-v}:
  \begin{passumptions}{H}
    \setcounter{enumi}{7}
...
%    \item $\delta' = \delta \cup \left\{\src{\loc}\mapsto\trg{z}\right\}$
  ...
  Next, use \Cref{tr:w-e-ectx,tr:w-e-delete,tr:w-e-let-v} on \Cref{asm:exprbacktranslation:vend:wrapper:correct:execs0}:
...
\begin{proof}
  ...
  \begin{description}
    ...
    \item \textbf{Case} \ref{tr:tw-e-let-v}\textbf{:}
          If
          \begin{passumptions}{H}
            \item $\trg{\Omega}=\irl{\Omega}=\trg{\cfstate;\comp;\memstate}$
            \item $\trg{\gamma}=\trg{\hole{\cdot}}$
