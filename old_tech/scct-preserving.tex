...
\begin{theorem}[TMS Relation Correctness for $\mmlAtmsmmlAtscctcomp{\bullet}$]\label{thm:tms-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)} = \tmssafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))} = \tmssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
