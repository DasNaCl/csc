...
\begin{theorem}[TMS Relation Correctness for $\mmlAtmmlAtmscomp{\bullet}$]\label{thm:tms-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)} = \tmssafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))} = \tmssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SMS Relation Correctness for $\mmlAtmmlAtmscomp{\bullet}$]\label{thm:sms-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\smssafe)} = \smssafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\smssafe))} = \smssafe 
  \end{align*}
\end{theorem}
\begin{proof}
...
\begin{theorem}[sCCT Relation Correctness for $\mmlAtmmlAtmscomp{\bullet}$]\label{thm:scct-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)} = \scctsafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))} = \scctsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SS Relation Correctness for $\mmlAtmmlAtmscomp{\bullet}$]\label{thm:spec-rel-corr:lsmslms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\specsafe)} = \specsafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevi[^*_{\delta_{MS}}]{\bullet}}(\specsafe))} = \specsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SMS Relation Correctness for $\mmlAtmsmmlAtscctcomp{\bullet}$]\label{thm:sms-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\smssafe)} = \smssafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\smssafe))} = \smssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[sCCT Relation Correctness for $\mmlAtmsmmlAtscctcomp{\bullet}$]\label{thm:scct-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)} = \scctsafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))} = \scctsafe 
  \end{align*}
\end{theorem}
\begin{proof}
...
\begin{theorem}[SS Relation Correctness for $\mmlAtmsmmlAtscctcomp{\bullet}$]\label{thm:spec-rel-corr:lmslscct}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\specsafe)} = \specsafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevo[^*_{\delta_{MS}}]{\bullet}}(\specsafe))} = \specsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\realthm{thm:rsmsp}{5}{Robust Memory Safety Preservation (T$\to$MS)}
\begin{proof}
...
\begin{theorem}[TMS Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:tms-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\tmssafe)} = \tmssafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\tmssafe))} = \tmssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SMS Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:sms-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\smssafe)} = \smssafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\smssafe))} = \smssafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[sCCT Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:scct-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\scctsafe)} = \scctsafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\scctsafe))} = \scctsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
...
\begin{theorem}[SS Relation Correctness for $\mmlAmmlAtcomp{\bullet}$]\label{thm:spec-rel-corr:ltmslsms}
  \begin{align*}
    \text{ if }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\tospecificevs[^*_{\delta_{MS}}]{\bullet}}(\specsafe)} = \specsafe
    \text{ and } 
    ...
    \\
    \text{ then }& 
    \tospecificev[^*_{\delta_{MS}}]{\sigma_{\xlangtraceeq{}{}}(\sigma_{\tospecificevt[^*_{\delta_{MS}}]{\bullet}}(\specsafe))} = \specsafe 
  \end{align*}
\end{theorem}
\begin{proof}
  unfolding.
