...
%  \item\label[ass]{asm:rsmsp:irlexec} $\wexec{\irl{prog\ \library_{ctx}\ }\mmlAtmmlAtmscompN{\mmlAmmlAtcomp{\library_{comp}}}}{\irl{\Omega}}{\irl{\finalexpr}}{\irl{\trace}}$
%  \end{assumptions}
  \begin{goals}
%    \item\label[goal]{rsmsp:sms} $\tospecificevi[_{\delta_{MS}'}]{\trace}\in\operatorname{msafe}$
    \item $\vdash\mmlAtmmlAtmscompN{\mmlAmmlAtcomp{\bullet}}:\lceil\operatorname{msafe}\rceil$
  \end{goals}
\end{scontents}
...
\begin{proof}
  ...
  \begin{passumptions}{H}
    \item $\rtp{\mmlAtmmlAtmscompN{\mmlAmmlAtcomp{\bullet}}}{\lceil\operatorname{tmsafe}\rceil\cap\lceil\operatorname{smsafe}\rceil}$
  \end{passumptions}
...
\begin{proof}[Proof (Alternative)]
  ...
  Then
  \begin{goals}
    \item\label[goal]{goal:rmtsp:rsat} $\mmlAtmmlAtmscompN{\mmlAmmlAtcomp{\library_{\ctx}}}\vDash_{R}\pi$
  \end{goals}
  ...
  \begin{passumptions}{H}
    \setcounter{enumi}{5}
    \item\label[ass]{asm:rmtsp:smsrsat} $\mmlAtmmlAtmscompN{\mmlAmmlAtcomp{\library_{\ctx}}}\vDash_{R}\pi$
  \end{passumptions}
