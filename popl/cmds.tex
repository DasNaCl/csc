...
\newcommand{\lnew}[4][]{\ensuremath \wrapkeyword[#1]{let}\ #2 {#1{=}} \wrapkeyword[#1]{new}\ #3\ \wrapkeyword[#1]{in}\ #4\xspace}
...
\newcommand{\prog}[3][]{\ensuremath\wrapkeyword[#1]{prog}\ #2\ #3\xspace}

% Compiler
\newcommand{\rtp}[2]{\ensuremath\Vdash_{rtp}{#1}:{#2}}
\newcommand{\ccbase}[1][]{\ensuremath\gamma#1}
\newcommand{\cc}[3][]{\ensuremath{}^{#2}_{#3}\ccbase[#1]}
\newcommand{\cca}{\ensuremath\cc{\src{L_{\tmssafe}}}{\trg{L}}}
\newcommand{\ccb}{\ensuremath\cc{\trg{L}}{\irl{L_{\mssafe}}}}
\newcommand{\ccdce}{\ensuremath\cc[_{\gls{dce}}]{\irl{L_{\mssafe}}}{\irl{L_{\mssafe}}}}
\newcommand{\cccf}{\ensuremath\cc[_{\gls{cf}}]{\irl{L_{\mssafe}}}{\irl{L_{\mssafe}}}}
...
% Filters
\newcommand{\filter}[2][]{\ensuremath{#2}{\kern-2pt}\downarrow{\kern-3pt}{#1}\xspace}
\newcommand{\filterLtms}[2][_{\thelocmap}]{\ensuremath\filter[^{\src{L_{\tmssafe}}}#1]{#2}}
\newcommand{\filterL}[2][_{\thelocmap}]{\ensuremath\filter[^{\trg{L}}#1]{#2}}
