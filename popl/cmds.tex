...
\newcommand{\inttype}[1]{\ensuremath\vdash{#1}\operatorname{int-\type}}

% Filters
\newcommand{\filter}[2][]{\ensuremath{#2}\downarrow^{#1}\xspace}
\newcommand{\filterLtms}[1]{\ensuremath\filter[\src{L_{\tmssafe}}]{#1}}
