...
\begin{example}[Instrumented \texttt{strncpy}]
  ...
  \MKin{
    this is kind of problematic for several reasons. (1) we don't pass pointers (2) fns signatures should not change
  }
\end{example}
...
\end{theorem}
\begin{proof}
  Consequence of \Thmref{thm:cca:rtp:tms} and \Thmref{thm:ccb:rtp:sms} using \Thmref{thm:rtp}.
  \MKin{%
...
\end{theorem}
\begin{proof}
  Consequence of \Thmref{thm:cccf:rtp:ms} and \Thmref{thm:ccdce:rtp:ms} using \Thmref{corr:swappable}.
  \MKin{%
    \textbackslash Thmref or \textbackslash Cref?
  }
\end{proof}
