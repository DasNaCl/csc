...
Since $\trg{L}$ has no static typechecks, it could happen that a bogus context $\trg{\library_{\ctx}}$ calls this function expecting a natural number with $\trg{\lpair{17}{29}}$.
