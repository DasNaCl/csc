...
As stated earlier, this work wants to establish the theoretical foundation to ensure the secure compilation of programs like \texttt{strncpy} (\Cref{ex:strncpy}) to satisfy properties \gls{ms} and \gls{cct} robustly.
...
\begin{itemize}
  \item %
        ...
        % 
        The resulting security property is the golden standard of safety properties that secure cryptographic code should have~\cite{lemay2021ccc}\MK{more cits?}.
%        \MPin{
...
%        This demonstrates that the usage of the presented framework is both simpler and more expressive compared to one monolithic security proof of the whole compilation chain.
  ...
  \item The key contributions are formalized in the Coq proof assistant and the paper indicates this with \CoqSymbol.
\end{itemize}
