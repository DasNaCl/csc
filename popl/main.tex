...
\begin{itemize}
  ...
  \item %
        ...
        Furthermore, the chain entails two passes for \gls{ms}\MK{maybe patch when optimizing passes are done} that are optimizing: One performs a simple \gls{dce} and the other \gls{cf}.
