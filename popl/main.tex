...
Then, it showcases this theory a secure multi-pass compiler that preserves the aforementioned security-relevant properties.
% conclusion
...
That is, for a whole program $\src{\wholeprogvar}$, the compiler should relate the $\src{L}$ semantics of $\src{\wholeprogvar}$ with the semantics of $\trg{T}$ of the compiled counterpart of $\src{p}$ in such a way that they are ,,compatible''.
