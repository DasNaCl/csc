...
\begin{itemize}
  \item %
        ...
        Using the framework, the ease for formal reasoning about security property compositions is demonstrated by instantiating it on \gls{tms}, \gls{sms}, and \gls{cct}, which are ultimately composed to \gls{ms} and a combination of \gls{ms} and \gls{cct}.
