...
\begin{center}
  ...
  \typerule{e-proj1}{
    ...
    \pstepto{\rtt{\trg{\statevar}}{\trg{\lproja{\lpair{n_1}{n_2}}}}}{\rtt{\trg{\statevar}}{\trg{n_1}}}{\trg{\emptyevent}}
  }{e-proj1}
  %
...
One of those checks allows programmers to investigate wether a pointer is freed or not (\Cref{tr:e-ispoisoned-yes,tr:e-ispoisoned-no}).
The other check is a simple dynamic type check that evaluates to $\trg{0}$ if the check suceeds and to $\trg{1}$ otherwise (\Cref{tr:e-n-has-nat,tr:e-x-has-nat,tr:e-n-has-nattimesnat}).
As before, not all rules are shown due to their straightforwardness.
