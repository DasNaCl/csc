...
This section presents the key results of this paper that have been presented in prior work~\cite{kruse2022csc}.
The main results are the fact that secure compilers in the robust preservation framework~\cite{abate2019jour} compose.
...
...
\begin{definition}[Sequential Composition]\label{def:seqcomp}
  Let $\cc{\src{L}}{\trg{L}}$, $\cc{\trg{L}}{\obj{L}}$ be compilers from languages $\src{L}$ to $\trg{L}$ and $\trg{L}$ to $\obj{L}$, respectively.
  Their sequential composition is $\left(\cc{\src{L}}{\trg{L}}\circ\cc{\trg{L}}{\obj{L}}\right)\left(\src{p}\right)=\obj{p}$.
\end{definition}
...
\begin{corollary}[Sequential Composition of Secure Compilers]\label{corr:swappable}
  ...
  Then, $\rtp{\cc[_{1}]{\trg{L}}{\trg{L}}\circ\cc[_{2}]{\trg{L}}{\trg{L}}}{\class[_{1}]\cap\class[_{2}]}$ and $\rtp{\cc[_{2}]{\trg{L}}{\trg{L}}\circ\cc[_{1}]{\trg{L}}{\trg{L}}}{\class[_{2}]\cap\class[_{1}]}$. \Coqed
\end{corollary}
