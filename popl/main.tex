...
This relation projects the events\MP{whaddaya mean?}, while the stutter-equivalence $\traceagree{\pi}{\trace}{\abstrace}$ remains the same for all properties $\pi$, yet is indexed by $\pi$ to emphasise the kind of event agreement.\MP{unclear sentence}
...
int main() {  // allocates 17 integers initialised to 2
  int* x = new[17](2);
...
\Cref{fig:proofdiag:rtp} visualises this situation\MP{imprec}.
\begin{figure}[!ht]
  \begin{center}
