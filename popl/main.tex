...
\begin{lstlisting}[language=ml,basicstyle=\small\ttfamily,morekeywords={ifz}, caption=$\Ltms$]
let strncpy p : int * int * ptr int * ptr int -> ptr int * ptr int :=
  let [i, n, x, y] = p in
  ifz x[i] then
    ifz i < n then
      return call strncpy (i+1, n, x, y)
    else
      return (x, y)
  else
    return (x, y)
