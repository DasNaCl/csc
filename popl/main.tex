...
With this, a secure compiler needs to ensure that no malicious target-level context can supply unitialised memory and thereby sidestep the guarantees of the source language, e.g., by inserting appropriate checks prior to entering the body of \texttt{strncpy} or using capabilities~\cite{michael2023mswasm}.
\end{example}
