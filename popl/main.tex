...
Together, \gls*{sms}, \gls*{tms} and \gls*{cct} yield \gls*{msscct}, which is the gold standard of security properties for secure applications: programs attaining \gls*{msscct} do not leak sensitive data either through erroneous memory accesses, nor through timing side-channels.
