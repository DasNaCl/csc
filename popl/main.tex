...
\BrText{Solution}{
This paper introduces a formal framework for secure compiler compositions and showcases the framework's power by instantiating it on a multi-level compilation chain.
