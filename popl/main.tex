...
% This paper presents one such framework to be able to build a secure compiler as the composition of several smaller ones.
% Let us now introduce a minimal example of what such a secure compiler should be capable of dealing with.
