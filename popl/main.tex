...
As typically done in not only secure compilation~\cite{abate2019jour,devriese2018parametricity}, \MP{others do this too, parametricity results e.g.} this paper assumes that whole programs are the result of linking partial programs referred to as {\em context} ($\ctx$) and {\em component} ($\comp$).
