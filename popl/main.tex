...
The context is usually arbitrary\footnote{Up to, e.g., provoking link failure.} and thus has the role of an {\em attacker} that can interact with the component by means of whatever features the programming language has.
