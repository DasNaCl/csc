...
Some programming languages of today enjoy strong security guarantees that programmers want to have, such as the memory-safety guarantees given by the semantic analysis pass of a compiler for the Rust programming lanugage.
