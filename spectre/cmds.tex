...
\newcommand{\seqctEvent}[1][]{\ensuremath a^{\text{seq}}_{\text{ct}}}
\newcommand{\specctEvent}[1][]{\ensuremath a^{\text{spec}}_{\text{ct}}}
\newcommand{\seqmemEvent}[1][]{\ensuremath a^{\text{seq}}_{\text{mem}}}
\newcommand{\specmemEvent}[1][]{\ensuremath a^{\text{spec}}_{\text{mem}}}
\newcommand{\seqarchEvent}[1][]{\ensuremath a^{\text{seq}}_{\text{arch}}}
\newcommand{\specarchEvent}[1][]{\ensuremath a^{\text{spec}}_{\text{arch}}}

\newcommand{\seqctTrace}[1][]{\ensuremath \overline{a^{\text{seq}}_{\text{ct}}}}
\newcommand{\specctTrace}[1][]{\ensuremath \overline{a^{\text{spec}}_{\text{ct}}}}
\newcommand{\seqmemTrace}[1][]{\ensuremath \overline{a^{\text{seq}}_{\text{mem}}}}
\newcommand{\specmemTrace}[1][]{\ensuremath \overline{a^{\text{spec}}_{\text{mem}}}}
\newcommand{\seqarchTrace}[1][]{\ensuremath \overline{a^{\text{seq}}_{\text{arch}}}}
\newcommand{\specarchTrace}[1][]{\ensuremath \overline{a^{\text{spec}}_{\text{arch}}}}
