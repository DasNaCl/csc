...
\newcommand{\policy}{\ensuremath \tau}
...
\newcommand{\locmap}{\ensuremath\delta}
\newcommand{\locmapsto}[2]{\ensuremath\locmap\lrpars{#1}=#2}

\newcommand{\seqctspecctlocmap}{\ensuremath\delta^{\text{seqct}}_{\text{specct}}}
\newcommand{\seqctspecctlocmapsto}[2]{\ensuremath\seqctspecctlocmap\lrpars{\seqctev{#1}}=\specctev{#2}}
\newcommand{\seqmemspecmemlocmap}{\ensuremath\delta^{\text{seqmem}}_{\text{specmem}}}
\newcommand{\seqmemspecmemlocmapsto}[2]{\ensuremath\seqmemspecmemlocmap\lrpars{\seqmemev{#1}}=\specmemev{#2}}
\newcommand{\seqarchspecarchlocmap}{\ensuremath\delta^{\text{seqarch}}_{\text{specarch}}}
\newcommand{\seqarchspecarchlocmapsto}[2]{\ensuremath\seqarchspecarchlocmap\lrpars{\seqarchev{#1}}=\specarchev{#2}}
\newcommand{\specmemspecctlocmap}{\ensuremath\delta^{\text{specmem}}_{\text{specct}}}
\newcommand{\specmemspecctlocmapsto}[2]{\ensuremath\specmemspecctlocmap\lrpars{\specmemev{#1}}=\specctev{#2}}
\newcommand{\specctspecarchlocmap}{\ensuremath\delta^{\text{specct}}_{\text{specarch}}}
\newcommand{\specctspecarchlocmapsto}[2]{\ensuremath\specctspecarchlocmap\lrpars{\specctev{#1}}=\specarchev{#2}}

\newcommand{\specarchspecfencelocmap}{\ensuremath\delta^{\text{specarch}}_{\text{specfence}}}
\newcommand{\specarchspecfencelocmapsto}[2]{\ensuremath\specarchspecfencelocmap\lrpars{\specarchev{#1}}=\specfenceev{#2}}
\newcommand{\specarchspecslhlocmap}{\ensuremath\delta^{\text{specarch}}_{\text{specslh}}}
\newcommand{\specarchspecslhlocmapsto}[2]{\ensuremath\specarchspecslhlocmap\lrpars{\specarchev{#1}}=\specslhev{#2}}
