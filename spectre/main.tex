...
\begin{center}
  \judgbox{\specarchTOspecslh{n;s;\trg{\overline{b}}}{m;\trg{\overline{b}}} : \specarchEvent \to \specslhTrace \to \mathbb{P}}{,,Map speculative architecture to speculative load hardening. %
  $s$ is a map of secret locations.''}
  %
  ...
  \typerule{specarch-to-specslh-specmode-load}{
    ...
    \specarchev{Load\;\varLoc\;v}\specarchTOspecslh{1+n;s;\trg{b}\cdot\trg{\overline{b}}}{1+n;\trg{b}\cdot\trg{\overline{b}}}\specslhev{Load\;\varLoc\;v}
  }{specarch-to-specslh-specmode-load}
  %
  \typerule{specarch-to-specslh-store}{}{
    \specarchev{Store\;\varLoc\;v}\specarchTOspecslh{n;s;\trg{\overline{b}}}{n;\trg{\overline{b}}}\specslhev{Store\;\varLoc\;v}
  }{specarch-to-specslh-store}
  %
  \typerule{specarch-to-specslh-load}{}{
    \specarchev{Load\;\varLoc\;v}\specarchTOspecslh{n;s;\trg{\overline{b}}}{n;\trg{\overline{b}}}\specslhev{Load\;\varLoc\;v}
  ...
  \typerule{specarch-to-specslh-rlb}{}{
    \specarchev{Rlb}\specarchTOspecslh{n;s;\trg{\overline{b}}}{1+n;\trg{\overline{b}}}\specslhev{Rlb}
  ...
  \typerule{specarch-to-specslh-branch}{}{
    \specarchev{Pc\;n'}\specarchTOspecslh{n;s;\trg{\overline{b}}}{n;\trg{\overline{b}}}\specslhev{Branch\;b\;n'}
...
\begin{center}
  ...
  \typerule{specarch-to-specslh-refl}{}{
    \hole{\cdot}\specarchTOspecslhtr{0;s;\trg{\hole{\cdot}}}{0;\trg{\hole{\cdot}}}\hole{\cdot}
  }{specarch-to-specslh-refl}
  %
  \typerule{specarch-to-specslh-trans}{
    \specarchEvent\specarchTOspecslh{n;s;\trg{\overline{b}}}{n';\trg{\overline{b'}}}\specslhEvent\rulesep
    \specarchTrace\specarchTOspecslhtr{n';s;\trg{\overline{b'}}}{m;\trg{\overline{b''}}}\specslhTrace
  }{
    \specarchEvent\cdot\specarchTrace\specarchTOspecslhtr{n;s;\trg{\overline{b}}}{m;\trg{\overline{b''}}}\specslhEvent\cdot\specslhTrace
