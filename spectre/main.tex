...
\begin{center}
  ...
  \typerule{specarch-to-fencing-load-yes}{
    ...
    \specarchev{Load\;\varLoc\;v}\specarchTOspecfence{n}{o}\specfenceev{Fence\cdot Load\;\varLoc\;v}
  }{specarch-to-fencing-load-yes}
  %
  \typerule{specarch-to-fencing-store-yes}{
    o\lrpars{n} = \text{yes}
  }{
    \specarchev{Store\;\varLoc\;v}\specarchTOspecfence{n}{o}\specfenceev{Fence\cdot Store\;\varLoc\;v}
...
\begin{center}
  ...
  \typerule{specarch-to-fencing-trans}{
    \specarchEvent\specarchTOspecfence{n}{o}\specfenceEvent \rulesep
    \specarchTrace\specarchTOspecfence{1+n}{o}\specfenceTrace 
  }{
    \specarchEvent\cdot\specarchTrace\specarchTOspecfencetr{n}{o}\specfenceEvent\cdot\specfenceTrace
