...
{\everypar={{\setbox0=\lastbox}\everypar{}}\restartlist{passumptionslist}\mbox{\textsc{#1}.}$\;$\\\vspace{-2ex}\hline\noindent\everypar={{\setbox0=\lastbox}\everypar{}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Properties Names
\newcommand{\tmssafe}{\text{tmssafe}}
\newcommand{\smssafe}{\text{smssafe}}
\newcommand{\mssafe}{\text{mssafe}}
\newcommand{\ctsafe}{\text{ctsafe}}
\newcommand{\scctsafe}{\text{sctsafe}}
\newcommand{\msscctsafe}{\text{mssctsafe}}
\newcommand{\sssafe}{\text{sssafe}}
\newcommand{\specmssafe}{\text{specmssafe}}
