...
\newcommand{\specev}[1]{\ensuremath\ulcorner #1 \urcorner\;^{\kern-3pt{\specsafe}}}

\newcommand{\varSecuritytag}[1]{\ensuremath\sigma#1}
...
\newcommand{\smsAlloc}[1][\varLoc]{\ensuremath\makeConcreteEvent{Alloc}{#1}{\smssafe}}
\newcommand{\smsDealloc}[1][\varLoc]{\ensuremath\makeConcreteEvent{Dealloc}{#1}{\smssafe}}
\newcommand{\smsUse}[1][\varLoc]{\ensuremath\makeConcreteEvent{Use}{#1}{\smssafe}}
...
\newcommand{\stutterstepMonitor}[1][{\varMonitor[_1]\times\varMonitor[_2]}]{\ensuremath\varMonitor[#1]}
