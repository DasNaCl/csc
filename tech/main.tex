...
\end{gather*}
\begin{center}
  \judgbox{\pstepto{\src{\runtimetermvar}}{\src{\runtimetermvar[']}}{\src{\event}}}{,,$\runtimetermvar$ does one primitive step to $\runtimetermvar[']$ emitting event $\event$.''}
  %
  ...
  \typerule{$\src{\Ltms}-e-\text{get}-\in$}{
    ...
    \pstepto{\src{\rtt{\statevar}{\lget{x}{n}}}}{\src{\rtt{\statevar}{\statevar.\heap[^{\sandboxtag}](\loc+n)}}}{\src{\tup{\ev{Get}\ \loc\ n}{\sandboxtag,\unlock}}}
  }{ap:ltms-e-get-in}
  %
  \typerule{$\src{\Ltms}-e-\text{get}-\notin$}{
    ...
    \pstepto{\src{\rtt{\statevar}{\lget{x}{n}}}}{\src{\rtt{\statevar}{1729}}}{\src{\tup{\ev{Get}\ \loc\ n}{\sandboxtag,\unlock}}}
  }{ap:ltms-e-get-notin}
  %
  \typerule{$\src{\Ltms}-e-\text{set}-\in$}{
    ...
    \pstepto{\src{\rtt{\statevar}{\lset{x}{n}{\valueexpr}}}}{\src{\rtt{\statevar\subst{\heap[^{\sandboxtag}]}{\heap[']}}{\valueexpr}}}{\src{\tup{\ev{Set}\ \loc\ n\ \valueexpr}{\sandboxtag,\unlock}}}
  }{ap:ltms-e-set-in}
  %
  \typerule{$\src{\Ltms}-e-\text{set}-\notin$}{
    ...
    \pstepto{\src{\rtt{\statevar}{\lset{x}{n}{\valueexpr}}}}{\src{\rtt{\statevar}{\valueexpr}}}{\src{\tup{\ev{Set}\ \loc\ n\ \valueexpr}{\sandboxtag,\unlock}}}
  }{ap:ltms-e-set-notin}
  %
  \typerule{$\src{\Ltms}-e-\text{new}$}{
    \fresh{\src{\statevar}}{\src{z}} &
    \fresh{\src{\statevar}}{\src{\loc}} &
    \src{\heap[^{\sandboxtag}_1]}=\growh{\src{\statevar.\heap[^{\sandboxtag}]}}{\src{n}} &
    \src{\store[_1]}=\src{\storeel{z}{\loc}{\statevar.\sandboxtag}{\poisonless}{n},\statevar.\store}
  }{
    \pstepto{\src{\rtt{\statevar}{\lnew{x}{n}{\expr}}}}{\src{\rtt{\statevar\subst{\heap[^{\sandboxtag}]}{\heap[^{\sandboxtag}_1]}\subst{\store}{\store[_1]}}{\expr\subst{z}{x}}}}{\src{\tup{\ev{Alloc}\ \loc\ n}{\sandboxtag}}}
  }{ap:ltms-e-new}
  %
  \typerule{$\src{\Ltms}-e-\text{dealloc}$}{
    ...
    \pstepto{\src{\rtt{\statevar}{\ldelete{x}}}}{\src{\rtt{\statevar\subst{\store}{\store[_1]}}{0}}}{\src{\tup{\ev{Dealloc}\ \loc}{\sandboxtag}}}
  }{ap:ltms-e-dealloc}
  %
