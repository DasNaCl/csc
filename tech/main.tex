...
\begin{lemma}{\lemmalabel[Trace Relation distributes on Universal Image]{xtrace-distribute-universal}}
...
\end{proof}
\begin{lemma}{\lemmalabel[Trace Relation distributes on Existential Image]{xtrace-distribute-existential}}
  Let $X$ be either a trace-property or a class. Then:
  \begin{goals}
...
\begin{lemma}{\lemmalabel[Composition of RTP]{rtp-compo}}
  If 
  \begin{assumptions}
...
\begin{corollary}{\corollarylabel[Commutativity of RTP]{rtp-swappable}}
  If 
  \begin{assumptions}
...
\begin{lemma}{\lemmalabel[Composition of RTP-Universal]{rtp-universal-compo}}
  If 
  \begin{assumptions}
...
\begin{lemma}{\lemmalabel[Composition of RTP-Existential]{rtp-existential-compo}}
  If 
  \begin{assumptions}
  ...
  then
  \begin{goals}
    \goal{rtp-universal-compo}{\rtpExistential{\fncompo{\ccSI}{\ccIT}}{\srcClass[_1]\cap\srcClass[_2]}{\fncompo{\sim_1}{\sim_2}}}
  \end{goals}
\end{lemma}
\begin{proof}
  \incompleteProof
